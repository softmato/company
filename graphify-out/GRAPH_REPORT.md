# Graph Report - company  (2026-09-04)

## Corpus Check
- 598 files · ~558,576 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3414 nodes · 6857 edges · 185 communities (177 shown, 8 thin omitted)
...
Cohesion: 0.08
Nodes (37): authorize(), decryptSecret(), deriveFromKey(), encryptSecret(), key(), checkTotp(), createTotpEnrolment(), enrolmentUri() (+29 more)
...
Cohesion: 0.1
Nodes (33): isPaymentError(), sendReceipt(), refusal(), everything, clearInvoice(), closeSession(), CompletedPayment, completePayment() (+25 more)
...
Cohesion: 0.1
Nodes (22): ApplicationPanel(), Breadcrumbs(), ContentTable(), ReauthFields(), RegisterApplicationForm(), DESCRIPTION, ScopeCheckboxes(), ApplicationsPage() (+14 more)
...
Cohesion: 0.14
Nodes (20): PublishConfirm(), PublishPending(), RotateTotpFormProps, SubmitButton(), TotpSetupProps, LoginFailureCode, LoginPage(), Button() (+12 more)

### Community 21 - "Community 21"
Cohesion: 0.09
Nodes (25): BuildTiers(), ClosingCta(), Hero(), PLACE_COORDINATES, PLACE_PHOTO, PlaceSection(), PrinciplesSection(), QUALITIES (+17 more)

### Community 22 - "Community 22"
Cohesion: 0.14
Nodes (28): requireAdmin(), DomainList(), DomainRow, confirmIdentity(), confirmIfProduction(), confirmName(), readDomains(), readScopes() (+20 more)
...
Cohesion: 0.08
Nodes (22): authenticateApplication(), AuthenticatedApplication, bearerToken(), matchSecret(), unauthenticated(), PAYMENT_ERROR_STATUS, PaymentError, PaymentErrorCode (+14 more)
...
Cohesion: 0.12
Nodes (21): AdminRoster(), InviteAdminForm(), PendingAdminActions(), listAdmins(), RosterEntry, RotateTotpForm(), TotpSetup(), confirmEnrolment() (+13 more)

### Community 30 - "Community 30"
Cohesion: 0.14
Nodes (26): buildInvoiceDocument(), customerParty(), documentStatus(), documentIssues(), SheetWarning(), findInvoice(), findPayment(), InvoiceLineRecord (+18 more)
...
Cohesion: 0.12
Nodes (19): covering, DarkNavZone(), ProductsSection(), CLOSING_HEADING, PRINCIPLES_HEADING, PRODUCTS_HEADING, SERVICES_HEADING, STATEMENT (+11 more)

### Community 33 - "Community 33"
Cohesion: 0.15
Nodes (20): publishContent(), unpublishContent(), saveContent(), ActionResult, databaseMessage(), parseId(), requireKind(), ContentForm() (+12 more)
...
Cohesion: 0.13
Nodes (20): EnrolmentHandoff(), enrolmentUrl(), createPendingAdmin(), findPendingAdmin(), findTotpSecret(), PendingAdmin, pendingOnly(), reclaimPendingAdmin() (+12 more)

### Community 39 - "Community 39"
Cohesion: 0.13
Nodes (19): IconBell(), IconCamera(), IconDownload(), IconFingerprint(), IconHome(), IconOffline(), IconPin(), IconProps (+11 more)
...
Cohesion: 0.13
Nodes (20): assertRegisteredHost(), isRegisteredHost(), addDomain(), AddDomainInput, removeDomain(), normalizeHostname(), normalizeHostnameInput(), DomainInput (+12 more)
...
Cohesion: 0.15
Nodes (19): nextPollAt(), pollDelayMs(), pollExhausted(), giveUp(), LIVE, PollPendingResult, pollPendingTransactions(), reschedule() (+11 more)

### Community 48 - "Community 48"
Cohesion: 0.11
Nodes (12): NavItem, SECTIONS, Chip(), PostList(), PostSummary, cn(), PageContainer(), Glyph() (+4 more)
...
Cohesion: 0.22
Nodes (9): CraftConstellation(), CRAFT_DISCS, CraftDisc, TextTag, Drift(), Parallax(), prefersReducedMotion(), registerMotionPlugins() (+1 more)
...
Cohesion: 0.17
Nodes (10): DisciplineCluster(), Discipline, DISCIPLINES, Satellite, TierRow(), Tier, TIERS, TierSide (+2 more)
...
Cohesion: 0.15
Nodes (10): buildReceipt(), Receipt, ReceiptInput, audited, makeAttempt(), makeSession(), NOW, receipts (+2 more)
...
Cohesion: 0.26
Nodes (11): paisa(), party(), serializeInvoiceDocument(), serializeReceiptDocument(), blankAsNull(), missingSellerFields(), sellerFromSettings(), DocumentLine (+3 more)
...
Cohesion: 0.24
Nodes (10): NotFound(), CheckoutView, summarise(), Summary, isContentKind(), readPresentation(), ContentEditPage(), ContentListPage() (+2 more)

### Community 105 - "Community 105"
Cohesion: 0.24
Nodes (9): OrderSummary(), OrderSummaryProps, PlanDetails(), plainText(), Presentation, PresentationInput, presentationSchema, sellingPoint() (+1 more)
...
Cohesion: 0.29
Nodes (9): offerable(), availableProviders(), ensureProvidersRegistered(), MOCKABLE, registerIfAbsent(), registerMocks(), registeredProviders(), beginPayment() (+1 more)
...
Cohesion: 0.38
Nodes (7): emailConfigured, resendClient(), configuredDomain(), fallbackIdentity(), resolveEmailIdentity(), Message, env
...
- **Why does `isPaymentError()` connect `Community 13` to `Community 104`, `Community 42`, `Community 108`, `Community 47`, `Community 16`, `Community 79`, `Community 22`, `Community 27`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 48` to `Community 32`, `Community 1`, `Community 0`, `Community 67`, `Community 36`, `Community 37`, `Community 121`, `Community 39`, `Community 136`, `Community 81`, `Community 52`, `Community 20`, `Community 86`, `Community 21`, `Community 25`, `Community 95`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `submitContact()` connect `Community 96` to `Community 19`, `Community 20`?**
