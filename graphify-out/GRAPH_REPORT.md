...
## Summary
- 3896 nodes · 7841 edges · 198 communities (190 shown, 8 thin omitted)
...
Cohesion: 0.05
Nodes (44): ApplicationHeader(), ApplicationPanel(), Breadcrumbs(), ContentTable(), DeleteApplicationForm(), DomainList(), DomainRow, FieldError() (+36 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (54): confirmEnrolment(), EnrolPage(), metadata, openPendingSecret(), seal(), sealPendingSecret(), activateWithSecret(), deletePendingAdmin() (+46 more)
...
Cohesion: 0.08
Nodes (31): AdminRoster(), EnrolmentHandoff(), InviteAdminForm(), PendingAdminActions(), PublicationPanel(), PublishConfirm(), PublishPending(), listAdmins() (+23 more)
...
Cohesion: 0.18
Nodes (28): AboutPage(), generateMetadata(), BlogIndexPage(), generateMetadata(), PostList(), CareersPage(), generateMetadata(), metadataFor() (+20 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (37): BlogPostSeed, blogPostSeeds, PageSeed, pageSeeds, ProductPageSeed, productPageSeeds, AdminUser, adminUsers (+29 more)

### Community 13 - "Community 13"
Cohesion: 0.09
Nodes (39): confirmOfflinePayment(), pendingCash(), RecordedOfflinePayment, RecordOfflinePaymentInput, rejectOfflinePayment(), buildReceipt(), ReceiptSender, sendReceipt() (+31 more)
...
Cohesion: 0.15
Nodes (36): requireAdmin(), addCredentialAction(), confirmIdentity(), confirmIfProduction(), confirmName(), deleteApplicationAction(), readDomains(), readId() (+28 more)

### Community 17 - "Community 17"
Cohesion: 0.1
Nodes (26): covering, DarkNavZone(), DeviceScreen(), PLACE_COORDINATES, PLACE_PHOTO, CLOSING_HEADING, PRINCIPLES_HEADING, PRODUCTS_HEADING (+18 more)
...
Cohesion: 0.11
Nodes (30): readProduct(), assertRegisteredHost(), isRegisteredHost(), addDomain(), AddDomainInput, normalizeHostname(), normalizeHostnameInput(), assertLoopbackAllowed() (+22 more)
...
Cohesion: 0.1
Nodes (27): DocumentFormat, joinReference(), encodeRandom(), encodeTime(), newRequestId(), apiError(), apiJson(), secretExpiryHeaders() (+19 more)

### Community 22 - "Community 22"
Cohesion: 0.12
Nodes (29): buildInvoiceDocument(), customerParty(), documentStatus(), documentIssues(), readPresentation(), findInvoice(), findPayment(), InvoiceLineRecord (+21 more)
...
Cohesion: 0.12
Nodes (24): chromeBinary(), renderWithChrome(), run(), fontsArrived(), renderWithBundledChromium(), COL, drawInvoice(), dateLine() (+16 more)

### Community 26 - "Community 26"
Cohesion: 0.09
Nodes (23): CallbackPage(), metadata, CheckoutNotice(), CheckoutNoticeProps, Tone, ConfirmOutcome, confirmSessionPayment(), ReturnLink (+15 more)

### Community 27 - "Community 27"
Cohesion: 0.14
Nodes (15): BLOOM_LAYERS, EXIT_DX, HeroArc(), CRESCENT_LAYERS, HeroEye(), EXIT_DX, heroStart(), HERO (+7 more)
...
Cohesion: 0.08
Nodes (28): ServiceSeed, serviceSeeds, services, FiscalPeriod, fiscalPeriods, periodStatus, BlogPostSeed, blogPostSeeds (+20 more)
...
Cohesion: 0.19
Nodes (21): NotFound(), getLegalDocument, getPost, getProductPage, getService, published(), publishedSlugs(), BS_MONTHS (+13 more)
...
Cohesion: 0.12
Nodes (21): confirmCashAction(), decide(), rejectCashAction(), enrolmentUrl(), qrSvg(), createPendingAdmin(), reclaimPendingAdmin(), AuditActorType (+13 more)
...
Cohesion: 0.1
Nodes (16): Chip(), PostSummary, cn(), PageContainer(), AppStill(), BY_SLUG, stillFor(), BARS (+8 more)
...
Cohesion: 0.16
Nodes (13): BANK_SLUGS, bankMark(), BankSlug, BrandMark(), MarkAsset, ProviderBadge(), ProviderMark(), WALLET_MARKS (+5 more)
...
Cohesion: 0.13
Nodes (16): BuildTiers(), ClosingCta(), Hero(), PlaceSection(), PrinciplesSection(), ProductsSection(), RecentPosts(), ServicesSection() (+8 more)
...
Cohesion: 0.17
Nodes (14): CashRow, listCash(), Offline, adminMode(), listRefunds(), RefundRow, AdminCashPage(), CashCard() (+6 more)
...
Cohesion: 0.23
Nodes (11): paisa(), party(), serializeInvoiceDocument(), serializeReceiptDocument(), blankAsNull(), sellerFromSettings(), DocumentLine, Party (+3 more)
...
- **Why does `isPaymentError()` connect `Community 26` to `Community 2`, `Community 36`, `Community 13`, `Community 16`, `Community 18`, `Community 21`?**
  _High betweenness centrality (0.089) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 38` to `Community 1`, `Community 3`, `Community 100`, `Community 101`, `Community 37`, `Community 40`, `Community 8`, `Community 73`, `Community 43`, `Community 140`, `Community 45`, `Community 11`, `Community 81`, `Community 49`, `Community 82`, `Community 17`, `Community 90`, `Community 27`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `decide()` connect `Community 36` to `Community 16`, `Community 42`, `Community 26`, `Community 20`?**
