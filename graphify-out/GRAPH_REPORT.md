...
## Corpus Check
- 648 files · ~632,646 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3892 nodes · 7817 edges · 207 communities (195 shown, 12 thin omitted)
...
Cohesion: 0.05
Nodes (56): CashRow, listCash(), Offline, INVOICE_STATUSES, InvoiceFilter, InvoiceRow, InvoiceTotals, listInvoices() (+48 more)
...
Cohesion: 0.07
Nodes (31): Account, accountClass, accounts, normalBalance, Product, productKind, products, FiscalPeriod (+23 more)
...
Cohesion: 0.12
Nodes (27): chromeBinary(), renderWithChrome(), run(), fontsArrived(), renderWithBundledChromium(), COL, drawInvoice(), dateLine() (+19 more)

### Community 19 - "Community 19"
Cohesion: 0.07
Nodes (33): credentialMode, Customer, customers, Invoice, InvoiceLine, invoiceLines, invoices, invoiceStatus (+25 more)
...
Cohesion: 0.1
Nodes (26): BuildTiers(), ClosingCta(), PrinciplesSection(), CLOSING_HEADING, PRINCIPLES_HEADING, PRODUCTS_HEADING, SERVICES_HEADING, STATEMENT (+18 more)
...
Cohesion: 0.08
Nodes (28): Breadcrumbs(), ContentForm(), ContentTable(), RegisterApplicationForm(), ApplicationsPage(), applicationColumns, ApplicationDetail, credentialColumns (+20 more)
...
Cohesion: 0.1
Nodes (22): ApplicationHeader(), ApplicationPanel(), FieldError(), KeyLegend(), KEYS, KIND_LABEL, NewProductDraft, ProductField() (+14 more)

### Community 26 - "Community 26"
Cohesion: 0.1
Nodes (22): AdminRoster(), InviteAdminForm(), PendingAdminActions(), listAdmins(), RosterEntry, RotateTotpForm(), TotpSetup(), confirmEnrolment() (+14 more)
...
Cohesion: 0.07
Nodes (25): Application, APPLICATION_SCOPES, ApplicationCredential, applicationCredentials, ApplicationDomain, applicationDomains, applications, ApplicationScope (+17 more)
...
Cohesion: 0.11
Nodes (21): extractHeadings(), Heading, headingId(), getLegalDocument, INTEGRATION_PATH, integrationDoc(), stripRepoLinks(), DevelopersPage() (+13 more)
...
Cohesion: 0.12
Nodes (17): Chip(), PostList(), PostSummary, formatBsNumeric(), cn(), MarkArrow(), StaggerIn(), StaggerTag (+9 more)

### Community 36 - "Community 36"
Cohesion: 0.09
Nodes (26): SignResponse, uploadImage(), UploadResult, ImageMime, key, message, ACCEPT_ATTRIBUTE, ACCEPTED (+18 more)
...
Cohesion: 0.22
Nodes (18): NotFound(), getPost, getProductPage, getService, publishedSlugs(), formatBsWithAd(), CmsImage(), CmsImageFill() (+10 more)
...
Cohesion: 0.12
Nodes (17): CallbackPage(), metadata, CheckoutNotice(), CheckoutNoticeProps, Tone, ReturnLink, returnLinkFor(), CheckoutView (+9 more)
...
Cohesion: 0.25
Nodes (13): NUMERIC_FIELDS, DashboardSnapshot, FILTERS, Card(), CardBody(), CardHeader(), CardTitle(), Money() (+5 more)
...
Cohesion: 0.18
Nodes (15): DashboardMethod, DashboardMonth, ActivityEntry, dashboardAttentionPayments(), dashboardMetrics(), dashboardOverdueInvoices(), dashboardPaymentMethods(), dashboardPayments() (+7 more)
...
Cohesion: 0.15
Nodes (15): DashboardActivity(), DashboardInvoices(), DASHBOARD_TABS, DashboardInvoice, DashboardPayment, DashboardPaymentFilter, DashboardTab, filterDashboardPayments() (+7 more)
...
Cohesion: 0.17
Nodes (13): isIndexableLegalDocument(), LegalReadiness, JsonLd(), serialiseJsonLd(), isProductionSite(), crumbs, modified, node (+5 more)
...
Cohesion: 0.19
Nodes (9): ConfirmOutcome, confirmSessionPayment(), BUSY, FonepayQr(), FonepayQrProps, NOTES, sendPaymentReceipt(), checkPayment() (+1 more)
...
Cohesion: 0.23
Nodes (8): POST, jobEndpoint(), JobHandler, equalInConstantTime(), isAuthorisedJobRequest(), NOT_FOUND, POST, POST
...
Cohesion: 0.27
Nodes (7): DeviceScreen(), ProductsSection(), RecentPosts(), homeTagline(), collapse(), splitLede(), HomePage()
...
Cohesion: 0.29
Nodes (7): sitemap(), listPublishedLegalDocuments(), published(), publishedPageSlugs(), ContactDetails(), SiteFooter(), getSettings
...
Cohesion: 0.36
Nodes (5): PLACE_COORDINATES, PLACE_PHOTO, PlaceSection(), TextTag, WordReveal()
...
- **Why does `isPaymentError()` connect `Community 12` to `Community 101`, `Community 38`, `Community 6`, `Community 74`, `Community 43`, `Community 48`, `Community 24`, `Community 25`, `Community 26`, `Community 60`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Why does `decide()` connect `Community 24` to `Community 123`, `Community 59`, `Community 12`, `Community 38`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 35` to `Community 129`, `Community 10`, `Community 141`, `Community 142`, `Community 14`, `Community 21`, `Community 31`, `Community 32`, `Community 162`, `Community 36`, `Community 170`, `Community 44`, `Community 45`, `Community 47`, `Community 50`, `Community 78`, `Community 93`, `Community 94`, `Community 115`, `Community 122`?**
