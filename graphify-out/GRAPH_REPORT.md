# Graph Report - company  (2026-09-09)

## Corpus Check
- 619 files · ~603,415 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3642 nodes · 7211 edges · 202 communities (191 shown, 11 thin omitted)
...
Cohesion: 0.06
Nodes (34): ApplicationHeader(), ApplicationPanel(), Breadcrumbs(), ContentTable(), DomainList(), DomainRow, KeyLegend(), KEYS (+26 more)
...
Cohesion: 0.1
Nodes (27): EnrolmentHandoff(), InviteAdminForm(), RotateTotpForm(), RotateTotpFormProps, SubmitButton(), TotpSetup(), TotpSetupProps, expiresIn() (+19 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (29): AuditRecord, Customer, customers, Invoice, InvoiceLine, invoiceLines, invoices, invoiceStatus (+21 more)

### Community 13 - "Community 13"
Cohesion: 0.1
Nodes (28): AdminRoster(), PendingAdminActions(), listAdmins(), RosterEntry, confirmEnrolment(), metadata, enrolmentUrl(), openPendingSecret() (+20 more)

### Community 14 - "Community 14"
Cohesion: 0.09
Nodes (33): expireOne(), ExpireSessionsResult, expireStaleSessions(), OPEN, AuditRecorder, FormPost, isPastExpiry(), isSessionIdShape() (+25 more)
...
Cohesion: 0.18
Nodes (25): AboutPage(), generateMetadata(), CareersPage(), generateMetadata(), metadataFor(), getPage, listPublishedProducts(), listPublishedServices() (+17 more)
...
Cohesion: 0.08
Nodes (27): Account, accountClass, accounts, normalBalance, Product, productKind, products, entryDirection (+19 more)

### Community 21 - "Community 21"
Cohesion: 0.15
Nodes (34): requireAdmin(), addCredentialAction(), confirmIdentity(), confirmIfProduction(), confirmName(), readDomains(), readId(), readScopes() (+26 more)
...
Cohesion: 0.1
Nodes (28): BookingFailure, BookingOutcome, BookingRecord, getAllLeads(), LeadEntry, LeadRecord, leadsStore, recordBooking() (+20 more)
...
Cohesion: 0.11
Nodes (20): BuildTiers(), PrinciplesSection(), CLOSING_HEADING, PRINCIPLES_HEADING, PRODUCTS_HEADING, STATEMENT, TIERS_HEADING, Statement() (+12 more)
...
Cohesion: 0.12
Nodes (20): Chip(), PostList(), PostSummary, ClosingCta(), DisciplineCluster(), SERVICES_HEADING, ServiceStep(), ServicesChapter() (+12 more)
...
Cohesion: 0.12
Nodes (24): confirmSessionPayment(), isPaymentError(), registerIfAbsent(), asJson(), eventIdFor(), ProviderEventInput, ProviderEventType, recordProviderEvent() (+16 more)

### Community 35 - "Community 35"
Cohesion: 0.26
Nodes (18): NotFound(), getLegalDocument, getPost, getProductPage, getService, listPublishedLegalDocuments(), published(), publishedSlugs() (+10 more)
...
Cohesion: 0.11
Nodes (11): metadata, SmoothScroll(), ChatWidget(), NAV_LINKS, SiteFooter(), LINKS, SiteHeader(), useScrolled() (+3 more)
...
Cohesion: 0.14
Nodes (20): uploadCmsImage(), UploadResult, cmsObjectKey(), DetectedImage, extensionForMime(), isImageMime(), Signature, SIGNATURES (+12 more)
...
Cohesion: 0.11
Nodes (12): Receipt, ReceiptInput, refunds, audited, makeAttempt(), makeSession(), NOW, receipts (+4 more)

### Community 45 - "Community 45"
Cohesion: 0.15
Nodes (22): close(), flag(), notify(), settle(), settleTransaction(), assertTransition(), canTransition(), isSettled() (+14 more)
...
Cohesion: 0.13
Nodes (19): assertRegisteredHost(), isRegisteredHost(), addDomain(), AddDomainInput, removeDomain(), normalizeHostname(), normalizeHostnameInput(), addCredential() (+11 more)
...
Cohesion: 0.18
Nodes (15): amountInWords(), numberInWords(), ONES, SCALES, TENS, underHundred(), underThousand(), InvoiceSheet() (+7 more)
...
Cohesion: 0.16
Nodes (12): EsewaConfig, FonepayConfig, callbackBase(), MockConfig, MockProviderAdapter, InitiateResult, PROVIDER_IDS, ProviderAdapter (+4 more)
...
Cohesion: 0.22
Nodes (16): attach(), invoiceAttachment(), receiptAttachment(), safe(), documentPdf(), DocumentPdfResult, documentKeyFor(), isFinal() (+8 more)
...
Cohesion: 0.15
Nodes (10): CraftConstellation(), CRAFT_DISCS, CraftDisc, Discipline, DISCIPLINES, Satellite, Drift(), Parallax() (+2 more)

### Community 66 - "Community 66"
Cohesion: 0.19
Nodes (14): listPayments(), PAYMENT_STATUSES, PaymentFilter, PaymentRow, PaymentTotals, whereFor(), formatNpr(), formatPaisa() (+6 more)
...
Cohesion: 0.18
Nodes (11): AccountingError, JournalLineInput, PostedJournal, PostJournalInput, InvoiceIssuedInput, InvoiceLineForPosting, PaymentReceivedInput, paymentReceivedJournal() (+3 more)
...
Cohesion: 0.3
Nodes (12): AdminGuard, requireAdminApi(), POST(), detectImage(), parseCmsImageKey(), publicBucket(), publicUrl(), r2() (+4 more)

### Community 79 - "Community 79"
Cohesion: 0.18
Nodes (13): INVOICE_STATUSES, InvoiceFilter, InvoiceRow, InvoiceTotals, listInvoices(), numberingGaps(), whereFor(), TableFilters() (+5 more)
...
Cohesion: 0.19
Nodes (11): PLACE_COORDINATES, PLACE_PHOTO, PlaceSection(), FormGround, FormKind, LightForm(), LightFormScene, useNearViewport() (+3 more)
...
Cohesion: 0.18
Nodes (15): assertRevenueAccounts(), defaultRevenueAccount(), assertLines(), assertServiceWindow(), CreatedInvoice, createInvoice(), CreateInvoiceInput, CUSTOMER_COLUMNS (+7 more)
...
Cohesion: 0.25
Nodes (12): DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailCategory, NAME_SUFFIX, EmailIdentity, fromHeaderFor(), normaliseDomain(), replyToFor() (+4 more)
...
Cohesion: 0.24
Nodes (9): ProductsSection(), RecentPosts(), ServicesSection(), homeTagline(), collapse(), splitLede(), HomePage(), JsonLd() (+1 more)
...
Cohesion: 0.32
Nodes (9): escapeHtml(), invoiceHtml(), page(), receiptHtml(), GET(), render(), safeFilename(), UNAUTHORIZED (+1 more)

### Community 109 - "Community 109"
Cohesion: 0.21
Nodes (11): allocateDocumentNo(), allocateSequence(), COLUMN, formatDocumentNo(), SequenceKind, TABLE, WIDTH, assertBalanced() (+3 more)
...
Cohesion: 0.33
Nodes (8): emailConfigured, resendClient(), configuredDomain(), fallbackIdentity(), resolveEmailIdentity(), EmailAttachment, Message, env
...
Cohesion: 0.46
Nodes (5): BlogIndexPage(), generateMetadata(), listPublishedPosts(), BS_MONTHS, formatBs()
...
Cohesion: 0.43
Nodes (4): ConfirmOutcome, sendEmail(), sendPaymentReceipt(), POST
...
- **Why does `isPaymentError()` connect `Community 34` to `Community 33`, `Community 2`, `Community 5`, `Community 45`, `Community 14`, `Community 21`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 31` to `Community 2`, `Community 136`, `Community 11`, `Community 18`, `Community 29`, `Community 30`, `Community 32`, `Community 162`, `Community 37`, `Community 38`, `Community 39`, `Community 40`, `Community 41`, `Community 43`, `Community 55`, `Community 65`, `Community 66`, `Community 85`, `Community 124`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `submitContact()` connect `Community 94` to `Community 11`?**
