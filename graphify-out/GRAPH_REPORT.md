...
## Corpus Check
- 648 files · ~632,607 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3892 nodes · 7817 edges · 211 communities (199 shown, 12 thin omitted)
...
Cohesion: 0.09
Nodes (35): callbackUrl(), decodeResponse(), EsewaConfig, EsewaProviderAdapter, HOSTS, missing(), STATUS, transactionUuidFor() (+27 more)
...
Cohesion: 0.11
Nodes (28): chromeBinary(), renderWithChrome(), run(), fontsArrived(), renderWithBundledChromium(), COL, drawInvoice(), dateLine() (+20 more)
...
Cohesion: 0.1
Nodes (32): expireOne(), ExpireSessionsResult, expireStaleSessions(), OPEN, isPaymentError(), FormPost, isPastExpiry(), isSessionIdShape() (+24 more)
...
Cohesion: 0.12
Nodes (28): dmSans, inter, metadata, outfit, plexMono, logoDataUri(), OpengraphImage(), size (+20 more)
...
Cohesion: 0.15
Nodes (20): EnrolmentHandoff(), RotateTotpFormProps, SubmitButton(), TotpSetupProps, expiresIn(), cn(), Button(), buttonClasses() (+12 more)
...
Cohesion: 0.13
Nodes (27): buildInvoiceDocument(), customerParty(), documentStatus(), documentIssues(), findInvoice(), findPayment(), InvoiceLineRecord, invoiceLinesFor() (+19 more)
...
Cohesion: 0.14
Nodes (22): publishContent(), unpublishContent(), revalidateContent(), saveContent(), ActionResult, databaseMessage(), parseId(), requireKind() (+14 more)
...
Cohesion: 0.12
Nodes (19): extractHeadings(), Heading, headingId(), INTEGRATION_PATH, integrationDoc(), stripRepoLinks(), DevelopersPage(), metadata (+11 more)
...
Cohesion: 0.1
Nodes (21): BuildTiers(), PrinciplesSection(), CLOSING_HEADING, PRINCIPLES_HEADING, PRODUCTS_HEADING, STATEMENT, TIERS_HEADING, Statement() (+13 more)
...
Cohesion: 0.13
Nodes (17): FieldError(), KIND_LABEL, NewProductDraft, ProductField(), ProductOption, ReauthFields(), DESCRIPTION, ScopeCheckboxes() (+9 more)
...
Cohesion: 0.11
Nodes (22): CashRow, listCash(), Offline, adminMode(), hasEverRun(), HeldPayment, heldPayments(), openRunItems() (+14 more)
...
Cohesion: 0.15
Nodes (18): TotpSetup(), confirmCashAction(), decide(), rejectCashAction(), confirmEnrolment(), EnrolPage(), metadata, openPendingSecret() (+10 more)
...
Cohesion: 0.1
Nodes (12): refunds, invoice(), audited, makeAttempt(), makeSession(), NOW, receipts, audited (+4 more)
...
Cohesion: 0.12
Nodes (17): DisciplineCluster(), Discipline, DISCIPLINES, Satellite, PLACE_COORDINATES, PLACE_PHOTO, PlaceSection(), SERVICES_HEADING (+9 more)
...
Cohesion: 0.13
Nodes (9): formatBsNumeric(), MarkArrow(), StaggerIn(), StaggerTag, CardItem, PageContainer(), BsDate(), Toast (+1 more)
...
Cohesion: 0.17
Nodes (13): CheckoutFlow(), CheckoutFlowProps, fmt(), PROVIDER_META, FonepayQr(), GatewayForm(), EsewaIcon(), FonepayIcon() (+5 more)
...
Cohesion: 0.16
Nodes (12): ClosingCta(), covering, DarkNavZone(), BlurIn(), FormGround, FormKind, LightForm(), LightFormScene (+4 more)
...
Cohesion: 0.16
Nodes (10): AdminRoster(), InviteAdminForm(), PendingAdminActions(), listAdmins(), RosterEntry, RotateTotpForm(), findTotpSecret(), credentialsSchema (+2 more)
...
Cohesion: 0.2
Nodes (13): nextPollAt(), pollDelayMs(), pollExhausted(), giveUp(), LIVE, PollPendingResult, pollPendingTransactions(), reschedule() (+5 more)
...
Cohesion: 0.18
Nodes (12): isIndexableLegalDocument(), LegalReadiness, JsonLd(), serialiseJsonLd(), crumbs, modified, node, output (+4 more)
...
Cohesion: 0.24
Nodes (8): DeviceScreen(), ProductsSection(), RecentPosts(), homeTagline(), collapse(), splitLede(), generateMetadata(), HomePage()
...
Cohesion: 0.24
Nodes (8): PublicationPanel(), PublishConfirm(), PublishPending(), Badge(), BadgeTone, STATUS_TONES, toneForStatus(), TONES
...
Cohesion: 0.28
Nodes (6): confirmSessionPayment(), BUSY, FonepayQrProps, NOTES, checkPayment(), latestAttempt()
...
Cohesion: 0.29
Nodes (5): CODES, LOGIN_FAILURE_MESSAGE, LoginFailure, LoginFailureCode, LoginPage()
...
Cohesion: 0.5
Nodes (3): Chip(), PostList(), PostSummary
...
- **Why does `isPaymentError()` connect `Community 15` to `Community 65`, `Community 34`, `Community 35`, `Community 4`, `Community 7`, `Community 43`, `Community 141`, `Community 46`, `Community 48`, `Community 50`, `Community 52`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Why does `decide()` connect `Community 43` to `Community 34`, `Community 28`, `Community 15`, `Community 127`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 23` to `Community 133`, `Community 9`, `Community 140`, `Community 148`, `Community 24`, `Community 30`, `Community 158`, `Community 33`, `Community 37`, `Community 38`, `Community 167`, `Community 41`, `Community 44`, `Community 175`, `Community 180`, `Community 56`, `Community 63`, `Community 64`, `Community 83`, `Community 100`, `Community 113`, `Community 121`?**
