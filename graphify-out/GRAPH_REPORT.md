...
## Corpus Check
- 612 files · ~581,657 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3615 nodes · 7157 edges · 198 communities (190 shown, 8 thin omitted)
...
Cohesion: 0.06
Nodes (35): ApplicationHeader(), ApplicationPanel(), Breadcrumbs(), ContentTable(), DomainList(), DomainRow, KeyLegend(), KEYS (+27 more)

### Community 5 - "Community 5"
Cohesion: 0.07
Nodes (46): confirmEnrolment(), EnrolPage(), metadata, openPendingSecret(), seal(), sealPendingSecret(), qrSvg(), activateWithSecret() (+38 more)
...
Cohesion: 0.11
Nodes (34): publishContent(), unpublishContent(), saveContent(), ActionResult, databaseMessage(), parseId(), requireKind(), getContent() (+26 more)

### Community 10 - "Community 10"
Cohesion: 0.09
Nodes (31): ClosingCta(), covering, DarkNavZone(), DisciplineCluster(), PrinciplesSection(), CLOSING_HEADING, PRINCIPLES_HEADING, PRODUCTS_HEADING (+23 more)
...
Cohesion: 0.09
Nodes (30): AdminRoster(), EnrolmentHandoff(), InviteAdminForm(), PendingAdminActions(), PublicationPanel(), PublishConfirm(), PublishPending(), listAdmins() (+22 more)
...
Cohesion: 0.08
Nodes (33): callbackUrl(), decodeResponse(), EsewaConfig, EsewaProviderAdapter, HOSTS, missing(), STATUS, transactionUuidFor() (+25 more)
...
Cohesion: 0.1
Nodes (32): CheckoutView, expireOne(), ExpireSessionsResult, expireStaleSessions(), OPEN, isPaymentError(), FormPost, isPastExpiry() (+24 more)
...
Cohesion: 0.14
Nodes (25): optionalText, requiredText, SEO_FIELDS, seoSchema, slugSchema, SORT_ORDER_FIELD, sortOrderSchema, tagsSchema (+17 more)
...
Cohesion: 0.09
Nodes (30): BookingFailure, BookingOutcome, BookingRecord, getAllLeads(), getAvailableSlots(), LeadEntry, LeadRecord, leadsStore (+22 more)
...
Cohesion: 0.11
Nodes (27): assertRegisteredHost(), isRegisteredHost(), addDomain(), normalizeHostname(), normalizeHostnameInput(), addCredential(), DomainInput, IssuedCredential (+19 more)

### Community 31 - "Community 31"
Cohesion: 0.17
Nodes (27): ContactDetails(), absoluteImage(), blogPostingNode(), collectionPageNode(), contactPageNode(), iso(), legalPageNode(), productNode() (+19 more)
...
Cohesion: 0.24
Nodes (18): NotFound(), getLegalDocument, getPost, getProductPage, getService, published(), publishedSlugs(), BS_MONTHS (+10 more)

### Community 34 - "Community 34"
Cohesion: 0.12
Nodes (25): offerable(), availableProviders(), ensureProvidersRegistered(), esewaConfig(), khaltiConfig(), MOCKABLE, MODES, registerIfAbsent() (+17 more)
...
Cohesion: 0.11
Nodes (18): authenticateApplication(), AuthenticatedApplication, bearerToken(), matchSecret(), unauthenticated(), AddDomainInput, Actor, AuditRecorder (+10 more)
...
Cohesion: 0.23
Nodes (24): requireAdmin(), addCredentialAction(), confirmIdentity(), confirmIfProduction(), confirmName(), readDomains(), readId(), readScopes() (+16 more)
...
Cohesion: 0.27
Nodes (13): NUMERIC_FIELDS, DashboardSnapshot, FILTERS, Card(), CardBody(), CardHeader(), CardTitle(), EmptyState() (+5 more)

### Community 46 - "Community 46"
Cohesion: 0.13
Nodes (12): Chip(), PostList(), PostSummary, cn(), PillPile(), PageContainer(), Skeleton(), SkeletonRows() (+4 more)
...
Cohesion: 0.11
Nodes (13): audited, makeAttempt(), makeSession(), NOW, receipts, audited, makePayable(), NOW (+5 more)
...
Cohesion: 0.16
Nodes (13): BLOOM_LAYERS, EXIT_DX, HeroArc(), CRESCENT_LAYERS, HeroEye(), EXIT_DX, Hero(), heroStart() (+5 more)
...
Cohesion: 0.15
Nodes (15): CheckoutFlow(), CheckoutFlowProps, fmt(), PROVIDER_META, GatewayForm(), EsewaIcon(), FonepayIcon(), KhaltiIcon() (+7 more)
...
Cohesion: 0.17
Nodes (13): BlogIndexPage(), listPublishedPosts(), listPublishedServices(), ProductsSection(), RecentPosts(), ServicesSection(), homeTagline(), collapse() (+5 more)
...
Cohesion: 0.22
Nodes (16): documentFile(), safeFilename(), attach(), invoiceAttachment(), receiptAttachment(), safe(), documentPdf(), escapeHtml() (+8 more)
...
Cohesion: 0.18
Nodes (11): AdminNav(), NavItem, SECTIONS, AdminLayout(), setAdminMode(), adminMode(), AdminModeSwitch(), MODES (+3 more)
...
Cohesion: 0.22
Nodes (6): OrderSummary(), metadata, Wordmark(), CheckoutPage(), metadata, buttonClasses()
...
Cohesion: 0.24
Nodes (8): DeviceScreen(), PLACE_COORDINATES, PLACE_PHOTO, PlaceSection(), CmsImage(), CmsImageFillProps, CmsImageProps, optimizable()
...
Cohesion: 0.27
Nodes (7): AdminGuard, requireAdminApi(), extensionForMime(), isImageMime(), key, message, POST()
...
Cohesion: 0.33
Nodes (4): StatusBadge(), metadata, MOCK_SUBSCRIPTIONS, SubscriptionRecord
...
## Knowledge Gaps
- **1488 isolated node(s):** `eslintConfig`, `RemotePatterns`, `TRUSTED_IMAGE_HOSTS`, `nextConfig`, `config` (+1483 more)
...
- **Why does `cn()` connect `Community 46` to `Community 32`, `Community 98`, `Community 36`, `Community 71`, `Community 40`, `Community 41`, `Community 10`, `Community 12`, `Community 45`, `Community 78`, `Community 16`, `Community 50`, `Community 84`, `Community 85`, `Community 121`, `Community 29`, `Community 57`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `isPaymentError()` connect `Community 17` to `Community 34`, `Community 37`, `Community 102`, `Community 42`, `Community 14`, `Community 15`, `Community 87`, `Community 55`, `Community 30`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `submitContact()` connect `Community 100` to `Community 16`, `Community 22`?**
