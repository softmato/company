# Graph Report - company  (2026-09-03)

## Corpus Check
- 597 files · ~555,397 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3403 nodes · 6833 edges · 206 communities (195 shown, 11 thin omitted)
...
1. `cn()` - 85 edges
2. `[Unreleased]` - 79 edges
3. `PaymentError` - 40 edges
4. `[Phase 1] — 2026-08-14` - 39 edges
5. `recordAudit()` - 36 edges
6. `metadataFor()` - 35 edges
7. `getPage` - 35 edges
8. `requireAdmin()` - 33 edges
9. `siteUrl()` - 27 edges
10. `breadcrumbList()` - 26 edges
...
- `registerApplicationAction()` --calls--> `registerApplication()`  [INFERRED]
  apps/web/app/(admin)/admin/applications/actions.ts → packages/payment-core/applications/manage.ts
- `updateApplicationAction()` --calls--> `updateApplication()`  [INFERRED]
  apps/web/app/(admin)/admin/applications/actions.ts → packages/payment-core/applications/manage.ts
- `addDomainAction()` --calls--> `addDomain()`  [INFERRED]
  apps/web/app/(admin)/admin/applications/domain-actions.ts → packages/payment-core/applications/domains-manage.ts
- `failure()` --calls--> `isPaymentError()`  [INFERRED]
  apps/web/app/(admin)/admin/applications/result.ts → packages/payment-core/errors.ts
...
Cohesion: 0.05
Nodes (40): call(), endpoint(), loaded, msg, [name, urlPath = '/', scrollArg = '0', width = '1440', height = '900'], pending, PORT, send() (+32 more)

### Community 2 - "Community 2"
Cohesion: 0.09
Nodes (30): AdminRoster(), EnrolmentHandoff(), InviteAdminForm(), PendingAdminActions(), PublishConfirm(), PublishPending(), listAdmins(), RosterEntry (+22 more)
...
Cohesion: 0.09
Nodes (31): BuildTiers(), ClosingCta(), DarkNavZone(), DeviceScreen(), PrinciplesSection(), CLOSING_HEADING, PRINCIPLES_HEADING, PRODUCTS_HEADING (+23 more)
...
Cohesion: 0.06
Nodes (48): 1. Conventions, 2. Authentication, 3. Endpoints, 4. Outbound webhooks, 5.1 `manual_qr`, 5.1 `manual_qr` — **removed 2026-08-16**, 5.2 Khalti (KPG v2), 5.3 eSewa (+40 more)

### Community 7 - "Community 7"
Cohesion: 0.08
Nodes (42): EnrolPage(), openPendingSecret(), seal(), sealPendingSecret(), authorize(), decryptSecret(), deriveFromKey(), encryptSecret() (+34 more)
...
Cohesion: 0.09
Nodes (37): nextPollAt(), pollDelayMs(), pollExhausted(), giveUp(), LIVE, PollPendingResult, pollPendingTransactions(), reschedule() (+29 more)

### Community 10 - "Community 10"
Cohesion: 0.12
Nodes (33): buildInvoiceDocument(), customerParty(), documentStatus(), documentIssues(), SheetWarning(), readPresentation(), findInvoice(), findPayment() (+25 more)

### Community 11 - "Community 11"
Cohesion: 0.18
Nodes (25): AboutPage(), generateMetadata(), BlogIndexPage(), generateMetadata(), CareersPage(), generateMetadata(), metadataFor(), getPage (+17 more)

### Community 12 - "Community 12"
Cohesion: 0.12
Nodes (33): dmSans, inter, metadata, outfit, plexMono, robots(), siteUrl(), absoluteImage() (+25 more)

### Community 13 - "Community 13"
Cohesion: 0.09
Nodes (29): ReauthFields(), DESCRIPTION, ScopeCheckboxes(), revokeApplicationAction(), rotateSecretAction(), assertRegisteredHost(), isRegisteredHost(), normalizeHostname() (+21 more)
...
Cohesion: 0.08
Nodes (34): BookingFailure, BookingOutcome, BookingRecord, getAvailableSlots(), LeadEntry, LeadRecord, leadsStore, recordBooking() (+26 more)

### Community 16 - "Community 16"
Cohesion: 0.1
Nodes (23): EsewaConfig, FonepayConfig, callbackUrl(), HOSTS, isLookupAnswer(), KhaltiConfig, KhaltiProviderAdapter, parseJson() (+15 more)
...
Cohesion: 0.05
Nodes (38): 1. What each side owns, 2.1 Raise an invoice, 2.2 Send the customer to pay, 2.3 Learn that they paid, 2.4 Show the customer their records, 2. The happy path, in four calls, 3. Sending your plan details, 4. Things that will bite you (+30 more)
...
Cohesion: 0.17
Nodes (20): NotFound(), getPost, getProductPage, getService, publishedSlugs(), BS_MONTHS, formatBs(), formatBsWithAd() (+12 more)

### Community 21 - "Community 21"
Cohesion: 0.11
Nodes (22): extractHeadings(), Heading, headingId(), INTEGRATION_PATH, integrationDoc(), stripRepoLinks(), DevelopersPage(), metadata (+14 more)

### Community 22 - "Community 22"
Cohesion: 0.16
Nodes (22): optionalText, requiredText, SEO_FIELDS, seoSchema, slugSchema, SORT_ORDER_FIELD, sortOrderSchema, tagsSchema (+14 more)
...
Cohesion: 0.12
Nodes (22): confirmEnrolment(), metadata, enrolmentUrl(), qrSvg(), activateWithSecret(), createPendingAdmin(), deletePendingAdmin(), findEnrolmentSubject() (+14 more)
...
Cohesion: 0.13
Nodes (21): amountInWords(), numberInWords(), ONES, SCALES, TENS, underHundred(), underThousand(), InvoiceSheet() (+13 more)
...
Cohesion: 0.18
Nodes (22): publishContent(), unpublishContent(), saveContent(), ActionResult, databaseMessage(), parseId(), requireAdmin(), requireKind() (+14 more)

### Community 32 - "Community 32"
Cohesion: 0.1
Nodes (19): FiscalPeriod, fiscalPeriods, periodStatus, entryDirection, journalEntries, JournalEntry, journalSource, ledgerEntries (+11 more)

### Community 33 - "Community 33"
Cohesion: 0.14
Nodes (20): expireOne(), ExpireSessionsResult, expireStaleSessions(), OPEN, isPastExpiry(), expireIfDue(), loadPayableSession(), loadSession() (+12 more)

### Community 34 - "Community 34"
Cohesion: 0.14
Nodes (18): ApplicationPanel(), Breadcrumbs(), ContentTable(), RegisterApplicationForm(), ApplicationsPage(), ApplicationDetail, getApplicationDetail(), listApplications() (+10 more)
...
Cohesion: 0.16
Nodes (15): documentFile(), DocumentFormat, joinReference(), safeFilename(), encodeRandom(), encodeTime(), newRequestId(), apiError() (+7 more)

### Community 37 - "Community 37"
Cohesion: 0.12
Nodes (22): paisa(), party(), serializeInvoiceDocument(), serializeReceiptDocument(), CUSTOMER, DUE, ISSUED, SAMPLE_INVOICE (+14 more)

### Community 38 - "Community 38"
Cohesion: 0.16
Nodes (12): covering, BLOOM_LAYERS, EXIT_DX, HeroArc(), CRESCENT_LAYERS, HeroEye(), EXIT_DX, Hero() (+4 more)

### Community 39 - "Community 39"
Cohesion: 0.12
Nodes (21): BlogPostSeed, blogPostSeeds, LegalDocumentSeed, legalDocumentSeeds, PageSeed, pageSeeds, ProductPageSeed, productPageSeeds (+13 more)

### Community 40 - "Community 40"
Cohesion: 0.1
Nodes (20): Account, accountClass, normalBalance, Product, productKind, products, Application, APPLICATION_SCOPES (+12 more)
...
Cohesion: 0.1
Nodes (21): accounts, deliveryStatus, idempotencyKeys, PaymentSession, ProviderEvent, providerEvents, Refund, refundStatus (+13 more)

### Community 43 - "Community 43"
Cohesion: 0.16
Nodes (18): availableProviders(), ensureProvidersRegistered(), MOCKABLE, registerIfAbsent(), registerMocks(), registerReal(), hasProvider(), providerAdapter() (+10 more)
...
Cohesion: 0.1
Nodes (23): 1. Local setup, 2. Variables, 3. File storage, 4. Environments, 5. Deployment, 6. Cron, 7. Cost, 8. Secrets (+15 more)

### Community 46 - "Community 46"
Cohesion: 0.09
Nodes (23): Blocked on external parties, Blocked on the founder, code:bash (pnpm install && pnpm dev      # localhost:3000, admin.localh), code:markdown (### Session N — YYYY-MM-DD), Current status, Decisions made, Deviations from the docs, Memory (+15 more)

### Community 47 - "Community 47"
Cohesion: 0.15
Nodes (15): AccountingError, assertBalanced(), JournalLineInput, PostedJournal, postJournal(), PostJournalInput, resolveFiscalPeriod(), InvoiceIssuedInput (+7 more)
...
Cohesion: 0.09
Nodes (21): ☐ 10. Publish `sdk-v0.1.1`, ☐ 11. Signal the rotation overlap, ☑ 1. Correct the base URL, ☑ 2. Build `GET /v1/transactions/{id}`, ☑ 3. Build `POST /v1/refunds`, ☐ 4. Move the re-authentication gate to where it does something, ☐ 5. One application, two credential sets, ☐ 6. Sandbox and Production, everywhere a person reads (+13 more)

### Community 51 - "Community 51"
Cohesion: 0.2
Nodes (15): DocumentPdfResult, DocumentKeyInput, documentPdfKey(), hex(), segment(), documentKeyFor(), isFinal(), readDocumentPdf() (+7 more)
...
Cohesion: 0.13
Nodes (13): CraftConstellation(), CRAFT_DISCS, CraftDisc, DisciplineCluster(), Discipline, DISCIPLINES, Satellite, PLACE_COORDINATES (+5 more)
...
Cohesion: 0.16
Nodes (10): Chip(), PostList(), PostSummary, cn(), PillPile(), PageContainer(), StillFrame(), EmptyState() (+2 more)
...
Cohesion: 0.21
Nodes (13): auditActions(), AuditRow, listAuditEntries(), NUMERIC_FIELDS, AuditLogPage(), FilterLink(), formatBsNumeric(), BsDate() (+5 more)

### Community 59 - "Community 59"
Cohesion: 0.19
Nodes (14): DomainList(), DomainRow, confirmIdentity(), readDomains(), readScopes(), registerApplicationAction(), registerSchema, revealWebhookSecretAction() (+6 more)
...
Cohesion: 0.14
Nodes (14): AiProvider, defaultAiProvider, SmartFallbackProvider, AiProviderChatParams, AiProviderResponse, BookMeetingParams, ChatMessage, ContactHumanParams (+6 more)

### Community 66 - "Community 66"
Cohesion: 0.16
Nodes (11): ConfirmOutcome, POST, POST, jobEndpoint(), JobHandler, equalInConstantTime(), isAuthorisedJobRequest(), NOT_FOUND (+3 more)

### Community 67 - "Community 67"
Cohesion: 0.22
Nodes (15): DEFAULT_MAILBOXES, EMAIL_CATEGORIES, NAME_SUFFIX, EmailIdentity, fromHeaderFor(), normaliseDomain(), replyToFor(), configuredDomain() (+7 more)
...
Cohesion: 0.12
Nodes (15): PageSeed, pageSeeds, ServiceSeed, serviceSeeds, BlogPost, ContactSubmission, contactSubmissions, contentStatus (+7 more)

### Community 71 - "Community 71"
Cohesion: 0.14
Nodes (15): addDomain(), AddDomainInput, removeDomain(), Actor, AuditRecorder, FormPost, text(), displayable() (+7 more)
...
Cohesion: 0.27
Nodes (14): attach(), invoiceAttachment(), receiptAttachment(), safe(), documentPdf(), escapeHtml(), invoiceHtml(), page() (+6 more)
...
Cohesion: 0.35
Nodes (8): DashboardSnapshot, FILTERS, Card(), CardBody(), CardHeader(), CardTitle(), Money(), StatTile()
...
Cohesion: 0.12
Nodes (12): ESEWA_KEYS, esewaSet, hex32, issues, missing, parsed, PRIVATE_R2_KEYS, privateR2Set (+4 more)
...
Cohesion: 0.18
Nodes (12): listPayments(), PAYMENT_STATUSES, PaymentFilter, PaymentRow, PaymentTotals, whereFor(), TableFilters(), TableFiltersProps (+4 more)

### Community 82 - "Community 82"
Cohesion: 0.18
Nodes (11): ServicesChapter(), BlurIn(), TextTag, FormGround, FormKind, LightForm(), LightFormScene, useNearViewport() (+3 more)

### Community 83 - "Community 83"
Cohesion: 0.16
Nodes (9): Receipt, ReceiptInput, audited, makeAttempt(), makeSession(), NOW, receipts, INPUT (+1 more)

### Community 84 - "Community 84"
Cohesion: 0.13
Nodes (9): adapter, mockAdapter, mockSession, mockTxn, txn, NOW, PERIOD_ENDS, PERIOD_STARTS (+1 more)

### Community 85 - "Community 85"
Cohesion: 0.27
Nodes (12): sitemap(), isIndexableLegalDocument(), LegalReadiness, getLegalDocument, listPublishedLegalDocuments(), listPublishedPosts(), listPublishedProducts(), listPublishedServices() (+4 more)

### Community 86 - "Community 86"
Cohesion: 0.2
Nodes (14): assertRevenueAccounts(), defaultRevenueAccount(), assertLines(), assertServiceWindow(), CreatedInvoice, createInvoice(), CreateInvoiceInput, CUSTOMER_COLUMNS (+6 more)
...
Cohesion: 0.15
Nodes (11): AuditRecord, paymentSessions, audited, entry, expiresAt, makeSession(), NOW, PERIOD_ENDS (+3 more)
...
Cohesion: 0.23
Nodes (11): mutatingEndpoint(), paisa(), serializeInvoice(), serializeRefund(), serializeSession(), serializeTransaction(), serializeTransactionView(), POST (+3 more)

### Community 92 - "Community 92"
Cohesion: 0.23
Nodes (11): INVOICE_STATUSES, InvoiceFilter, InvoiceRow, InvoiceTotals, listInvoices(), numberingGaps(), whereFor(), AdminInvoicesPage() (+3 more)

### Community 93 - "Community 93"
Cohesion: 0.24
Nodes (12): Glyph(), IconBell(), IconCamera(), IconDownload(), IconFingerprint(), IconHome(), IconOffline(), IconPin() (+4 more)
...
Cohesion: 0.29
Nodes (10): ContactResult, schema, submitContact(), ContactNotification, notifyContact(), hashIp(), isRateLimited(), SendResult (+2 more)

### Community 96 - "Community 96"
Cohesion: 0.14
Nodes (10): BlogPostSeed, blogPostSeeds, blogPosts, teamMembers, draft, effectiveAt, live, returned (+2 more)

### Community 97 - "Community 97"
Cohesion: 0.23
Nodes (11): confirmSessionPayment(), isPaymentError(), asJson(), eventIdFor(), ProviderEventInput, ProviderEventType, recordProviderEvent(), refusal() (+3 more)
...
Cohesion: 0.27
Nodes (7): chromeBinary(), renderWithChrome(), run(), fontsArrived(), renderWithBundledChromium(), renderPdf(), PdfResult

### Community 103 - "Community 103"
Cohesion: 0.23
Nodes (6): SmoothScroll(), ChatWidget(), NAV_LINKS, LINKS, SiteHeader(), useScrolled()
...
Cohesion: 0.23
Nodes (10): CreatedSession, createSession(), CreateSessionInput, ownedInvoice(), providersForAmount(), generateSessionId(), isSessionIdShape(), seen (+2 more)

### Community 106 - "Community 106"
Cohesion: 0.21
Nodes (9): Customer, customers, Invoice, InvoiceLine, invoiceLines, invoices, invoiceStatus, stale (+1 more)
...
Cohesion: 0.24
Nodes (7): CallbackPage(), metadata, CheckoutNotice(), CheckoutNoticeProps, Tone, ReturnLink, returnLinkFor()

### Community 114 - "Community 114"
Cohesion: 0.23
Nodes (5): ContentForm(), KindCard(), PublicationPanel(), StatusBadge(), Field()

### Community 115 - "Community 115"
Cohesion: 0.27
Nodes (8): EmailCategory, emailConfigured, resendClient(), EmailAttachment, Message, EmailTemplate, env, BookingEmailData
...
Cohesion: 0.27
Nodes (8): ProductsSection(), RecentPosts(), ServicesSection(), homeTagline(), collapse(), splitLede(), generateMetadata(), HomePage()
...
Cohesion: 0.25
Nodes (9): buildSnapshots(), invoiceMetadata(), InvoiceSnapshots, PartySnapshot, CUSTOMER_ROW, forged, metadata, SELLER (+1 more)

### Community 125 - "Community 125"
Cohesion: 0.2
Nodes (9): ProductPageSeed, productPageSeeds, legalDocuments, productPages, createdSlugs, effectiveAt, slug(), unique() (+1 more)

### Community 126 - "Community 126"
Cohesion: 0.24
Nodes (4): FonepayProviderAdapter, unavailable(), adapter, surface
...
Cohesion: 0.31
Nodes (8): CheckoutProvider, CheckoutView, offerable(), summarise(), Summary, CheckoutPage(), metadata, buttonClasses()

### Community 132 - "Community 132"
Cohesion: 0.24
Nodes (8): Tone, TONE_BY_STATUS, TONES, Badge(), BadgeTone, STATUS_TONES, toneForStatus(), TONES
...
Cohesion: 0.28
Nodes (8): allocateDocumentNo(), allocateSequence(), COLUMN, formatDocumentNo(), SequenceKind, TABLE, WIDTH, requestRefund()

### Community 137 - "Community 137"
Cohesion: 0.31
Nodes (7): EnqueueResult, enqueueWebhook(), buildPayload(), EVENT_BY_STATUS, WEBHOOK_EVENTS, WebhookEvent, WebhookPayload
...
Cohesion: 0.4
Nodes (4): QUALITIES, Quality, QualityPile(), TONE_CLASS
...
Cohesion: 0.33
Nodes (5): DEFAULT_RECEIVABLE_BY_KIND, DEFAULT_REVENUE_BY_KIND, InvoiceableProductKind, RECEIVABLE, REVENUE
...
Cohesion: 0.6
Nodes (4): getAllLeads(), updateLeadStatus(), GET(), PATCH()

### Community 171 - "Community 171"
Cohesion: 0.4
Nodes (4): chromeBinary, chromiumUsable, renderWithBundledChromium, renderWithChrome
...
## Knowledge Gaps
- **1341 isolated node(s):** `eslintConfig`, `RemotePatterns`, `TRUSTED_IMAGE_HOSTS`, `nextConfig`, `config` (+1336 more)
...
- **Why does `isPaymentError()` connect `Community 97` to `Community 33`, `Community 3`, `Community 36`, `Community 131`, `Community 9`, `Community 43`, `Community 13`, `Community 59`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 55` to `Community 2`, `Community 131`, `Community 4`, `Community 132`, `Community 11`, `Community 144`, `Community 145`, `Community 19`, `Community 21`, `Community 27`, `Community 30`, `Community 168`, `Community 48`, `Community 53`, `Community 58`, `Community 77`, `Community 82`, `Community 93`, `Community 103`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `headers` connect `Community 95` to `Community 32`?**
