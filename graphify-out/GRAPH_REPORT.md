...
## Corpus Check
- 590 files · ~543,928 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3337 nodes · 6688 edges · 183 communities (172 shown, 11 thin omitted)
...
Cohesion: 0.05
Nodes (112): AboutPage(), generateMetadata(), dmSans, inter, metadata, outfit, plexMono, NotFound() (+104 more)
...
Cohesion: 0.07
Nodes (48): confirmEnrolment(), EnrolPage(), metadata, openPendingSecret(), seal(), sealPendingSecret(), qrSvg(), activateWithSecret() (+40 more)
...
Cohesion: 0.07
Nodes (37): ApplicationPanel(), Breadcrumbs(), ContentTable(), RegisterApplicationForm(), SettingsForm(), ApplicationsPage(), ApplicationDetail, ApplicationSummary (+29 more)

### Community 7 - "Community 7"
Cohesion: 0.08
Nodes (32): AdminRoster(), EnrolmentHandoff(), InviteAdminForm(), PendingAdminActions(), PublicationPanel(), PublishConfirm(), PublishPending(), listAdmins() (+24 more)
...
Cohesion: 0.13
Nodes (31): buildInvoiceDocument(), customerParty(), documentStatus(), documentIssues(), findInvoice(), findPayment(), InvoiceLineRecord, invoiceLinesFor() (+23 more)

### Community 15 - "Community 15"
Cohesion: 0.07
Nodes (34): products, Application, APPLICATION_SCOPES, ApplicationDomain, applicationDomains, applications, ApplicationScope, Customer (+26 more)
...
Cohesion: 0.09
Nodes (20): DarkNavZone(), DeviceScreen(), Discipline, DISCIPLINES, Satellite, PLACE_COORDINATES, PLACE_PHOTO, PlaceSection() (+12 more)

### Community 28 - "Community 28"
Cohesion: 0.11
Nodes (18): Chip(), PostList(), PostSummary, DisciplineCluster(), ServiceStep(), ServiceStepData, cn(), MarkArrow() (+10 more)
...
Cohesion: 0.15
Nodes (19): enrolmentUrl(), createPendingAdmin(), deletePendingAdmin(), findPendingAdmin(), PendingAdmin, pendingOnly(), reclaimPendingAdmin(), replaceSecret() (+11 more)
...
Cohesion: 0.17
Nodes (18): publishContent(), unpublishContent(), saveContent(), ActionResult, databaseMessage(), parseId(), requireKind(), ContentForm() (+10 more)
...
Cohesion: 0.25
Nodes (14): NUMERIC_FIELDS, DashboardSnapshot, FILTERS, Card(), CardBody(), CardHeader(), CardTitle(), EmptyState() (+6 more)
...
Cohesion: 0.15
Nodes (19): isPaymentError(), registerReal(), asJson(), eventIdFor(), ProviderEventInput, ProviderEventType, recordProviderEvent(), hasProvider() (+11 more)
...
Cohesion: 0.15
Nodes (13): PrinciplesSection(), QUALITIES, Quality, QualityPile(), TONE_CLASS, ServicesChapter(), ServicesSection(), LightForm() (+5 more)
...
Cohesion: 0.13
Nodes (12): AuditRecord, FiscalPeriod, fiscalPeriods, periodStatus, bsCalendar, BsMonthBoundary, FiscalPeriodSeed, audited (+4 more)
...
Cohesion: 0.22
Nodes (9): ClosingCta(), covering, BlurIn(), TextTag, prefersReducedMotion(), registerMotionPlugins(), TextTag, ToneReveal() (+1 more)
...
Cohesion: 0.16
Nodes (15): uploadCmsImage(), UploadResult, cmsObjectKey(), DetectedImage, ImageMime, Signature, SIGNATURES, validateImage() (+7 more)
...
Cohesion: 0.2
Nodes (10): AuditDetail(), changedKeys(), auditActions(), AuditRow, listAuditEntries(), AuditLogPage(), FilterLink(), formatAd() (+2 more)
...
Cohesion: 0.2
Nodes (11): mutatingEndpoint(), paisa(), serializeInvoice(), serializeSession(), serializeTransaction(), POST, schema, prerenderInvoicePdf() (+3 more)
...
Cohesion: 0.22
Nodes (7): AdminNav(), NavItem, SECTIONS, AdminLayout(), initials(), StaggerIn(), StaggerTag
...
Cohesion: 0.27
Nodes (10): CheckoutProvider, CheckoutView, offerable(), summarise(), Summary, readPresentation(), availableProviders(), CheckoutPage() (+2 more)
...
Cohesion: 0.39
Nodes (5): RecentPosts(), homeTagline(), collapse(), splitLede(), HomePage()
...
## Knowledge Gaps
- **1310 isolated node(s):** `eslintConfig`, `RemotePatterns`, `TRUSTED_IMAGE_HOSTS`, `nextConfig`, `config` (+1305 more)
...
- **Why does `cn()` connect `Community 28` to `Community 0`, `Community 128`, `Community 6`, `Community 7`, `Community 149`, `Community 27`, `Community 29`, `Community 32`, `Community 34`, `Community 35`, `Community 39`, `Community 42`, `Community 48`, `Community 61`, `Community 75`, `Community 94`, `Community 95`, `Community 105`, `Community 111`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `isPaymentError()` connect `Community 40` to `Community 38`, `Community 8`, `Community 105`, `Community 11`, `Community 12`, `Community 78`, `Community 17`, `Community 88`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `headers` connect `Community 19` to `Community 122`?**
