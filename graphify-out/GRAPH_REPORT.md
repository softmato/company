# Graph Report - company  (2026-09-21)

## Corpus Check
- 639 files · ~628,416 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3810 nodes · 7526 edges · 203 communities (191 shown, 12 thin omitted)
...
2. `cn()` - 85 edges
3. `[Phase 1] — 2026-08-14` - 57 edges
4. `PaymentError` - 43 edges
...
- `session()` --calls--> `generateSessionId()`  [INFERRED]
  apps/web/tests/return-url-allowlist.test.ts → packages/payment-core/sessions/id.ts

## Communities (203 total, 12 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (187): Added, Added, Added, Added, Added, Added, Added, Added (+179 more)
...
Cohesion: 0.06
Nodes (40): products, Application, APPLICATION_SCOPES, ApplicationCredential, applicationCredentials, ApplicationDomain, applicationDomains, applications (+32 more)

### Community 6 - "Community 6"
Cohesion: 0.09
Nodes (34): publishContent(), unpublishContent(), revalidateContent(), saveContent(), ActionResult, databaseMessage(), parseId(), requireKind() (+26 more)
...
Cohesion: 0.13
Nodes (28): NotFound(), extractHeadings(), Heading, headingId(), getLegalDocument, getPost, getProductPage, getService (+20 more)
...
Cohesion: 0.17
Nodes (27): NUMERIC_FIELDS, DashboardSnapshot, FILTERS, FilterLink(), Chip(), PostList(), PostSummary, formatBsNumeric() (+19 more)
...
Cohesion: 0.11
Nodes (21): CraftConstellation(), CRAFT_DISCS, CraftDisc, BLOOM_LAYERS, EXIT_DX, HeroArc(), CRESCENT_LAYERS, HeroEye() (+13 more)

### Community 13 - "Community 13"
Cohesion: 0.08
Nodes (30): EsewaConfig, FonepayConfig, callbackUrl(), HOSTS, isLookupAnswer(), KhaltiConfig, KhaltiProviderAdapter, parseJson() (+22 more)

### Community 14 - "Community 14"
Cohesion: 0.1
Nodes (27): EnrolmentHandoff(), InviteAdminForm(), PublishConfirm(), PublishPending(), RotateTotpForm(), RotateTotpFormProps, SubmitButton(), expiresIn() (+19 more)
...
Cohesion: 0.07
Nodes (26): accounts, FiscalPeriod, fiscalPeriods, periodStatus, entryDirection, journalEntries, JournalEntry, journalSource (+18 more)

### Community 17 - "Community 17"
Cohesion: 0.07
Nodes (30): DisciplineCluster(), Discipline, DISCIPLINES, Satellite, PLACE_COORDINATES, PLACE_PHOTO, PlaceSection(), PrinciplesSection() (+22 more)
...
Cohesion: 0.1
Nodes (27): expireOne(), ExpireSessionsResult, expireStaleSessions(), OPEN, PAYMENT_ERROR_STATUS, PaymentErrorCode, PUBLIC_MESSAGE, isPastExpiry() (+19 more)
...
Cohesion: 0.12
Nodes (22): AdminRoster(), PendingAdminActions(), listAdmins(), RosterEntry, TotpSetup(), TotpSetupProps, confirmEnrolment(), metadata (+14 more)
...
Cohesion: 0.11
Nodes (21): ApplicationHeader(), FieldError(), KIND_LABEL, NewProductDraft, ProductField(), ProductOption, ReauthFields(), DESCRIPTION (+13 more)

### Community 29 - "Community 29"
Cohesion: 0.1
Nodes (22): listPublishedServices(), ClosingCta(), covering, DarkNavZone(), DeviceScreen(), ProductsSection(), RecentPosts(), ServicesSection() (+14 more)
...
Cohesion: 0.09
Nodes (29): assertRevenueAccounts(), defaultRevenueAccount(), assertLines(), assertServiceWindow(), CreatedInvoice, createInvoice(), CreateInvoiceInput, CUSTOMER_COLUMNS (+21 more)
...
Cohesion: 0.1
Nodes (23): AccountingError, allocateDocumentNo(), allocateSequence(), COLUMN, formatDocumentNo(), SequenceKind, TABLE, WIDTH (+15 more)
...
Cohesion: 0.13
Nodes (17): Eclipse(), Orb(), FORM_COLORS, KATHMANDU, PointGlobe(), Showcase(), useIdleSpin(), SURFACES (+9 more)

### Community 41 - "Community 41"
Cohesion: 0.16
Nodes (23): buildInvoiceDocument(), customerParty(), documentStatus(), findInvoice(), findPayment(), InvoiceLineRecord, invoiceLinesFor(), InvoiceRecord (+15 more)

### Community 42 - "Community 42"
Cohesion: 0.1
Nodes (17): generateSessionId(), audited, makeAttempt(), makeSession(), NOW, receipts, audited, makePayable() (+9 more)
...
Cohesion: 0.1
Nodes (16): CallbackPage(), metadata, CheckoutNotice(), CheckoutNoticeProps, Tone, confirmSessionPayment(), BUSY, FonepayQr() (+8 more)
...
Cohesion: 0.15
Nodes (17): documentFile(), DocumentFormat, joinReference(), safeFilename(), encodeRandom(), encodeTime(), newRequestId(), apiError() (+9 more)

### Community 47 - "Community 47"
Cohesion: 0.14
Nodes (21): isPaymentError(), asJson(), eventIdFor(), ProviderEventInput, ProviderEventType, recordProviderEvent(), hasProvider(), providerAdapter() (+13 more)
...
Cohesion: 0.14
Nodes (14): bankApps(), BankReply, FonepayConfig, FonepayProviderAdapter, HOSTS, STATUS, StatusReply, PaymentError (+6 more)
...
Cohesion: 0.12
Nodes (16): AdminNav(), NavItem, SECTIONS, AdminLayout(), setAdminMode(), adminMode(), AdminModeSwitch(), MODES (+8 more)
...
Cohesion: 0.18
Nodes (18): DEFAULT_MAILBOXES, EMAIL_CATEGORIES, NAME_SUFFIX, emailConfigured, resendClient(), EmailIdentity, fromHeaderFor(), normaliseDomain() (+10 more)
...
Cohesion: 0.19
Nodes (17): ConfirmOutcome, availableProviders(), availableFor(), registerFromEnv(), ensureProvidersRegistered(), esewaConfig(), khaltiConfig(), MOCKABLE (+9 more)

### Community 70 - "Community 70"
Cohesion: 0.2
Nodes (15): EmailCategory, DetailRow, escapeHtml(), layout(), LayoutOptions, paragraph(), rowsTable(), EmailTemplate (+7 more)
...
Cohesion: 0.16
Nodes (14): authenticateApplication(), AuthenticatedApplication, bearerToken(), matchSecret(), unauthenticated(), AuditRecorder, FiledRefund, REFUNDABLE (+6 more)
...
Cohesion: 0.23
Nodes (13): paisa(), party(), serializeInvoiceDocument(), serializeReceiptDocument(), documentIssues(), blankAsNull(), missingSellerFields(), sellerParty() (+5 more)
...
Cohesion: 0.24
Nodes (12): enrolmentUrl(), createPendingAdmin(), findPendingAdmin(), reclaimPendingAdmin(), buildHandoff(), Handoff, inviteAdmin(), InviteResult (+4 more)
...
Cohesion: 0.26
Nodes (9): sitemap(), isIndexableLegalDocument(), LegalReadiness, listPublishedLegalDocuments(), published(), publishedPageSlugs(), ContactDetails(), SiteFooter() (+1 more)
...
Cohesion: 0.18
Nodes (10): Brand rules (from the guidelines), Cautions, code:json ({"merchantId":"2222040021755313","deviceId":"433ea55d-…",), code:block2 (MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAvg3896JXlW6z7lAQ), Files, Flows, Fonepay — Checkout by Fonepay (Nabil Bank), Our key (+2 more)
...
## Knowledge Gaps
- **1576 isolated node(s):** `eslintConfig`, `RemotePatterns`, `TRUSTED_IMAGE_HOSTS`, `nextConfig`, `config` (+1571 more)
...
- **Why does `isPaymentError()` connect `Community 47` to `Community 64`, `Community 4`, `Community 5`, `Community 38`, `Community 44`, `Community 46`, `Community 22`, `Community 24`, `Community 28`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 10` to `Community 163`, `Community 36`, `Community 164`, `Community 8`, `Community 43`, `Community 12`, `Community 171`, `Community 45`, `Community 14`, `Community 15`, `Community 17`, `Community 146`, `Community 111`, `Community 52`, `Community 23`, `Community 55`, `Community 29`, `Community 63`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `env` connect `Community 46` to `Community 33`, `Community 98`, `Community 66`, `Community 69`, `Community 103`, `Community 73`, `Community 79`, `Community 15`, `Community 51`, `Community 56`, `Community 25`, `Community 29`, `Community 30`?**
