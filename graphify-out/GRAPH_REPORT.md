...
## Summary
- 1677 nodes · 3250 edges · 97 communities (93 shown, 4 thin omitted)
...
Cohesion: 0.07
Nodes (31): Application, APPLICATION_SCOPES, applications, ApplicationScope, Customer, customers, Invoice, InvoiceLine (+23 more)

### Community 9 - "Community 9"
Cohesion: 0.11
Nodes (23): PrinciplesSection(), PRINCIPLES_HEADING, SERVICES_HEADING, STATEMENT, TIERS_HEADING, ServiceStep(), ServicesChapter(), ServiceStepData (+15 more)
...
Cohesion: 0.09
Nodes (22): allocateDocumentNo(), allocateSequence(), COLUMN, formatDocumentNo(), SequenceKind, TABLE, WIDTH, FiscalPeriod (+14 more)
...
Cohesion: 0.1
Nodes (19): Account, accountClass, accounts, normalBalance, Product, productKind, products, vProductPl (+11 more)
...
Cohesion: 0.22
Nodes (16): NUMERIC_FIELDS, Chip(), PostList(), PostSummary, cn(), Card(), CardBody(), CardHeader() (+8 more)
...
Cohesion: 0.19
Nodes (13): isPastExpiry(), isSessionIdShape(), expireIfDue(), loadPayableSession(), loadSession(), assertOffered(), selectProvider(), isPayable() (+5 more)
...
Cohesion: 0.18
Nodes (15): everything, displayable(), liveAttempt(), StartedPayment, startPayment(), StartPaymentInput, storedInitiate(), TXN_STATUSES (+7 more)
...
Cohesion: 0.17
Nodes (10): PAYMENT_ERROR_STATUS, PaymentError, PaymentErrorCode, PUBLIC_MESSAGE, assertTransition(), canTransition(), PAYABLE, SessionStatus (+2 more)
...
Cohesion: 0.23
Nodes (8): DeviceScreen(), PLACE_COORDINATES, PLACE_PHOTO, PlaceSection(), PRODUCTS_HEADING, Parallax(), TextTag, WordReveal()
...
Cohesion: 0.24
Nodes (6): ClosingCta(), covering, DarkNavZone(), CLOSING_HEADING, BlurIn(), TextTag
...
- **Why does `submitContact()` connect `Community 2` to `Community 48`, `Community 17`?**
  _High betweenness centrality (0.104) - this node is a cross-community bridge._
- **Why does `headers` connect `Community 17` to `Community 2`?**
  _High betweenness centrality (0.104) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 19` to `Community 64`, `Community 0`, `Community 33`, `Community 1`, `Community 4`, `Community 2`, `Community 39`, `Community 9`, `Community 42`, `Community 45`, `Community 48`, `Community 52`, `Community 60`, `Community 61`, `Community 63`?**
