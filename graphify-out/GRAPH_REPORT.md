...
## Summary
- 3360 nodes · 6710 edges · 190 communities (182 shown, 8 thin omitted)
...
Cohesion: 0.1
Nodes (37): dmSans, inter, metadata, outfit, plexMono, robots(), sitemap(), isIndexableLegalDocument() (+29 more)
...
Cohesion: 0.09
Nodes (34): confirmSessionPayment(), expireOne(), ExpireSessionsResult, expireStaleSessions(), OPEN, AuditRecorder, FormPost, isPastExpiry() (+26 more)
...
Cohesion: 0.07
Nodes (33): Application, APPLICATION_SCOPES, ApplicationDomain, applicationDomains, applications, ApplicationScope, Customer, customers (+25 more)
...
Cohesion: 0.12
Nodes (28): requireAdmin(), DomainList(), DomainRow, confirmIdentity(), readDomains(), readScopes(), registerApplicationAction(), registerSchema (+20 more)

### Community 17 - "Community 17"
Cohesion: 0.1
Nodes (33): isPaymentError(), buildReceipt(), sendReceipt(), clearInvoice(), closeSession(), CompletedPayment, completePayment(), flagForReconciliation() (+25 more)
...
Cohesion: 0.09
Nodes (24): ApplicationPanel(), Breadcrumbs(), ContentTable(), ReauthFields(), RegisterApplicationForm(), DESCRIPTION, ScopeCheckboxes(), ApplicationsPage() (+16 more)

### Community 23 - "Community 23"
Cohesion: 0.13
Nodes (26): registerReal(), EsewaConfig, asJson(), eventIdFor(), ProviderEventInput, ProviderEventType, recordProviderEvent(), FonepayConfig (+18 more)
...
Cohesion: 0.11
Nodes (20): BuildTiers(), ClosingCta(), covering, DarkNavZone(), CLOSING_HEADING, PRINCIPLES_HEADING, PRODUCTS_HEADING, STATEMENT (+12 more)

### Community 27 - "Community 27"
Cohesion: 0.12
Nodes (21): AdminRoster(), PendingAdminActions(), listAdmins(), RosterEntry, TotpSetup(), TotpSetupProps, confirmEnrolment(), metadata (+13 more)
...
Cohesion: 0.23
Nodes (20): NotFound(), getLegalDocument, getPost, getProductPage, getService, listPublishedLegalDocuments(), published(), publishedSlugs() (+12 more)
...
Cohesion: 0.08
Nodes (26): AiProvider, defaultAiProvider, SmartFallbackProvider, AI_TOOL_DEFINITIONS, AiProviderChatParams, AiProviderResponse, BookMeetingParams, ChatMessage (+18 more)
...
Cohesion: 0.22
Nodes (15): auditActions(), AuditRow, listAuditEntries(), NUMERIC_FIELDS, DashboardSnapshot, FILTERS, AuditLogPage(), formatBsNumeric() (+7 more)

### Community 44 - "Community 44"
Cohesion: 0.11
Nodes (16): FilterLink(), Chip(), PostList(), PostSummary, cn(), PageContainer(), Badge(), BadgeTone (+8 more)
...
Cohesion: 0.15
Nodes (16): DocumentFormat, joinReference(), encodeRandom(), encodeTime(), newRequestId(), apiError(), apiJson(), toPaymentError() (+8 more)
...
Cohesion: 0.15
Nodes (15): PLACE_COORDINATES, PLACE_PHOTO, PlaceSection(), PrinciplesSection(), Statement(), CRAFT_STATEMENT, Principle, PRINCIPLES (+7 more)
...
Cohesion: 0.19
Nodes (11): BLOOM_LAYERS, EXIT_DX, HeroArc(), CRESCENT_LAYERS, HeroEye(), EXIT_DX, Hero(), heroStart() (+3 more)

### Community 55 - "Community 55"
Cohesion: 0.19
Nodes (16): enrolmentUrl(), createPendingAdmin(), deletePendingAdmin(), findPendingAdmin(), PendingAdmin, pendingOnly(), reclaimPendingAdmin(), buildHandoff() (+8 more)
...
Cohesion: 0.15
Nodes (8): metadata, SmoothScroll(), ChatWidget(), NAV_LINKS, LINKS, SiteHeader(), useScrolled(), Wordmark()
...
Cohesion: 0.26
Nodes (6): KindCard(), Card(), CardBody(), CardHeader(), CardTitle(), StatTile()
...
Cohesion: 0.2
Nodes (8): CraftConstellation(), CRAFT_DISCS, CraftDisc, Discipline, DISCIPLINES, Satellite, Drift(), Parallax()
...
Cohesion: 0.21
Nodes (8): DisciplineCluster(), SERVICES_HEADING, ServiceStep(), ServicesChapter(), ServiceStepData, MarkSpark(), BlurIn(), TextTag
...
Cohesion: 0.29
Nodes (8): extensionForMime(), isImageMime(), CMS_IMAGE_KEY, cmsImageKey(), slugify(), key, message, POST()
...
- **Why does `cn()` connect `Community 44` to `Community 131`, `Community 132`, `Community 8`, `Community 20`, `Community 26`, `Community 161`, `Community 36`, `Community 38`, `Community 39`, `Community 40`, `Community 41`, `Community 43`, `Community 52`, `Community 56`, `Community 61`, `Community 78`, `Community 91`, `Community 104`, `Community 112`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `isPaymentError()` connect `Community 17` to `Community 7`, `Community 15`, `Community 16`, `Community 47`, `Community 112`, `Community 23`, `Community 93`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `headers` connect `Community 92` to `Community 12`?**
