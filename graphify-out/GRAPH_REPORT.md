...
## Corpus Check
- 639 files · ~628,436 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3810 nodes · 7526 edges · 198 communities (186 shown, 12 thin omitted)
...
Cohesion: 0.05
Nodes (42): ApplicationHeader(), ApplicationPanel(), Breadcrumbs(), ContentTable(), DomainList(), DomainRow, FieldError(), KeyLegend() (+34 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (54): AdminRoster(), PendingAdminActions(), listAdmins(), RosterEntry, TotpSetup(), confirmEnrolment(), EnrolPage(), metadata (+46 more)
...
Cohesion: 0.07
Nodes (38): bankApps(), BankReply, FonepayConfig, FonepayProviderAdapter, HOSTS, STATUS, StatusReply, PAYMENT_ERROR_STATUS (+30 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (47): nextPollAt(), pollDelayMs(), pollExhausted(), giveUp(), LIVE, PollPendingResult, pollPendingTransactions(), reschedule() (+39 more)
...
Cohesion: 0.09
Nodes (42): dmSans, inter, metadata, outfit, plexMono, logoDataUri(), OpengraphImage(), size (+34 more)
...
Cohesion: 0.06
Nodes (32): Account, accountClass, accounts, normalBalance, Product, productKind, FiscalPeriod, fiscalPeriods (+24 more)
...
Cohesion: 0.1
Nodes (27): EnrolmentHandoff(), InviteAdminForm(), PublishConfirm(), PublishPending(), RotateTotpForm(), RotateTotpFormProps, TotpSetupProps, expiresIn() (+19 more)
...
Cohesion: 0.07
Nodes (31): PLACE_COORDINATES, PLACE_PHOTO, PlaceSection(), PrinciplesSection(), QUALITIES, Quality, QualityPile(), TONE_CLASS (+23 more)
...
Cohesion: 0.12
Nodes (19): CraftConstellation(), CRAFT_DISCS, CraftDisc, BLOOM_LAYERS, EXIT_DX, HeroArc(), CRESCENT_LAYERS, HeroEye() (+11 more)
...
Cohesion: 0.13
Nodes (20): extractHeadings(), Heading, headingId(), getLegalDocument, listPublishedLegalDocuments(), DevelopersPage(), metadata, { title, body } (+12 more)
...
Cohesion: 0.13
Nodes (26): attach(), invoiceAttachment(), receiptAttachment(), safe(), documentPdf(), DocumentPdfResult, DocumentKeyInput, documentPdfKey() (+18 more)

### Community 31 - "Community 31"
Cohesion: 0.1
Nodes (28): BookingFailure, BookingOutcome, BookingRecord, getAllLeads(), getAvailableSlots(), LeadEntry, LeadRecord, leadsStore (+20 more)
...
Cohesion: 0.09
Nodes (28): assertRevenueAccounts(), defaultRevenueAccount(), assertLines(), assertServiceWindow(), CreatedInvoice, createInvoice(), CreateInvoiceInput, CUSTOMER_COLUMNS (+20 more)
...
Cohesion: 0.12
Nodes (19): listPublishedPosts(), listPublishedProducts(), listPublishedServices(), ClosingCta(), covering, DarkNavZone(), ProductsSection(), RecentPosts() (+11 more)

### Community 41 - "Community 41"
Cohesion: 0.1
Nodes (15): refunds, generateSessionId(), audited, makeAttempt(), makeSession(), NOW, receipts, audited (+7 more)
...
Cohesion: 0.13
Nodes (20): CheckoutFlow(), CheckoutFlowProps, fmt(), PROVIDER_META, GatewayForm(), EsewaIcon(), FonepayIcon(), KhaltiIcon() (+12 more)
...
Cohesion: 0.15
Nodes (18): documentFile(), DocumentFormat, joinReference(), safeFilename(), apiError(), apiJson(), secretExpiryHeaders(), toPaymentError() (+10 more)
...
Cohesion: 0.16
Nodes (18): enrolmentUrl(), createPendingAdmin(), findPendingAdmin(), findTotpSecret(), PendingAdmin, pendingOnly(), reclaimPendingAdmin(), replaceSecret() (+10 more)

### Community 51 - "Community 51"
Cohesion: 0.14
Nodes (20): isPaymentError(), asJson(), eventIdFor(), ProviderEventInput, ProviderEventType, recordProviderEvent(), hasProvider(), providerAdapter() (+12 more)
...
Cohesion: 0.13
Nodes (16): listRefunds(), RefundRow, StatusBadge(), Tone, TONE_BY_STATUS, TONES, formatNpr(), formatPaisa() (+8 more)
...
Cohesion: 0.13
Nodes (12): BuildTiers(), DisciplineCluster(), Discipline, DISCIPLINES, Satellite, TierRow(), Tier, TIERS (+4 more)
...
Cohesion: 0.17
Nodes (15): DetectedImage, extensionForMime(), ImageMime, isImageMime(), Signature, SIGNATURES, ValidationFailure, ValidationResult (+7 more)
...
Cohesion: 0.33
Nodes (11): AdminGuard, requireAdminApi(), POST(), detectImage(), parseCmsImageKey(), publicBucket(), publicUrl(), r2() (+3 more)
...
- **Why does `isPaymentError()` connect `Community 51` to `Community 2`, `Community 5`, `Community 6`, `Community 41`, `Community 44`, `Community 46`, `Community 48`, `Community 18`, `Community 23`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 16` to `Community 64`, `Community 161`, `Community 160`, `Community 167`, `Community 40`, `Community 42`, `Community 43`, `Community 47`, `Community 15`, `Community 49`, `Community 82`, `Community 17`, `Community 19`, `Community 21`, `Community 24`, `Community 26`, `Community 63`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `env` connect `Community 46` to `Community 99`, `Community 70`, `Community 39`, `Community 8`, `Community 72`, `Community 71`, `Community 45`, `Community 19`, `Community 30`, `Community 89`, `Community 127`, `Community 94`, `Community 31`?**
