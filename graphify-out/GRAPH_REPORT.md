...
## Corpus Check
- 603 files · ~568,545 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3472 nodes · 6956 edges · 194 communities (181 shown, 13 thin omitted)
...
1. `[Unreleased]` - 96 edges
2. `cn()` - 85 edges
3. `[Phase 1] — 2026-08-14` - 42 edges
...
Cohesion: 0.02
Nodes (92): Added, Added, Added, Added, Added, Added, Added, Added (+84 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (49): Account, accountClass, normalBalance, Product, productKind, products, Application, APPLICATION_SCOPES (+41 more)
...
Cohesion: 0.05
Nodes (48): INVOICE_STATUSES, InvoiceFilter, InvoiceRow, InvoiceTotals, listInvoices(), numberingGaps(), whereFor(), listPayments() (+40 more)
...
Cohesion: 0.06
Nodes (49): 1. Conventions, 2. Authentication, 3. Endpoints, 4. Outbound webhooks, 5.1 `manual_qr`, 5.1 `manual_qr` — **removed 2026-08-16**, 5.2 Khalti (KPG v2), 5.3 eSewa (+41 more)
...
Cohesion: 0.1
Nodes (32): AdminRoster(), PendingAdminActions(), listAdmins(), RosterEntry, TotpSetup(), confirmEnrolment(), metadata, enrolmentUrl() (+24 more)

### Community 9 - "Community 9"
Cohesion: 0.09
Nodes (36): AdminGuard, requireAdminApi(), POST(), DetectedImage, detectImage(), extensionForMime(), isImageMime(), Signature (+28 more)
...
Cohesion: 0.1
Nodes (23): EnrolmentHandoff(), InviteAdminForm(), RotateTotpForm(), RotateTotpFormProps, TotpSetupProps, expiresIn(), credentialsSchema, CODES (+15 more)
...
Cohesion: 0.08
Nodes (30): ApplicationHeader(), ApplicationPanel(), Breadcrumbs(), ContentTable(), KeyLegend(), KEYS, RegisterApplicationForm(), ApplicationsPage() (+22 more)

### Community 16 - "Community 16"
Cohesion: 0.09
Nodes (32): expireOne(), ExpireSessionsResult, expireStaleSessions(), OPEN, isPaymentError(), FormPost, isPastExpiry(), expireIfDue() (+24 more)
...
Cohesion: 0.19
Nodes (24): AboutPage(), generateMetadata(), BlogIndexPage(), generateMetadata(), CareersPage(), generateMetadata(), metadataFor(), getPage (+16 more)

### Community 19 - "Community 19"
Cohesion: 0.11
Nodes (26): publishContent(), unpublishContent(), saveContent(), ActionResult, databaseMessage(), parseId(), requireKind(), ContentForm() (+18 more)

### Community 20 - "Community 20"
Cohesion: 0.2
Nodes (22): NUMERIC_FIELDS, DashboardSnapshot, FILTERS, FilterLink(), Chip(), PostList(), PostSummary, formatBsNumeric() (+14 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (39): 1. What each side owns, 2.1 Raise an invoice, 2.2 Send the customer to pay, 2.3 Learn that they paid, 2.4 Show the customer their records, 2. The happy path, in four calls, 3. Sending your plan details, 4. Things that will bite you (+31 more)
...
Cohesion: 0.11
Nodes (31): buildReceipt(), everything, clearInvoice(), closeSession(), CompletedPayment, completePayment(), flagForReconciliation(), journalNoOf() (+23 more)

### Community 24 - "Community 24"
Cohesion: 0.09
Nodes (22): authenticateApplication(), AuthenticatedApplication, bearerToken(), matchSecret(), unauthenticated(), AddDomainInput, Actor, AuditRecorder (+14 more)

### Community 25 - "Community 25"
Cohesion: 0.08
Nodes (24): FiscalPeriod, fiscalPeriods, periodStatus, entryDirection, journalEntries, JournalEntry, journalSource, ledgerEntries (+16 more)
...
Cohesion: 0.21
Nodes (21): NotFound(), sitemap(), getLegalDocument, getPost, getProductPage, getService, listPublishedLegalDocuments(), published() (+13 more)
...
Cohesion: 0.12
Nodes (21): EsewaConfig, FonepayConfig, callbackUrl(), HOSTS, isLookupAnswer(), KhaltiConfig, KhaltiProviderAdapter, parseJson() (+13 more)

### Community 32 - "Community 32"
Cohesion: 0.14
Nodes (26): buildInvoiceDocument(), customerParty(), documentStatus(), SheetWarning(), findInvoice(), findPayment(), InvoiceLineRecord, invoiceLinesFor() (+18 more)
...
Cohesion: 0.18
Nodes (26): requireAdmin(), DomainList(), DomainRow, addCredentialAction(), confirmIdentity(), confirmIfProduction(), confirmName(), readDomains() (+18 more)

### Community 35 - "Community 35"
Cohesion: 0.12
Nodes (21): BuildTiers(), ClosingCta(), covering, DarkNavZone(), CLOSING_HEADING, PRINCIPLES_HEADING, PRODUCTS_HEADING, SERVICES_HEADING (+13 more)

### Community 36 - "Community 36"
Cohesion: 0.1
Nodes (25): SignResponse, uploadImage(), UploadResult, PendingDot(), Spinner(), ACCEPT_ATTRIBUTE, ACCEPTED, describeRejection() (+17 more)

### Community 37 - "Community 37"
Cohesion: 0.14
Nodes (18): extractHeadings(), Heading, headingId(), INTEGRATION_PATH, integrationDoc(), stripRepoLinks(), DevelopersPage(), metadata (+10 more)

### Community 38 - "Community 38"
Cohesion: 0.11
Nodes (24): documentIssues(), CUSTOMER, DUE, ISSUED, SAMPLE_INVOICE, SAMPLE_INVOICE_PART_PAID, SAMPLE_INVOICE_VOID, SAMPLE_RECEIPT (+16 more)
...
Cohesion: 0.12
Nodes (23): BookingFailure, BookingOutcome, BookingRecord, getAllLeads(), getAvailableSlots(), LeadEntry, LeadRecord, leadsStore (+15 more)
...
Cohesion: 0.15
Nodes (17): DocumentFormat, joinReference(), encodeRandom(), encodeTime(), newRequestId(), apiError(), apiJson(), toPaymentError() (+9 more)

### Community 44 - "Community 44"
Cohesion: 0.18
Nodes (20): DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailCategory, NAME_SUFFIX, emailConfigured, resendClient(), EmailIdentity, fromHeaderFor() (+12 more)
...
Cohesion: 0.16
Nodes (17): amountInWords(), numberInWords(), ONES, SCALES, TENS, underHundred(), underThousand(), InvoiceSheet() (+9 more)
...
Cohesion: 0.17
Nodes (13): ReauthFields(), DESCRIPTION, ScopeCheckboxes(), SubmitButton(), ApplicationSummary, CredentialResult, failure(), readScopes() (+5 more)

### Community 51 - "Community 51"
Cohesion: 0.16
Nodes (17): registerReal(), asJson(), eventIdFor(), ProviderEventInput, ProviderEventType, recordProviderEvent(), hasProvider(), providerAdapter() (+9 more)

### Community 52 - "Community 52"
Cohesion: 0.14
Nodes (19): assertRegisteredHost(), isRegisteredHost(), addDomain(), normalizeHostname(), normalizeHostnameInput(), addCredential(), DomainInput, IssuedCredential (+11 more)
...
Cohesion: 0.23
Nodes (17): documentFile(), safeFilename(), attach(), invoiceAttachment(), receiptAttachment(), safe(), documentPdf(), escapeHtml() (+9 more)
...
Cohesion: 0.22
Nodes (8): Orb(), ToneSegment, ToneSentence, TextTag, prefersReducedMotion(), registerMotionPlugins(), TextTag, TextTag

### Community 62 - "Community 62"
Cohesion: 0.16
Nodes (15): mutatingEndpoint(), paisa(), serializeInvoice(), serializeRefund(), serializeSession(), serializeTransaction(), serializeTransactionView(), POST (+7 more)

### Community 63 - "Community 63"
Cohesion: 0.12
Nodes (15): AuditRecord, generateSessionId(), isSessionIdShape(), seen, suffix, makeSession(), audited, entry (+7 more)
...
Cohesion: 0.2
Nodes (11): Eclipse(), FORM_COLORS, KATHMANDU, PointGlobe(), Showcase(), useIdleSpin(), SURFACES, FormGround (+3 more)
...
Cohesion: 0.17
Nodes (12): PLACE_COORDINATES, PLACE_PHOTO, PlaceSection(), ServicesChapter(), MarkSquiggle(), BlurIn(), LightForm(), LightFormScene (+4 more)
...
Cohesion: 0.16
Nodes (11): CraftConstellation(), CRAFT_DISCS, CraftDisc, DisciplineCluster(), Discipline, DISCIPLINES, Satellite, Drift() (+3 more)
...
Cohesion: 0.13
Nodes (9): Receipt, ReceiptInput, ReceiptSender, INPUT, receipt, NOW, PERIOD_ENDS, PERIOD_STARTS (+1 more)

### Community 80 - "Community 80"
Cohesion: 0.14
Nodes (10): audited, makeAttempt(), makeSession(), NOW, receipts, adapter, mockAdapter, mockSession (+2 more)
...
Cohesion: 0.22
Nodes (11): ConfirmOutcome, availableProviders(), ensureProvidersRegistered(), MOCKABLE, registerIfAbsent(), registerMocks(), sendPaymentReceipt(), POST (+3 more)

### Community 84 - "Community 84"
Cohesion: 0.14
Nodes (12): audited, entry, makePayable(), NOW, PERIOD_ENDS, PERIOD_STARTS, receipts, sendReceipt() (+4 more)

### Community 85 - "Community 85"
Cohesion: 0.22
Nodes (9): listPublishedTeam(), DeviceScreen(), CmsImage(), CmsImageFillProps, CmsImageProps, optimizable(), TeamGrid(), generateMetadata() (+1 more)

### Community 86 - "Community 86"
Cohesion: 0.22
Nodes (13): recordLead(), recordSupportRequest(), reference(), AI_TOOL_DEFINITIONS, bookMeetingSchema, contactHumanSchema, createLeadSchema, executeTool() (+5 more)

### Community 87 - "Community 87"
Cohesion: 0.19
Nodes (9): CallbackPage(), metadata, CheckoutNotice(), CheckoutNoticeProps, Tone, confirmSessionPayment(), ReturnLink, returnLinkFor() (+1 more)
...
Cohesion: 0.19
Nodes (9): PrinciplesSection(), QUALITIES, Quality, QualityPile(), TONE_CLASS, CRAFT_STATEMENT, Principle, PRINCIPLES (+1 more)

### Community 92 - "Community 92"
Cohesion: 0.25
Nodes (11): nextPollAt(), pollDelayMs(), pollExhausted(), giveUp(), LIVE, PollPendingResult, pollPendingTransactions(), reschedule() (+3 more)
...
Cohesion: 0.22
Nodes (8): dmSans, inter, metadata, outfit, plexMono, JsonLd(), serialiseJsonLd(), isProductionSite()

### Community 110 - "Community 110"
Cohesion: 0.29
Nodes (9): OrderSummary(), CheckoutView, offerable(), summarise(), Summary, readPresentation(), CheckoutPage(), metadata (+1 more)

### Community 111 - "Community 111"
Cohesion: 0.27
Nodes (8): OrderSummaryProps, PlanDetails(), plainText(), Presentation, PresentationInput, presentationSchema, sellingPoint(), toStoredPresentation()
...
Cohesion: 0.31
Nodes (7): ProductsSection(), RecentPosts(), ServicesSection(), homeTagline(), collapse(), splitLede(), HomePage()
...
Cohesion: 0.43
Nodes (6): uploadCmsImage(), UploadResult, cmsObjectKey(), validationMessage(), putCmsObject(), r2()
...
## Knowledge Gaps
- **1378 isolated node(s):** `eslintConfig`, `RemotePatterns`, `TRUSTED_IMAGE_HOSTS`, `nextConfig`, `config` (+1373 more)
...
- **Why does `isPaymentError()` connect `Community 16` to `Community 34`, `Community 43`, `Community 110`, `Community 50`, `Community 83`, `Community 51`, `Community 87`, `Community 23`, `Community 24`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 20` to `Community 130`, `Community 131`, `Community 11`, `Community 18`, `Community 146`, `Community 147`, `Community 28`, `Community 157`, `Community 159`, `Community 35`, `Community 36`, `Community 165`, `Community 37`, `Community 40`, `Community 42`, `Community 53`, `Community 61`, `Community 72`, `Community 76`, `Community 91`, `Community 110`, `Community 112`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `CheckoutView` connect `Community 110` to `Community 16`, `Community 87`?**
