# Graph Report - company  (2026-09-26)

## Corpus Check
- 830 files · ~756,072 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4677 nodes · 10366 edges · 214 communities (202 shown, 12 thin omitted)
...
1. `[Unreleased]` - 211 edges
2. `cn()` - 161 edges
3. `recordAudit()` - 92 edges
4. `requireAdmin()` - 62 edges
5. `[Phase 1] — 2026-08-14` - 60 edges
6. `PaymentError` - 45 edges
7. `requireAdmin()` - 41 edges
8. `idField()` - 39 edges
9. `formatPaisa()` - 39 edges
10. `metadataFor()` - 35 edges

## Surprising Connections (you probably didn't know these)
- `addCredentialAction()` --calls--> `addCredential()`  [INFERRED]
  apps/web/app/(admin)/admin/applications/actions.ts → packages/payment-core/applications/manage.ts
- `revokeCredentialAction()` --calls--> `revokeCredential()`  [INFERRED]
  apps/web/app/(admin)/admin/applications/actions.ts → packages/payment-core/applications/manage.ts
- `setWebhookUrlAction()` --calls--> `setCredentialWebhookUrl()`  [INFERRED]
  apps/web/app/(admin)/admin/applications/actions.ts → packages/payment-core/applications/manage.ts
...
Cohesion: 0.01
Nodes (206): Added, Added, Added, Added, Added, Added, Added, Added (+198 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (86): acceptInvitation(), AcceptInviteState, addDeliverableAction(), addMilestoneAction(), addPersonAction(), schema, addStageAction(), createClientAction() (+78 more)
...
Cohesion: 0.11
Nodes (41): CLASSES, metadata, NUMERIC_FIELDS, DashboardSnapshot, FILTERS, FilterLink(), metadata, AddPersonForm() (+33 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (43): covering, DarkNavZone(), PREVIEW_HEADING, PREVIEW_POINTS, POINT_LOOK, PreviewSection(), SITE_ICONS, CLOSING_HEADING (+35 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (38): AdminNav(), NavItem, SECTIONS, AdminLayout(), setAdminMode(), AdminModeSwitch(), MODES, AdminSandboxNotice() (+30 more)

### Community 6 - "Community 6"
Cohesion: 0.09
Nodes (29): EnrolmentHandoff(), RotateTotpFormProps, SubmitButton(), TotpSetupProps, ActionForm(), ActionFormState, InviteDetails, InviteHandoff() (+21 more)

### Community 7 - "Community 7"
Cohesion: 0.08
Nodes (53): AccountsPage(), adminMode(), AccountLedgerPage(), isSource(), JournalsPage(), metadata, AccountLedger, BALANCE_SHEET (+45 more)
...
Cohesion: 0.06
Nodes (43): callbackUrl(), decodeResponse(), EsewaConfig, EsewaProviderAdapter, HOSTS, missing(), STATUS, transactionUuidFor() (+35 more)
...
Cohesion: 0.06
Nodes (36): WALLET_MARKS, CraftConstellation(), CRAFT_DISCS, CraftDisc, DIRECT_LINE, OWN_PRODUCTS, PORTAL, SHIPPED (+28 more)

### Community 12 - "Community 12"
Cohesion: 0.07
Nodes (40): DocumentFormat, joinReference(), encodeRandom(), encodeTime(), newRequestId(), apiError(), apiJson(), secretExpiryHeaders() (+32 more)

### Community 13 - "Community 13"
Cohesion: 0.06
Nodes (35): ApplicationHeader(), ApplicationPanel(), Breadcrumbs(), ContentTable(), DeleteApplicationForm(), DomainList(), DomainRow, KeyLegend() (+27 more)
...
Cohesion: 0.08
Nodes (44): confirmOfflinePayment(), pendingCash(), RecordedOfflinePayment, RecordOfflinePaymentInput, rejectOfflinePayment(), buildReceipt(), Receipt, ReceiptInput (+36 more)
...
Cohesion: 0.08
Nodes (37): EsewaConfig, FonepayConfig, callbackBase(), MockConfig, MockProviderAdapter, hasProvider(), providerAdapter(), registerProvider() (+29 more)

### Community 18 - "Community 18"
Cohesion: 0.07
Nodes (34): INVOICE_STATUSES, InvoiceFilter, InvoiceRow, InvoiceTotals, listInvoices(), numberingGaps(), whereFor(), listPayments() (+26 more)
...
Cohesion: 0.06
Nodes (34): Account, accountClass, accounts, normalBalance, Product, productKind, products, FiscalPeriod (+26 more)
...
Cohesion: 0.07
Nodes (30): CashRow, listCash(), Offline, hasEverRun(), HeldPayment, heldPayments(), openRunItems(), RunItem (+22 more)

### Community 23 - "Community 23"
Cohesion: 0.11
Nodes (28): publishContent(), unpublishContent(), revalidateContent(), saveContent(), ActionResult, databaseMessage(), parseId(), requireKind() (+20 more)

### Community 24 - "Community 24"
Cohesion: 0.12
Nodes (18): BLOOM_LAYERS, EXIT_DX, HeroArc(), CRESCENT_LAYERS, HeroEye(), EXIT_DX, createLetterMelt(), HeroPixelArc() (+10 more)

### Community 25 - "Community 25"
Cohesion: 0.18
Nodes (24): AboutPage(), generateMetadata(), CareersPage(), generateMetadata(), metadataFor(), getPage, listPublishedServices, listPublishedTeam() (+16 more)

### Community 26 - "Community 26"
Cohesion: 0.07
Nodes (28): credentialMode, Customer, customers, Invoice, InvoiceLine, invoiceLines, invoices, invoiceStatus (+20 more)

### Community 27 - "Community 27"
Cohesion: 0.08
Nodes (37): EnrolPage(), authorize(), decryptSecret(), deriveFromKey(), encryptSecret(), key(), checkTotp(), createTotpEnrolment() (+29 more)

### Community 28 - "Community 28"
Cohesion: 0.11
Nodes (23): extractHeadings(), Heading, headingId(), getLegalDocument, INTEGRATION_PATH, integrationDoc(), stripRepoLinks(), DevelopersPage() (+15 more)
...
Cohesion: 0.11
Nodes (30): readProduct(), assertRegisteredHost(), addDomain(), AddDomainInput, removeDomain(), normalizeHostname(), normalizeHostnameInput(), assertLoopbackAllowed() (+22 more)

### Community 32 - "Community 32"
Cohesion: 0.14
Nodes (24): Eclipse(), Orb(), FORM_COLORS, KATHMANDU, PointGlobe(), Showcase(), useIdleSpin(), drawApp() (+16 more)

### Community 33 - "Community 33"
Cohesion: 0.14
Nodes (30): robots(), isIndexableLegalDocument(), LegalReadiness, siteUrl(), absoluteImage(), blogPostingNode(), collectionPageNode(), contactPageNode() (+22 more)

### Community 34 - "Community 34"
Cohesion: 0.09
Nodes (25): BentoCard(), BentoGrid(), BANK_SLUGS, bankMark(), BankSlug, BrandMark(), MarkAsset, PaymentActivity() (+17 more)

### Community 35 - "Community 35"
Cohesion: 0.14
Nodes (30): documentFile(), safeFilename(), attach(), invoiceAttachment(), receiptAttachment(), safe(), documentPdf(), DocumentPdfResult (+22 more)

### Community 36 - "Community 36"
Cohesion: 0.09
Nodes (29): DashboardActivity(), DashboardInvoices(), DASHBOARD_TABS, DashboardInvoice, DashboardMethod, DashboardMonth, DashboardPayment, DashboardPaymentFilter (+21 more)
...
Cohesion: 0.08
Nodes (24): Application, APPLICATION_SCOPES, ApplicationCredential, applicationCredentials, ApplicationDomain, applicationDomains, applications, ApplicationScope (+16 more)
...
Cohesion: 0.11
Nodes (20): FieldError(), KIND_LABEL, NewProductDraft, ProductField(), ProductOption, ReauthFields(), DESCRIPTION, ScopeCheckboxes() (+12 more)

### Community 42 - "Community 42"
Cohesion: 0.12
Nodes (23): confirmCashAction(), decide(), rejectCashAction(), enrolmentUrl(), qrSvg(), createPendingAdmin(), deletePendingAdmin(), findPendingAdmin() (+15 more)

### Community 43 - "Community 43"
Cohesion: 0.2
Nodes (22): sitemap(), BlogIndexPage(), generateMetadata(), getPost, getProductPage, getService, listPublishedLegalDocuments(), listPublishedPosts() (+14 more)
...
Cohesion: 0.1
Nodes (26): uploadCmsImage(), UploadResult, cmsObjectKey(), DetectedImage, detectImage(), Signature, SIGNATURES, validateImage() (+18 more)

### Community 47 - "Community 47"
Cohesion: 0.15
Nodes (22): ContactNotification, DetailRow, escapeHtml(), layout(), LayoutOptions, paragraph(), rowsTable(), SendResult (+14 more)

### Community 48 - "Community 48"
Cohesion: 0.13
Nodes (20): AdminRoster(), InviteAdminForm(), PendingAdminActions(), listAdmins(), RosterEntry, RotateTotpForm(), TotpSetup(), confirmEnrolment() (+12 more)

### Community 49 - "Community 49"
Cohesion: 0.15
Nodes (18): MESSAGES, signIn(), SignInState, aup, candidates, cookies, legalDocumentSeeds, partnerTerms (+10 more)

### Community 50 - "Community 50"
Cohesion: 0.07
Nodes (27): AdminUser, adminUsers, AuditLog, auditLogs, Client, clients, clientSessions, ClientUser (+19 more)

### Community 51 - "Community 51"
Cohesion: 0.12
Nodes (23): confirmSessionPayment(), nextPollAt(), pollDelayMs(), pollExhausted(), giveUp(), LIVE, PollPendingResult, pollPendingTransactions() (+15 more)

### Community 52 - "Community 52"
Cohesion: 0.12
Nodes (19): expireOne(), ExpireSessionsResult, expireStaleSessions(), OPEN, PaymentError, isPastExpiry(), expireIfDue(), loadPayableSession() (+11 more)
...
Cohesion: 0.09
Nodes (25): detectDocument(), DetectedFile, OFFICE, PNG_METADATA, safeFileName(), startsWith(), stripJpeg(), stripMetadata() (+17 more)

### Community 56 - "Community 56"
Cohesion: 0.11
Nodes (15): PLACE_COORDINATES, PLACE_PHOTO, MarkSquiggle(), FooterHorizon(), ElasticEngine, ElasticOptions, ElasticPhoto(), EMERALD_HORIZON_DEFAULTS (+7 more)

### Community 57 - "Community 57"
Cohesion: 0.11
Nodes (12): metadata, SmoothScroll(), FooterStars(), LAYERS, seeded(), NAV_LINKS, SiteFooter(), LINKS (+4 more)

### Community 58 - "Community 58"
Cohesion: 0.11
Nodes (22): BalanceSheetReport(), ProfitLossReport(), StatementSection, StatementTable(), AccountClass, AccountTotals, BalanceSheet, DEBIT_POSITIVE (+14 more)

### Community 59 - "Community 59"
Cohesion: 0.25
Nodes (24): requireAdmin(), addCredentialAction(), confirmIdentity(), confirmIfProduction(), confirmName(), deleteApplicationAction(), readDomains(), readId() (+16 more)

### Community 60 - "Community 60"
Cohesion: 0.13
Nodes (21): metadata, PortalDocumentsPage(), metadata, PortalInvoicesPage(), ART, PROJECT_ART, PROJECT_SCENES, SCENES (+13 more)
...
Cohesion: 0.15
Nodes (23): getAvailableSlots(), extractDate(), extractEmail(), extractName(), extractPhone(), extractTime(), MONTHS, NOT_A_NAME (+15 more)
...
Cohesion: 0.13
Nodes (17): CheckoutFlow(), CheckoutFlowProps, fmt(), PROVIDER_META, BUSY, FonepayQr(), FonepayQrProps, NOTES (+9 more)

### Community 71 - "Community 71"
Cohesion: 0.17
Nodes (17): MessageState, postMessage(), reviewDeliverable(), ReviewState, signOut(), uploadDocument(), UploadState, notifyCompanyOfMessage() (+9 more)
...
Cohesion: 0.1
Nodes (11): closeDb(), db, DbLike, DbTx, isNeon, teardown(), result, NOW (+3 more)
...
Cohesion: 0.13
Nodes (17): authenticateApplication(), AuthenticatedApplication, bearerToken(), matchSecret(), unauthenticated(), FiledRefund, REFUNDABLE, RequestRefundInput (+9 more)

### Community 79 - "Community 79"
Cohesion: 0.15
Nodes (17): AdminClientPage(), AdminProject, ClientDetail, ClientPerson, ClientRow, byRelevance, ClientDocumentRow, clientProject() (+9 more)

### Community 80 - "Community 80"
Cohesion: 0.12
Nodes (12): DisciplineCluster(), Discipline, DISCIPLINES, Satellite, ART, ServiceArtPanel(), ServiceArt, Tilt() (+4 more)
...
Cohesion: 0.19
Nodes (16): saveSettings(), SettingsResult, SETTING_DEFINITIONS, SETTING_GROUPS, SETTING_KEYS, SettingDefinition, SettingKind, getStoredSettings() (+8 more)
...
Cohesion: 0.27
Nodes (14): AdminGuard, requireAdminApi(), POST(), extensionForMime(), isImageMime(), parseCmsImageKey(), publicBucket(), publicUrl() (+6 more)
...
Cohesion: 0.13
Nodes (10): callbackUrl(), HOSTS, isLookupAnswer(), KhaltiConfig, KhaltiProviderAdapter, parseJson(), STATUS, websiteUrl() (+2 more)
...
Cohesion: 0.22
Nodes (13): projectArt(), projectScene(), ProjectCard(), ProjectHero(), StatusPill(), toneFor(), MilestoneView, dayDate() (+5 more)

### Community 96 - "Community 96"
Cohesion: 0.22
Nodes (14): DocumentKeyInput, documentPdfKey(), hex(), segment(), isFinal(), readDocumentPdf(), writeDocumentPdf(), deleteDocumentObject() (+6 more)
...
Cohesion: 0.15
Nodes (13): BookingFailure, BookingOutcome, BookingRecord, getAllLeads(), LeadEntry, LeadRecord, leadsStore, SupportRecord (+5 more)

### Community 103 - "Community 103"
Cohesion: 0.2
Nodes (15): recordBooking(), recordLead(), recordSupportRequest(), reference(), slotKey(), AI_TOOL_DEFINITIONS, bookMeetingSchema, contactHumanSchema (+7 more)

### Community 105 - "Community 105"
Cohesion: 0.15
Nodes (14): NotFound(), ClosingCta(), Hero(), PlaceSection(), PrinciplesSection(), ProductsSection(), RecentPosts(), ServicesSection() (+6 more)

### Community 106 - "Community 106"
Cohesion: 0.12
Nodes (17): 9.1 — Every recorded eSewa sandbox key in this repo was wrong, 9.2 — Khalti is testable too, and always was, 9.3 — The provider rows had to be switched on, 9.4 — The composition root's idempotence guard was wrong, 9.5 — Cancelling a payment produced a 500, twice over, 9.6 — What is proven (updated 2026-09-02, after real sandbox payments), 9.7 — The runbook (this is what was run), 9.8 — What acceptance 5 found: an unsigned POST crashed the consumer (+9 more)
...
Cohesion: 0.26
Nodes (14): availableProviders(), availableFor(), registerFromEnv(), ensureProvidersRegistered(), esewaConfig(), khaltiConfig(), MOCKABLE, MODES (+6 more)
...
Cohesion: 0.15
Nodes (11): dmSans, inter, metadata, outfit, plexMono, logoDataUri(), OpengraphImage(), size (+3 more)

### Community 113 - "Community 113"
Cohesion: 0.17
Nodes (10): DeviceScreen(), TRUSTED_IMAGE_HOSTNAMES, CmsImage(), CmsImageFillProps, CmsImageProps, optimizable(), loadRootEnv(), nextConfig (+2 more)
...
Cohesion: 0.2
Nodes (10): DeliverableReview(), metadata, PortalProjectPage(), ComposerState, MessageComposer(), MessageThread(), previewHost(), previewUrl() (+2 more)
...
Cohesion: 0.29
Nodes (7): IconChip(), SIZES, RecentMessage, RecentMessages(), SectionCard(), ROTATION, Tone

### Community 124 - "Community 124"
Cohesion: 0.23
Nodes (9): GET(), metadata, PortalLoginPage(), AuthFrame(), WHAT_IS_INSIDE, clientDocument(), currentViewer, SignInForm() (+1 more)
...
Cohesion: 0.2
Nodes (7): MeetingSlot, MeetingSlotsCard(), ChatMessageUI, ChatWidget(), DEFAULT_WELCOME_MESSAGE, QUICK_ACTIONS, SESSION_STAMP
...
Cohesion: 0.2
Nodes (10): createClient(), clientProjects(), build(), clientIds, files, Fixture, fixtures, ids (+2 more)
...
Cohesion: 0.22
Nodes (7): InvoiceList(), ClientInvoice, ClientReceipt, OPEN_SESSION, RECEIPTED, base, html
...
Cohesion: 0.53
Nodes (6): ContactResult, schema, submitContact(), notifyContact(), hashIp(), isRateLimited()
...
Cohesion: 0.52
Nodes (5): ConfirmOutcome, sendEmail(), deliverReceipt(), sendPaymentReceipt(), paymentReceiptEmail()
...
Cohesion: 0.53
Nodes (5): encode(), JournalPage(), metadata, sourceLink(), JournalDetail
...
## Knowledge Gaps
- **1772 isolated node(s):** `eslintConfig`, `RemotePatterns`, `TRUSTED_IMAGE_HOSTS`, `nextConfig`, `config` (+1767 more)
...
- **Why does `isPaymentError()` connect `Community 51` to `Community 9`, `Community 42`, `Community 41`, `Community 12`, `Community 109`, `Community 15`, `Community 52`, `Community 86`, `Community 59`?**
  _High betweenness centrality (0.109) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 5` to `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 11`, `Community 13`, `Community 18`, `Community 24`, `Community 25`, `Community 28`, `Community 158`, `Community 34`, `Community 45`, `Community 179`, `Community 54`, `Community 56`, `Community 57`, `Community 58`, `Community 60`, `Community 61`, `Community 79`, `Community 80`, `Community 95`, `Community 101`, `Community 123`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `recordAudit()` connect `Community 1` to `Community 71`, `Community 7`, `Community 27`, `Community 42`, `Community 41`, `Community 12`, `Community 109`, `Community 46`, `Community 111`, `Community 48`, `Community 49`, `Community 82`, `Community 85`, `Community 23`, `Community 59`, `Community 124`, `Community 159`?**
