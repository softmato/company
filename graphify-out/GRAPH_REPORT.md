...
## Summary
- 3332 nodes · 6681 edges · 186 communities (178 shown, 8 thin omitted)
...
Cohesion: 0.09
Nodes (34): AdminRoster(), PendingAdminActions(), listAdmins(), RosterEntry, TotpSetup(), confirmEnrolment(), metadata, enrolmentUrl() (+26 more)
...
Cohesion: 0.06
Nodes (37): Customer, customers, Invoice, InvoiceLine, invoiceLines, invoices, invoiceStatus, deliveryStatus (+29 more)
...
Cohesion: 0.09
Nodes (29): registerReal(), EsewaConfig, asJson(), eventIdFor(), ProviderEventInput, ProviderEventType, recordProviderEvent(), FonepayConfig (+21 more)

### Community 11 - "Community 11"
Cohesion: 0.12
Nodes (33): buildInvoiceDocument(), customerParty(), documentStatus(), documentIssues(), findInvoice(), findPayment(), InvoiceLineRecord, invoiceLinesFor() (+25 more)

### Community 12 - "Community 12"
Cohesion: 0.09
Nodes (34): expireOne(), ExpireSessionsResult, expireStaleSessions(), OPEN, isPaymentError(), PAYMENT_ERROR_STATUS, PaymentErrorCode, PUBLIC_MESSAGE (+26 more)
...
Cohesion: 0.11
Nodes (30): requireAdmin(), ReauthFields(), DESCRIPTION, ScopeCheckboxes(), confirmIdentity(), readDomains(), readScopes(), registerApplicationAction() (+22 more)
...
Cohesion: 0.11
Nodes (24): EnrolmentHandoff(), InviteAdminForm(), RotateTotpForm(), RotateTotpFormProps, SubmitButton(), TotpSetupProps, expiresIn(), formatAdDateTime() (+16 more)
...
Cohesion: 0.11
Nodes (25): publishContent(), unpublishContent(), saveContent(), ActionResult, databaseMessage(), parseId(), requireKind(), ContentForm() (+17 more)

### Community 21 - "Community 21"
Cohesion: 0.11
Nodes (22): extractHeadings(), Heading, headingId(), getLegalDocument, INTEGRATION_PATH, integrationDoc(), stripRepoLinks(), DevelopersPage() (+14 more)
...
Cohesion: 0.07
Nodes (26): FiscalPeriod, fiscalPeriods, periodStatus, entryDirection, journalEntries, JournalEntry, journalSource, ledgerEntries (+18 more)
...
Cohesion: 0.08
Nodes (26): Account, accountClass, normalBalance, Product, productKind, products, Application, APPLICATION_SCOPES (+18 more)
...
Cohesion: 0.11
Nodes (20): ApplicationPanel(), Breadcrumbs(), ContentTable(), DomainList(), DomainRow, RegisterApplicationForm(), ApplicationsPage(), ApplicationDetail (+12 more)
...
Cohesion: 0.19
Nodes (20): NotFound(), getPost, getProductPage, getService, publishedSlugs(), BS_MONTHS, formatBsWithAd(), DeviceScreen() (+12 more)
...
Cohesion: 0.1
Nodes (14): PaymentError, callbackUrl(), HOSTS, isLookupAnswer(), KhaltiConfig, KhaltiProviderAdapter, parseJson(), STATUS (+6 more)
...
Cohesion: 0.14
Nodes (11): Chip(), PostList(), PostSummary, cn(), PageContainer(), StillFrame(), EmptyState(), Skeleton() (+3 more)

### Community 45 - "Community 45"
Cohesion: 0.12
Nodes (19): hasEverRun(), HeldPayment, heldPayments(), openRunItems(), RunItem, listRefunds(), RefundRow, StatusBadge() (+11 more)
...
Cohesion: 0.18
Nodes (17): ContactNotification, DetailRow, escapeHtml(), layout(), LayoutOptions, paragraph(), rowsTable(), SendResult (+9 more)
...
Cohesion: 0.15
Nodes (15): CallbackPage(), metadata, CheckoutNotice(), CheckoutNoticeProps, Tone, OrderSummary(), ReturnLink, returnLinkFor() (+7 more)
...
Cohesion: 0.12
Nodes (12): generateSessionId(), isSessionIdShape(), audited, makePayable(), NOW, PERIOD_ENDS, PERIOD_STARTS, receipts (+4 more)
...
Cohesion: 0.16
Nodes (13): ClosingCta(), ServiceStep(), ServicesChapter(), ServiceStepData, ServicesSection(), MarkArrow(), MarkCircle(), MarkProps (+5 more)

### Community 70 - "Community 70"
Cohesion: 0.15
Nodes (12): CLOSING_HEADING, PRINCIPLES_HEADING, PRODUCTS_HEADING, SERVICES_HEADING, STATEMENT, TIERS_HEADING, TierRow(), Tier (+4 more)
...
Cohesion: 0.17
Nodes (11): BuildTiers(), covering, DarkNavZone(), Hero(), ProductsSection(), RecentPosts(), homeTagline(), collapse() (+3 more)

### Community 74 - "Community 74"
Cohesion: 0.25
Nodes (8): CRAFT_DISCS, CraftDisc, Drift(), Parallax(), prefersReducedMotion(), registerMotionPlugins(), StaggerTag, TextTag
...
Cohesion: 0.18
Nodes (12): PLACE_COORDINATES, PLACE_PHOTO, PlaceSection(), DrawIn(), FormGround, FormKind, LightForm(), LightFormScene (+4 more)

### Community 80 - "Community 80"
Cohesion: 0.18
Nodes (12): OrderSummaryProps, PlanDetails(), prerenderInvoicePdf(), plainText(), Presentation, PresentationInput, presentationSchema, sellingPoint() (+4 more)
...
Cohesion: 0.16
Nodes (8): AuditRecord, AccountSeed, accountSeeds, audited, makeAttempt(), makeSession(), NOW, receipts

### Community 84 - "Community 84"
Cohesion: 0.36
Nodes (7): FILTERS, Card(), CardBody(), CardHeader(), CardTitle(), Money(), StatTile()
...
Cohesion: 0.21
Nodes (11): ConfirmOutcome, confirmSessionPayment(), availableProviders(), ensureProvidersRegistered(), MOCKABLE, registerIfAbsent(), registerMocks(), registeredProviders() (+3 more)
...
Cohesion: 0.23
Nodes (9): CraftConstellation(), PrinciplesSection(), Statement(), CRAFT_STATEMENT, Principle, PRINCIPLES, TextTag, ToneReveal() (+1 more)
...
Cohesion: 0.43
Nodes (5): emailConfigured, resendClient(), EmailAttachment, Message, env
...
Cohesion: 0.4
Nodes (4): DisciplineCluster(), Discipline, DISCIPLINES, Satellite
...
- **Why does `cn()` connect `Community 44` to `Community 128`, `Community 129`, `Community 5`, `Community 142`, `Community 18`, `Community 21`, `Community 30`, `Community 37`, `Community 39`, `Community 41`, `Community 59`, `Community 60`, `Community 64`, `Community 69`, `Community 73`, `Community 74`, `Community 79`, `Community 84`, `Community 100`, `Community 127`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `isPaymentError()` connect `Community 12` to `Community 9`, `Community 10`, `Community 42`, `Community 15`, `Community 52`, `Community 88`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `headers` connect `Community 31` to `Community 120`?**
