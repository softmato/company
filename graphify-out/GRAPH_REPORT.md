...
## Corpus Check
- 619 files · ~603,311 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3642 nodes · 7211 edges · 204 communities (190 shown, 14 thin omitted)
...
Cohesion: 0.07
Nodes (47): TotpSetup(), confirmEnrolment(), EnrolPage(), metadata, openPendingSecret(), seal(), sealPendingSecret(), activateWithSecret() (+39 more)
...
Cohesion: 0.09
Nodes (37): publishContent(), unpublishContent(), saveContent(), ActionResult, databaseMessage(), parseId(), requireKind(), ContentForm() (+29 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (32): ApplicationHeader(), ApplicationPanel(), Breadcrumbs(), ContentTable(), KeyLegend(), KEYS, ReauthFields(), RegisterApplicationForm() (+24 more)
...
Cohesion: 0.1
Nodes (26): EnrolmentHandoff(), PublishConfirm(), PublishPending(), RotateTotpFormProps, SubmitButton(), TotpSetupProps, expiresIn(), formatAdDateTime() (+18 more)

### Community 12 - "Community 12"
Cohesion: 0.07
Nodes (37): products, Application, APPLICATION_SCOPES, ApplicationCredential, applicationCredentials, ApplicationDomain, applicationDomains, applications (+29 more)

### Community 13 - "Community 13"
Cohesion: 0.09
Nodes (34): expireOne(), ExpireSessionsResult, expireStaleSessions(), OPEN, FormPost, isPastExpiry(), isSessionIdShape(), expireIfDue() (+26 more)

### Community 14 - "Community 14"
Cohesion: 0.1
Nodes (34): confirmSessionPayment(), nextPollAt(), pollDelayMs(), pollExhausted(), giveUp(), LIVE, PollPendingResult, pollPendingTransactions() (+26 more)
...
Cohesion: 0.18
Nodes (25): AboutPage(), generateMetadata(), generateMetadata(), CareersPage(), generateMetadata(), metadataFor(), getPage, listPublishedProducts() (+17 more)
...
Cohesion: 0.09
Nodes (24): BuildTiers(), ClosingCta(), covering, DarkNavZone(), DeviceScreen(), PrinciplesSection(), CLOSING_HEADING, PRINCIPLES_HEADING (+16 more)
...
Cohesion: 0.2
Nodes (23): NotFound(), BlogIndexPage(), getLegalDocument, getPost, getProductPage, getService, listPublishedLegalDocuments(), listPublishedPosts() (+15 more)
...
Cohesion: 0.13
Nodes (29): buildInvoiceDocument(), customerParty(), documentStatus(), documentIssues(), findInvoice(), findPayment(), InvoiceLineRecord, invoiceLinesFor() (+21 more)
...
Cohesion: 0.11
Nodes (24): EsewaConfig, asJson(), ProviderEventInput, recordProviderEvent(), FonepayConfig, callbackUrl(), HOSTS, isLookupAnswer() (+16 more)
...
Cohesion: 0.24
Nodes (17): NUMERIC_FIELDS, DashboardSnapshot, FILTERS, FilterLink(), formatBsNumeric(), BsDate(), Card(), CardBody() (+9 more)
...
Cohesion: 0.14
Nodes (18): DocumentFormat, joinReference(), encodeRandom(), encodeTime(), newRequestId(), apiError(), apiJson(), secretExpiryHeaders() (+10 more)
...
Cohesion: 0.12
Nodes (22): BookingFailure, BookingOutcome, BookingRecord, getAllLeads(), getAvailableSlots(), LeadEntry, LeadRecord, leadsStore (+14 more)
...
Cohesion: 0.16
Nodes (14): Chip(), PostList(), PostSummary, ServiceStep(), ServiceStepData, cn(), MarkArrow(), MarkCircle() (+6 more)

### Community 60 - "Community 60"
Cohesion: 0.15
Nodes (16): adminMode(), hasEverRun(), HeldPayment, heldPayments(), openRunItems(), RunItem, listRefunds(), RefundRow (+8 more)
...
Cohesion: 0.13
Nodes (18): CUSTOMER, DUE, ISSUED, SAMPLE_INVOICE, SAMPLE_INVOICE_PART_PAID, SAMPLE_INVOICE_VOID, SAMPLE_RECEIPT, SAMPLE_RECEIPT_PARTIAL (+10 more)
...
Cohesion: 0.14
Nodes (13): PLACE_COORDINATES, PLACE_PHOTO, PlaceSection(), TRUSTED_IMAGE_HOSTNAMES, WordReveal(), CmsImage(), CmsImageFillProps, CmsImageProps (+5 more)
...
Cohesion: 0.24
Nodes (13): DetailRow, escapeHtml(), layout(), LayoutOptions, paragraph(), rowsTable(), EmailTemplate, contactEnquiryEmail() (+5 more)
...
Cohesion: 0.14
Nodes (8): PAYMENT_ERROR_STATUS, PaymentError, PaymentErrorCode, PUBLIC_MESSAGE, adapter, surface, cases, txn
...
Cohesion: 0.15
Nodes (12): StatusBadge(), Tone, TONE_BY_STATUS, TONES, metadata, MOCK_SUBSCRIPTIONS, SubscriptionRecord, Badge() (+4 more)
...
Cohesion: 0.13
Nodes (13): __resetStore(), defaultAiProvider, SmartFallbackProvider, args, data, fallback, mockContext, pricingDoc (+5 more)

### Community 87 - "Community 87"
Cohesion: 0.22
Nodes (9): AdminRoster(), InviteAdminForm(), PendingAdminActions(), listAdmins(), RosterEntry, RotateTotpForm(), enrolmentUrl(), qrSvg() (+1 more)
...
Cohesion: 0.21
Nodes (10): ServicesChapter(), BlurIn(), FormGround, FormKind, LightForm(), LightFormScene, useNearViewport(), noopSubscribe() (+2 more)

### Community 94 - "Community 94"
Cohesion: 0.19
Nodes (10): dmSans, inter, metadata, outfit, plexMono, sitemap(), publishedPageSlugs(), JsonLd() (+2 more)
...
Cohesion: 0.23
Nodes (11): buildReceipt(), sendReceipt(), INPUT, receipt, clearInvoice(), closeSession(), CompletedPayment, completePayment() (+3 more)
...
Cohesion: 0.23
Nodes (9): authenticateApplication(), AuthenticatedApplication, bearerToken(), matchSecret(), unauthenticated(), FiledRefund, REFUNDABLE, requestRefund() (+1 more)
...
Cohesion: 0.43
Nodes (4): ConfirmOutcome, sendPaymentReceipt(), POST, paymentReceiptEmail()
...
- **Why does `isPaymentError()` connect `Community 14` to `Community 2`, `Community 36`, `Community 41`, `Community 13`, `Community 79`, `Community 26`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 59` to `Community 2`, `Community 11`, `Community 143`, `Community 16`, `Community 18`, `Community 30`, `Community 31`, `Community 32`, `Community 162`, `Community 35`, `Community 163`, `Community 39`, `Community 40`, `Community 42`, `Community 43`, `Community 54`, `Community 61`, `Community 70`, `Community 77`, `Community 84`, `Community 93`, `Community 112`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `submitContact()` connect `Community 121` to `Community 11`?**
