...
## Corpus Check
- 606 files · ~576,255 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3551 nodes · 7058 edges · 197 communities (187 shown, 10 thin omitted)
...
1. `[Unreleased]` - 133 edges
2. `cn()` - 85 edges
3. `[Phase 1] — 2026-08-14` - 48 edges
...
## Communities (197 total, 10 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (129): Added, Added, Added, Added, Added, Added, Added, Added (+121 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (66): ContactResult, schema, submitContact(), ContactNotification, notifyContact(), hashIp(), isRateLimited(), DEFAULT_MAILBOXES (+58 more)
...
Cohesion: 0.07
Nodes (45): uploadCmsImage(), UploadResult, AdminGuard, requireAdminApi(), POST(), cmsObjectKey(), DetectedImage, detectImage() (+37 more)
...
Cohesion: 0.09
Nodes (37): giveUp(), LIVE, PollPendingResult, AuditRecorder, buildReceipt(), ReceiptSender, sendReceipt(), everything (+29 more)

### Community 10 - "Community 10"
Cohesion: 0.09
Nodes (33): expireOne(), ExpireSessionsResult, expireStaleSessions(), OPEN, FormPost, isPastExpiry(), isSessionIdShape(), expireIfDue() (+25 more)
...
Cohesion: 0.11
Nodes (24): EnrolmentHandoff(), InviteAdminForm(), PublishConfirm(), PublishPending(), RotateTotpForm(), RotateTotpFormProps, SubmitButton(), TotpSetup() (+16 more)
...
Cohesion: 0.14
Nodes (29): documentFile(), safeFilename(), attach(), invoiceAttachment(), receiptAttachment(), safe(), documentPdf(), DocumentPdfResult (+21 more)
...
Cohesion: 0.21
Nodes (21): AboutPage(), generateMetadata(), CareersPage(), generateMetadata(), metadataFor(), getPage, ContactPage(), generateMetadata() (+13 more)

### Community 20 - "Community 20"
Cohesion: 0.15
Nodes (23): optionalText, requiredText, SEO_FIELDS, seoSchema, slugSchema, SORT_ORDER_FIELD, sortOrderSchema, tagsSchema (+15 more)
...
Cohesion: 0.12
Nodes (23): amountInWords(), numberInWords(), ONES, SCALES, TENS, underHundred(), underThousand(), InvoiceSheet() (+15 more)
...
Cohesion: 0.09
Nodes (24): ApplicationPanel(), Breadcrumbs(), ContentTable(), RegisterApplicationForm(), ApplicationsPage(), applicationColumns, ApplicationDetail, credentialColumns (+16 more)

### Community 27 - "Community 27"
Cohesion: 0.08
Nodes (24): Customer, customers, Invoice, InvoiceLine, invoiceLines, invoices, invoiceStatus, paymentSessions (+16 more)

### Community 28 - "Community 28"
Cohesion: 0.12
Nodes (20): EsewaConfig, FonepayConfig, callbackUrl(), HOSTS, isLookupAnswer(), KhaltiConfig, KhaltiProviderAdapter, parseJson() (+12 more)
...
Cohesion: 0.2
Nodes (21): sitemap(), BlogIndexPage(), generateMetadata(), getPost, getProductPage, getService, listPublishedLegalDocuments(), listPublishedPosts() (+13 more)

### Community 31 - "Community 31"
Cohesion: 0.09
Nodes (21): products, FiscalPeriod, fiscalPeriods, periodStatus, entryDirection, journalEntries, JournalEntry, journalSource (+13 more)
...
Cohesion: 0.11
Nodes (21): ClosingCta(), PLACE_COORDINATES, PLACE_PHOTO, PlaceSection(), ServiceStep(), ServicesChapter(), ServiceStepData, MarkArrow() (+13 more)

### Community 34 - "Community 34"
Cohesion: 0.09
Nodes (24): BlogPostSeed, blogPostSeeds, LegalDocumentSeed, legalDocumentSeeds, PageSeed, pageSeeds, ProductPageSeed, productPageSeeds (+16 more)
...
Cohesion: 0.16
Nodes (18): AdminRoster(), PendingAdminActions(), listAdmins(), RosterEntry, confirmEnrolment(), metadata, openPendingSecret(), seal() (+10 more)
...
Cohesion: 0.11
Nodes (21): INVOICE_STATUSES, InvoiceFilter, InvoiceRow, InvoiceTotals, listInvoices(), numberingGaps(), whereFor(), listRefunds() (+13 more)
...
Cohesion: 0.11
Nodes (22): addDomainAction(), assertRegisteredHost(), isRegisteredHost(), addDomain(), AddDomainInput, normalizeHostname(), normalizeHostnameInput(), addCredential() (+14 more)

### Community 43 - "Community 43"
Cohesion: 0.14
Nodes (21): isPaymentError(), registerReal(), asJson(), eventIdFor(), ProviderEventInput, ProviderEventType, recordProviderEvent(), hasProvider() (+13 more)

### Community 44 - "Community 44"
Cohesion: 0.22
Nodes (14): auditActions(), AuditRow, listAuditEntries(), NUMERIC_FIELDS, FILTERS, AuditLogPage(), formatBsNumeric(), BsDate() (+6 more)
...
Cohesion: 0.14
Nodes (22): BOUNDS, clamped, frame, image, images, min, offset, scale (+14 more)

### Community 48 - "Community 48"
Cohesion: 0.12
Nodes (20): mutatingEndpoint(), paisa(), serializeInvoice(), serializeRefund(), serializeSession(), serializeTransaction(), serializeTransactionView(), POST (+12 more)

### Community 49 - "Community 49"
Cohesion: 0.11
Nodes (13): SmoothScroll(), MeetingSlot, MeetingSlotsCard(), ChatMessageUI, ChatWidget(), DEFAULT_WELCOME_MESSAGE, QUICK_ACTIONS, SESSION_STAMP (+5 more)
...
Cohesion: 0.13
Nodes (11): AuditRecord, audited, makeAttempt(), makeSession(), NOW, receipts, NOW, PERIOD_ENDS (+3 more)
...
Cohesion: 0.17
Nodes (13): ApplicationHeader(), ReauthFields(), DESCRIPTION, ScopeCheckboxes(), ApplicationSummary, CredentialResult, failure(), readScopes() (+5 more)

### Community 58 - "Community 58"
Cohesion: 0.13
Nodes (11): PAYMENT_ERROR_STATUS, PaymentError, PaymentErrorCode, PUBLIC_MESSAGE, decimalFromMinor(), minorFromDecimal(), minorFromInteger(), adapter (+3 more)

### Community 59 - "Community 59"
Cohesion: 0.13
Nodes (13): CraftConstellation(), CRAFT_DISCS, CraftDisc, covering, DarkNavZone(), DisciplineCluster(), Discipline, DISCIPLINES (+5 more)

### Community 60 - "Community 60"
Cohesion: 0.13
Nodes (14): BuildTiers(), CLOSING_HEADING, PRINCIPLES_HEADING, PRODUCTS_HEADING, SERVICES_HEADING, STATEMENT, TIERS_HEADING, TierRow() (+6 more)
...
Cohesion: 0.2
Nodes (14): enrolmentUrl(), qrSvg(), createPendingAdmin(), findPendingAdmin(), pendingOnly(), reclaimPendingAdmin(), buildHandoff(), Handoff (+6 more)
...
Cohesion: 0.13
Nodes (11): FilterLink(), Chip(), PostList(), PostSummary, cn(), PageContainer(), PendingDot(), Spinner() (+3 more)

### Community 72 - "Community 72"
Cohesion: 0.15
Nodes (15): DashboardActivity(), DashboardInvoices(), DASHBOARD_TABS, DashboardPayment, DashboardPaymentFilter, DashboardSnapshot, DashboardTab, filterDashboardPayments() (+7 more)
...
Cohesion: 0.16
Nodes (12): PrinciplesSection(), QUALITIES, Quality, QualityPile(), TONE_CLASS, Statement(), CRAFT_STATEMENT, Principle (+4 more)
...
Cohesion: 0.12
Nodes (8): Receipt, ReceiptInput, refunds, INPUT, receipt, audited, NOW, payment()
...
Cohesion: 0.17
Nodes (10): CallbackPage(), metadata, CheckoutNotice(), CheckoutNoticeProps, Tone, ConfirmOutcome, confirmSessionPayment(), ReturnLink (+2 more)

### Community 82 - "Community 82"
Cohesion: 0.17
Nodes (13): authenticateApplication(), AuthenticatedApplication, bearerToken(), matchSecret(), unauthenticated(), FiledRefund, REFUNDABLE, RequestRefundInput (+5 more)
...
Cohesion: 0.15
Nodes (9): generateSessionId(), audited, makePayable(), NOW, PERIOD_ENDS, PERIOD_STARTS, receipts, verified() (+1 more)
...
Cohesion: 0.21
Nodes (6): OrderSummary(), OrderSummaryProps, metadata, PlanDetails(), Presentation, Wordmark()
...
Cohesion: 0.14
Nodes (10): PageSeed, pageSeeds, pages, teamMembers, draft, effectiveAt, live, returned (+2 more)
...
Cohesion: 0.15
Nodes (12): 1. The pre-flight read, 2. Merge and build, 3. Apply the migrations, 4. Verify, in this order, 5. Afterwards, and not urgently, Before anything, code:sql (client_id LIKE 'app_' || mode || '\_%'), code:sql (SELECT client_id, is_live,) (+4 more)
...
Cohesion: 0.24
Nodes (9): NotFound(), ProductsSection(), RecentPosts(), ServicesSection(), homeTagline(), collapse(), splitLede(), generateMetadata() (+1 more)
...
Cohesion: 0.31
Nodes (9): CheckoutView, offerable(), summarise(), Summary, readPresentation(), availableProviders(), CheckoutPage(), metadata (+1 more)

### Community 114 - "Community 114"
Cohesion: 0.2
Nodes (9): BlogPostSeed, blogPostSeeds, blogPosts, legalDocuments, createdSlugs, effectiveAt, slug(), unique() (+1 more)
...
Cohesion: 0.29
Nodes (6): DeviceScreen(), CmsImage(), CmsImageFill(), CmsImageFillProps, CmsImageProps, optimizable()

### Community 120 - "Community 120"
Cohesion: 0.24
Nodes (5): DomainList(), DomainRow, KeyLegend(), KEYS, MODES
...
Cohesion: 0.39
Nodes (6): ensureProvidersRegistered(), MOCKABLE, registerIfAbsent(), registerMocks(), beginPayment(), BeginPaymentResult
...
## Knowledge Gaps
- **1439 isolated node(s):** `eslintConfig`, `RemotePatterns`, `TRUSTED_IMAGE_HOSTS`, `nextConfig`, `config` (+1434 more)
...
- **Why does `isPaymentError()` connect `Community 43` to `Community 38`, `Community 135`, `Community 9`, `Community 10`, `Community 46`, `Community 81`, `Community 113`, `Community 57`, `Community 58`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 71` to `Community 134`, `Community 13`, `Community 14`, `Community 19`, `Community 154`, `Community 32`, `Community 33`, `Community 37`, `Community 40`, `Community 41`, `Community 44`, `Community 47`, `Community 49`, `Community 59`, `Community 60`, `Community 72`, `Community 75`, `Community 84`, `Community 94`, `Community 113`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `CheckoutView` connect `Community 113` to `Community 81`, `Community 10`, `Community 43`?**
