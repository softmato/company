...
## Corpus Check
- 598 files · ~558,558 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3414 nodes · 6857 edges · 187 communities (179 shown, 8 thin omitted)
...
## Communities (187 total, 8 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (112): AboutPage(), generateMetadata(), dmSans, inter, metadata, outfit, plexMono, logoDataUri() (+104 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (59): AuditDetail(), changedKeys(), auditActions(), AuditRow, listAuditEntries(), NUMERIC_FIELDS, DashboardActivity(), DashboardInvoices() (+51 more)
...
Cohesion: 0.05
Nodes (46): products, Application, APPLICATION_SCOPES, ApplicationDomain, applicationDomains, applications, ApplicationScope, Customer (+38 more)
...
Cohesion: 0.08
Nodes (33): ContentForm(), EnrolmentHandoff(), InviteAdminForm(), PublicationPanel(), PublishConfirm(), PublishPending(), SubmitButton(), TotpSetup() (+25 more)

### Community 8 - "Community 8"
Cohesion: 0.08
Nodes (44): nextPollAt(), pollDelayMs(), pollExhausted(), giveUp(), LIVE, PollPendingResult, pollPendingTransactions(), reschedule() (+36 more)
...
Cohesion: 0.08
Nodes (31): ApplicationPanel(), Breadcrumbs(), ContentTable(), DomainList(), ReauthFields(), RegisterApplicationForm(), DESCRIPTION, ScopeCheckboxes() (+23 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (33): Account, accountClass, accounts, normalBalance, Product, productKind, FiscalPeriod, fiscalPeriods (+25 more)
...
Cohesion: 0.1
Nodes (28): registerReal(), EsewaConfig, asJson(), eventIdFor(), ProviderEventInput, ProviderEventType, recordProviderEvent(), FonepayConfig (+20 more)
...
Cohesion: 0.09
Nodes (20): PAYMENT_ERROR_STATUS, PaymentError, PaymentErrorCode, PUBLIC_MESSAGE, callbackUrl(), HOSTS, isLookupAnswer(), KhaltiConfig (+12 more)
...
Cohesion: 0.12
Nodes (22): AdminRoster(), PendingAdminActions(), listAdmins(), RosterEntry, RotateTotpForm(), RotateTotpFormProps, confirmEnrolment(), EnrolPage() (+14 more)
...
Cohesion: 0.11
Nodes (22): key, message, ACCEPT_ATTRIBUTE, ACCEPTED, describeRejection(), describeSourceRejection(), formatBytes(), LABEL_BY_MIME (+14 more)

### Community 34 - "Community 34"
Cohesion: 0.12
Nodes (15): BuildTiers(), covering, DarkNavZone(), CLOSING_HEADING, PRODUCTS_HEADING, TIERS_HEADING, TierRow(), Tier (+7 more)

### Community 35 - "Community 35"
Cohesion: 0.12
Nodes (20): ClosingCta(), Hero(), PLACE_COORDINATES, PLACE_PHOTO, PlaceSection(), PrinciplesSection(), ProductsSection(), RecentPosts() (+12 more)
...
Cohesion: 0.12
Nodes (15): NavItem, SECTIONS, Chip(), PostList(), PostSummary, cn(), MarkArrow(), MarkCircle() (+7 more)

### Community 41 - "Community 41"
Cohesion: 0.19
Nodes (18): DomainRow, confirmIdentity(), confirmIfProduction(), confirmName(), readDomains(), readScopes(), registerApplicationAction(), registerSchema (+10 more)
...
Cohesion: 0.13
Nodes (19): assertRegisteredHost(), isRegisteredHost(), addDomain(), AddDomainInput, removeDomain(), normalizeHostname(), normalizeHostnameInput(), DomainInput (+11 more)
...
Cohesion: 0.12
Nodes (17): DetectedImage, detectImage(), Signature, SIGNATURES, validateImage(), ValidationFailure, ValidationResult, different (+9 more)
...
Cohesion: 0.13
Nodes (15): AiProvider, defaultAiProvider, SmartFallbackProvider, AiProviderChatParams, AiProviderResponse, BookMeetingParams, ChatMessage, ContactHumanParams (+7 more)
...
Cohesion: 0.12
Nodes (12): buildReceipt(), Receipt, ReceiptInput, audited, makePayable(), NOW, PERIOD_ENDS, PERIOD_STARTS (+4 more)
...
Cohesion: 0.15
Nodes (15): authenticateApplication(), AuthenticatedApplication, bearerToken(), matchSecret(), unauthenticated(), AuditRecorder, FiledRefund, REFUNDABLE (+7 more)
...
Cohesion: 0.14
Nodes (11): AuditRecord, generateSessionId(), isSessionIdShape(), audited, makeAttempt(), makeSession(), NOW, receipts (+3 more)
...
Cohesion: 0.26
Nodes (10): amountInWords(), InvoiceSheet(), DocumentDate(), PartyBlock(), STATUS_LABEL, StatusBadge(), vatNote(), ReceiptSheet() (+2 more)
...
Cohesion: 0.23
Nodes (10): ConfirmOutcome, ContactNotification, emailConfigured, resendClient(), Message, sendEmail(), SendResult, env (+2 more)
...
Cohesion: 0.22
Nodes (7): SmoothScroll(), ChatWidget(), NAV_LINKS, SiteFooter(), LINKS, SiteHeader(), useScrolled()

### Community 84 - "Community 84"
Cohesion: 0.21
Nodes (12): NotFound(), OrderSummary(), CheckoutView, offerable(), summarise(), Summary, isContentKind(), readPresentation() (+4 more)
...
Cohesion: 0.26
Nodes (10): paisa(), party(), serializeInvoiceDocument(), serializeReceiptDocument(), blankAsNull(), missingSellerFields(), sellerFromSettings(), DocumentLine (+2 more)
...
Cohesion: 0.23
Nodes (5): AdminNav(), AdminLayout(), metadata, initials(), Wordmark()
...
Cohesion: 0.21
Nodes (8): DisciplineCluster(), Discipline, DISCIPLINES, Satellite, SERVICES_HEADING, ServiceStep(), ServiceStepData, Parallax()
...
Cohesion: 0.31
Nodes (8): AdminGuard, requireAdminApi(), extensionForMime(), isImageMime(), CMS_IMAGE_KEY, cmsImageKey(), slugify(), POST()
...
Cohesion: 0.33
Nodes (8): availableProviders(), ensureProvidersRegistered(), MOCKABLE, registerIfAbsent(), registerMocks(), registeredProviders(), beginPayment(), BeginPaymentResult

### Community 114 - "Community 114"
Cohesion: 0.22
Nodes (7): StatusBadge(), Tone, TONE_BY_STATUS, TONES, metadata, MOCK_SUBSCRIPTIONS, SubscriptionRecord
...
Cohesion: 0.53
Nodes (3): Heading, TocLinks(), useActiveHeading()
...
Cohesion: 0.57
Nodes (4): formatNpr(), formatPaisa(), groupLakhCrore(), Money()

### Community 127 - "Community 127"
Cohesion: 0.25
Nodes (3): credentialsSchema, LoginFailure, { handlers, auth, signIn, signOut }
...
Cohesion: 0.38
Nodes (6): numberInWords(), ONES, SCALES, TENS, underHundred(), underThousand()
...
Cohesion: 0.4
Nodes (4): CraftConstellation(), CRAFT_DISCS, CraftDisc, Drift()
...
Cohesion: 0.5
Nodes (3): SignResponse, uploadImage(), UploadResult
...
## Knowledge Gaps
- **1343 isolated node(s):** `eslintConfig`, `RemotePatterns`, `TRUSTED_IMAGE_HOSTS`, `nextConfig`, `config` (+1338 more)
...
- **Why does `isPaymentError()` connect `Community 17` to `Community 38`, `Community 8`, `Community 41`, `Community 75`, `Community 11`, `Community 14`, `Community 113`, `Community 84`, `Community 22`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 40` to `Community 0`, `Community 1`, `Community 7`, `Community 135`, `Community 143`, `Community 151`, `Community 27`, `Community 32`, `Community 33`, `Community 34`, `Community 35`, `Community 36`, `Community 73`, `Community 77`, `Community 83`, `Community 93`, `Community 101`, `Community 118`, `Community 126`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `submitContact()` connect `Community 119` to `Community 12`, `Community 7`?**
