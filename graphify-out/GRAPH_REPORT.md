...
## Corpus Check
- 306 files · ~150,192 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1535 nodes · 2906 edges · 88 communities (83 shown, 5 thin omitted)
...
Cohesion: 0.07
Nodes (70): AboutPage(), generateMetadata(), NotFound(), sitemap(), BlogIndexPage(), generateMetadata(), CareersPage(), generateMetadata() (+62 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (34): Eclipse(), Orb(), FORM_COLORS, KATHMANDU, PointGlobe(), useIdleSpin(), DarkNavZone(), BLOOM_LAYERS (+26 more)
...
Cohesion: 0.07
Nodes (33): AuditRecord, Customer, customers, Invoice, InvoiceLine, invoiceLines, invoices, invoiceStatus (+25 more)
...
Cohesion: 0.17
Nodes (22): NUMERIC_FIELDS, ActivityEntry, recentActivity(), unbalancedJournalCount(), AdminDashboard(), unbalancedJournalCount(), FilterLink(), Chip() (+14 more)
...
Cohesion: 0.14
Nodes (13): PublishConfirm(), PublishPending(), DESCRIPTION, ScopeCheckboxes(), SubmitButton(), Button(), ButtonSize, ButtonVariant (+5 more)

### Community 21 - "Community 21"
Cohesion: 0.16
Nodes (17): SettingsForm(), saveSettings(), SettingsResult, SETTING_DEFINITIONS, SETTING_GROUPS, SETTING_KEYS, SettingDefinition, SettingKind (+9 more)
...
Cohesion: 0.13
Nodes (12): Breadcrumbs(), ContentForm(), ContentTable(), KindCard(), PublicationPanel(), StatusBadge(), listContent(), isContentKind() (+4 more)
...
Cohesion: 0.19
Nodes (8): AdminNav(), NavItem, SECTIONS, AdminLayout(), initials(), Wordmark(), CheckoutPage(), buttonClasses()
...
Cohesion: 0.22
Nodes (7): SmoothScroll(), ContactDetails(), NAV_LINKS, SiteFooter(), LINKS, SiteHeader(), getSettings
...
Cohesion: 0.22
Nodes (6): ApplicationPanel(), RegisterApplicationForm(), ApplicationSummary, listProductsWithApplications(), ProductWithApplications, ProductsPage()
...
Cohesion: 0.42
Nodes (9): requireAdmin(), CredentialResult, failure(), readScopes(), registerApplicationAction(), registerSchema, revokeApplicationAction(), rotateSecretAction() (+1 more)

### Community 54 - "Community 54"
Cohesion: 0.39
Nodes (4): Field(), borderFor(), Input(), Textarea()
...
## Knowledge Gaps
- **583 isolated node(s):** `eslintConfig`, `Surface`, `SUBDOMAIN_SURFACE`, `SURFACE_PREFIX`, `config` (+578 more)
...
- **Why does `submitContact()` connect `Community 2` to `Community 17`, `Community 20`?**
  _High betweenness centrality (0.109) - this node is a cross-community bridge._
- **Why does `headers` connect `Community 17` to `Community 2`?**
  _High betweenness centrality (0.108) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 14` to `Community 0`, `Community 1`, `Community 2`, `Community 36`, `Community 38`, `Community 40`, `Community 20`, `Community 21`, `Community 54`, `Community 61`?**
