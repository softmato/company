...
## Corpus Check
- 361 files · ~362,601 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1798 nodes · 3622 edges · 98 communities (92 shown, 6 thin omitted)
...
1. `cn()` - 78 edges
2. `[Unreleased]` - 36 edges
3. `metadataFor()` - 35 edges
4. `getPage` - 35 edges
5. `[Phase 1] — 2026-08-14` - 30 edges
6. `siteUrl()` - 27 edges
...
Cohesion: 0.05
Nodes (103): AboutPage(), generateMetadata(), dmSans, inter, metadata, outfit, plexMono, NotFound() (+95 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (56): ContactResult, schema, submitContact(), ContactNotification, notifyContact(), hashIp(), isRateLimited(), DEFAULT_MAILBOXES (+48 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (36): AdminNav(), NavItem, SECTIONS, AdminLayout(), SettingsForm(), TRUSTED_IMAGE_HOSTNAMES, initials(), SmoothScroll() (+28 more)
...
Cohesion: 0.11
Nodes (26): NUMERIC_FIELDS, ActivityEntry, recentActivity(), unbalancedJournalCount(), AdminDashboard(), unbalancedJournalCount(), Chip(), PostList() (+18 more)

### Community 9 - "Community 9"
Cohesion: 0.07
Nodes (31): BlogPostSeed, blogPostSeeds, PageSeed, pageSeeds, ProductPageSeed, productPageSeeds, BlogPost, blogPosts (+23 more)

### Community 10 - "Community 10"
Cohesion: 0.09
Nodes (24): ClosingCta(), covering, DarkNavZone(), DeviceScreen(), DisciplineCluster(), Discipline, DISCIPLINES, Satellite (+16 more)
...
Cohesion: 0.06
Nodes (32): Added, Added, Added, Added, Added, Added, Changed, Changed (+24 more)

### Community 16 - "Community 16"
Cohesion: 0.09
Nodes (25): ServiceSeed, serviceSeeds, services, BlogPostSeed, blogPostSeeds, LegalDocumentSeed, legalDocumentSeeds, PageSeed (+17 more)

### Community 17 - "Community 17"
Cohesion: 0.1
Nodes (20): accounts, FiscalPeriod, fiscalPeriods, periodStatus, entryDirection, journalEntries, JournalEntry, journalSource (+12 more)
...
Cohesion: 0.13
Nodes (17): requireAdmin(), ApplicationPanel(), RegisterApplicationForm(), DESCRIPTION, ScopeCheckboxes(), ApplicationSummary, listProductsWithApplications(), ProductWithApplications (+9 more)

### Community 21 - "Community 21"
Cohesion: 0.1
Nodes (20): AuditRecord, Customer, customers, Invoice, InvoiceLine, invoiceLines, invoices, invoiceStatus (+12 more)

### Community 22 - "Community 22"
Cohesion: 0.09
Nodes (23): deliveryStatus, idempotencyKeys, PaymentSession, ProviderEvent, providerEvents, Refund, refunds, refundStatus (+15 more)
...
Cohesion: 0.11
Nodes (17): CraftConstellation(), CRAFT_DISCS, CraftDisc, PrinciplesSection(), QUALITIES, Quality, QualityPile(), TONE_CLASS (+9 more)
...
Cohesion: 0.15
Nodes (10): Breadcrumbs(), ContentForm(), ContentTable(), KindCard(), StatusBadge(), listContent(), isContentKind(), Field() (+2 more)
...
Cohesion: 0.26
Nodes (6): TextTag, prefersReducedMotion(), registerMotionPlugins(), StaggerTag, TextTag, TextTag
...
Cohesion: 0.25
Nodes (14): publishContent(), unpublishContent(), saveContent(), ActionResult, databaseMessage(), parseId(), requireKind(), getContent() (+6 more)
...
Cohesion: 0.21
Nodes (11): PublicationPanel(), PublishConfirm(), PublishPending(), CheckoutPage(), Button(), buttonClasses(), ButtonSize, ButtonVariant (+3 more)
...
Cohesion: 0.29
Nodes (5): SubmitButton(), Field(), borderFor(), Input(), Textarea()
...
Cohesion: 0.33
Nodes (7): isPastExpiry(), expireIfDue(), loadPayableSession(), loadSession(), isPayable(), now, session
...
Cohesion: 0.25
Nodes (3): authorize(), credentialsSchema, { handlers, auth, signIn, signOut }
...
Cohesion: 0.4
Nodes (4): Brand assets, code:block1 (pnpm brand:build), Generated files, Requirements for the masters
...
## Knowledge Gaps
- **670 isolated node(s):** `eslintConfig`, `RemotePatterns`, `TRUSTED_IMAGE_HOSTS`, `nextConfig`, `config` (+665 more)
...
- **Why does `cn()` connect `Community 8` to `Community 0`, `Community 33`, `Community 2`, `Community 67`, `Community 1`, `Community 69`, `Community 41`, `Community 42`, `Community 75`, `Community 10`, `Community 52`, `Community 25`, `Community 26`?**
  _High betweenness centrality (0.098) - this node is a cross-community bridge._
- **Why does `submitContact()` connect `Community 1` to `Community 17`, `Community 52`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `headers` connect `Community 17` to `Community 1`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
