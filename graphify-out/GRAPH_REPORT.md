...
## Corpus Check
- 604 files · ~572,793 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3491 nodes · 6984 edges · 192 communities (178 shown, 14 thin omitted)
...
Cohesion: 0.05
Nodes (55): CraftConstellation(), CRAFT_DISCS, CraftDisc, covering, DarkNavZone(), DisciplineCluster(), Discipline, DISCIPLINES (+47 more)
...
Cohesion: 0.12
Nodes (32): NotFound(), extractHeadings(), Heading, headingId(), getLegalDocument, getPost, getProductPage, getService (+24 more)

### Community 7 - "Community 7"
Cohesion: 0.08
Nodes (44): confirmSessionPayment(), pollExhausted(), giveUp(), LIVE, PollPendingResult, pollPendingTransactions(), reschedule(), AuditRecorder (+36 more)

### Community 8 - "Community 8"
Cohesion: 0.1
Nodes (37): publishContent(), unpublishContent(), saveContent(), ActionResult, databaseMessage(), parseId(), requireAdmin(), requireKind() (+29 more)

### Community 9 - "Community 9"
Cohesion: 0.17
Nodes (31): AboutPage(), generateMetadata(), BlogIndexPage(), generateMetadata(), CareersPage(), generateMetadata(), metadataFor(), getPage (+23 more)
...
Cohesion: 0.07
Nodes (40): identityContext(), retrieveContext(), RetrievedContext, chunkMarkdown(), KnowledgeChunk, getIndex(), KNOWLEDGE_FILES, knowledgeDir() (+32 more)
...
Cohesion: 0.11
Nodes (29): Eclipse(), Orb(), FORM_COLORS, KATHMANDU, PointGlobe(), Showcase(), useIdleSpin(), drawApp() (+21 more)
...
Cohesion: 0.1
Nodes (29): AdminRoster(), InviteAdminForm(), PendingAdminActions(), listAdmins(), RosterEntry, RotateTotpForm(), confirmEnrolment(), metadata (+21 more)
...
Cohesion: 0.09
Nodes (29): ensureProvidersRegistered(), MOCKABLE, registerIfAbsent(), registerMocks(), registerReal(), EsewaConfig, FonepayConfig, callbackBase() (+21 more)

### Community 19 - "Community 19"
Cohesion: 0.07
Nodes (29): ApplicationPanel(), Breadcrumbs(), ContentTable(), DomainList(), DomainRow, KeyLegend(), KEYS, RegisterApplicationForm() (+21 more)
...
Cohesion: 0.11
Nodes (24): EnrolmentHandoff(), PublicationPanel(), PublishConfirm(), PublishPending(), RotateTotpFormProps, SubmitButton(), TotpSetup(), TotpSetupProps (+16 more)
...
Cohesion: 0.14
Nodes (25): ApplicationHeader(), ReauthFields(), DESCRIPTION, ScopeCheckboxes(), addCredentialAction(), confirmIdentity(), confirmIfProduction(), confirmName() (+17 more)
...
Cohesion: 0.07
Nodes (24): AuditRecord, invoices, paymentSessions, audited, makeAttempt(), makeSession(), NOW, receipts (+16 more)
...
Cohesion: 0.1
Nodes (24): key, message, PendingDot(), Spinner(), ACCEPT_ATTRIBUTE, ACCEPTED, describeRejection(), describeSourceRejection() (+16 more)
...
Cohesion: 0.19
Nodes (17): DashboardActivity(), DASHBOARD_TABS, DashboardMonth, DashboardPaymentFilter, DashboardSnapshot, DashboardTab, filterDashboardPayments(), DashboardOperations() (+9 more)
...
Cohesion: 0.11
Nodes (22): assertRegisteredHost(), isRegisteredHost(), addDomain(), AddDomainInput, removeDomain(), normalizeHostname(), normalizeHostnameInput(), addCredential() (+14 more)
...
Cohesion: 0.21
Nodes (16): NUMERIC_FIELDS, DashboardInvoices(), FilterLink(), Chip(), PostList(), PostSummary, formatBsNumeric(), cn() (+8 more)
...
Cohesion: 0.13
Nodes (19): DashboardInvoice, DashboardMethod, DashboardPayment, ActivityEntry, dashboardAttentionPayments(), dashboardMetrics(), dashboardOverdueInvoices(), dashboardPaymentMethods() (+11 more)
...
Cohesion: 0.12
Nodes (13): callbackUrl(), HOSTS, isLookupAnswer(), KhaltiConfig, KhaltiProviderAdapter, parseJson(), STATUS, websiteUrl() (+5 more)
...
Cohesion: 0.16
Nodes (16): SettingsForm(), SETTING_DEFINITIONS, SETTING_GROUPS, SETTING_KEYS, SettingDefinition, SettingKind, SettingsPage(), getStoredSettings() (+8 more)
...
Cohesion: 0.14
Nodes (15): PAYMENT_ERROR_STATUS, PaymentError, PaymentErrorCode, PUBLIC_MESSAGE, adapter, surface, everything, assertTransition() (+7 more)

### Community 51 - "Community 51"
Cohesion: 0.12
Nodes (18): authenticateApplication(), AuthenticatedApplication, bearerToken(), matchSecret(), unauthenticated(), FiledRefund, REFUNDABLE, RequestRefundInput (+10 more)
...
Cohesion: 0.13
Nodes (16): BuildTiers(), ClosingCta(), Hero(), PlaceSection(), PrinciplesSection(), ProductsSection(), RecentPosts(), Statement() (+8 more)
...
Cohesion: 0.14
Nodes (13): CMS_IMAGE_KEY, cmsImageKey(), slugify(), different, GIF, html, JPEG, key (+5 more)
...
Cohesion: 0.24
Nodes (6): SmoothScroll(), NAV_LINKS, SiteFooter(), LINKS, SiteHeader(), useScrolled()
...
Cohesion: 0.43
Nodes (5): nextPollAt(), pollDelayMs(), delay, due, now
...
## Knowledge Gaps
- **1386 isolated node(s):** `eslintConfig`, `RemotePatterns`, `TRUSTED_IMAGE_HOSTS`, `nextConfig`, `config` (+1381 more)
...
- **Why does `isPaymentError()` connect `Community 7` to `Community 38`, `Community 102`, `Community 8`, `Community 18`, `Community 50`, `Community 26`, `Community 27`, `Community 92`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 41` to `Community 0`, `Community 160`, `Community 34`, `Community 36`, `Community 37`, `Community 6`, `Community 102`, `Community 40`, `Community 9`, `Community 143`, `Community 48`, `Community 23`, `Community 151`, `Community 89`, `Community 154`, `Community 123`, `Community 124`, `Community 125`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `submitContact()` connect `Community 115` to `Community 10`, `Community 23`?**
