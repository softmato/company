...
## Summary
- 3360 nodes · 6710 edges · 189 communities (183 shown, 6 thin omitted)
...
Cohesion: 0.06
Nodes (52): AdminRoster(), PendingAdminActions(), listAdmins(), RosterEntry, TotpSetup(), confirmEnrolment(), EnrolPage(), metadata (+44 more)
...
Cohesion: 0.07
Nodes (37): listRefunds(), RefundRow, StatusBadge(), Tone, TONE_BY_STATUS, TONES, amountInWords(), numberInWords() (+29 more)
...
Cohesion: 0.07
Nodes (33): Account, accountClass, accounts, normalBalance, Product, productKind, products, FiscalPeriod (+25 more)
...
Cohesion: 0.1
Nodes (31): requireAdmin(), DomainList(), DomainRow, ReauthFields(), DESCRIPTION, ScopeCheckboxes(), confirmIdentity(), readDomains() (+23 more)
...
Cohesion: 0.11
Nodes (24): ContentForm(), EnrolmentHandoff(), InviteAdminForm(), PublicationPanel(), PublishConfirm(), PublishPending(), RotateTotpForm(), RotateTotpFormProps (+16 more)

### Community 14 - "Community 14"
Cohesion: 0.16
Nodes (26): NotFound(), sitemap(), getLegalDocument, getPost, getProductPage, getService, listPublishedLegalDocuments(), published() (+18 more)
...
Cohesion: 0.09
Nodes (33): attach(), invoiceAttachment(), receiptAttachment(), safe(), documentIssues(), escapeHtml(), invoiceHtml(), page() (+25 more)
...
Cohesion: 0.1
Nodes (23): BuildTiers(), ClosingCta(), covering, DarkNavZone(), CLOSING_HEADING, PRODUCTS_HEADING, SERVICES_HEADING, TIERS_HEADING (+15 more)

### Community 22 - "Community 22"
Cohesion: 0.1
Nodes (32): BookingFailure, BookingOutcome, BookingRecord, getAvailableSlots(), LeadEntry, LeadRecord, leadsStore, SupportRecord (+24 more)

### Community 23 - "Community 23"
Cohesion: 0.11
Nodes (31): buildReceipt(), sendReceipt(), clearInvoice(), closeSession(), CompletedPayment, completePayment(), flagForReconciliation(), journalNoOf() (+23 more)
...
Cohesion: 0.11
Nodes (22): registerReal(), EsewaConfig, FonepayConfig, callbackBase(), MockConfig, MockProviderAdapter, hasProvider(), providerAdapter() (+14 more)
...
Cohesion: 0.09
Nodes (17): PaymentError, callbackUrl(), HOSTS, isLookupAnswer(), KhaltiConfig, KhaltiProviderAdapter, parseJson(), STATUS (+9 more)
...
Cohesion: 0.14
Nodes (27): buildInvoiceDocument(), customerParty(), documentStatus(), findInvoice(), findPayment(), InvoiceLineRecord, invoiceLinesFor(), InvoiceRecord (+19 more)
...
Cohesion: 0.14
Nodes (21): enrolmentUrl(), qrSvg(), createPendingAdmin(), deletePendingAdmin(), findPendingAdmin(), PendingAdmin, pendingOnly(), reclaimPendingAdmin() (+13 more)

### Community 33 - "Community 33"
Cohesion: 0.08
Nodes (20): AuditRecord, audited, makeAttempt(), makeSession(), NOW, receipts, adapter, mockAdapter (+12 more)
...
Cohesion: 0.12
Nodes (21): ApplicationPanel(), Breadcrumbs(), ContentTable(), RegisterApplicationForm(), ApplicationsPage(), ApplicationDetail, ApplicationSummary, getApplicationDetail() (+13 more)

### Community 37 - "Community 37"
Cohesion: 0.15
Nodes (21): ConfirmOutcome, DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailCategory, NAME_SUFFIX, emailConfigured, resendClient(), EmailIdentity (+13 more)
...
Cohesion: 0.14
Nodes (18): documentFile(), DocumentFormat, joinReference(), safeFilename(), encodeRandom(), encodeTime(), newRequestId(), apiError() (+10 more)
...
Cohesion: 0.13
Nodes (22): confirmSessionPayment(), nextPollAt(), pollDelayMs(), pollExhausted(), giveUp(), LIVE, PollPendingResult, pollPendingTransactions() (+14 more)
...
Cohesion: 0.15
Nodes (16): CallbackPage(), metadata, CheckoutNotice(), CheckoutNoticeProps, Tone, OrderSummary(), ReturnLink, returnLinkFor() (+8 more)

### Community 48 - "Community 48"
Cohesion: 0.19
Nodes (16): documentPdf(), DocumentPdfResult, DocumentKeyInput, documentPdfKey(), hex(), segment(), documentKeyFor(), isFinal() (+8 more)

### Community 49 - "Community 49"
Cohesion: 0.21
Nodes (16): publishContent(), unpublishContent(), saveContent(), ActionResult, databaseMessage(), parseId(), requireKind(), getContent() (+8 more)
...
Cohesion: 0.16
Nodes (10): Chip(), PostList(), PostSummary, cn(), PageContainer(), StillFrame(), EmptyState(), TotalRow() (+2 more)

### Community 59 - "Community 59"
Cohesion: 0.21
Nodes (8): KindCard(), Card(), CardBody(), CardHeader(), CardTitle(), Skeleton(), SkeletonRows(), StatTile()
...
Cohesion: 0.25
Nodes (8): ServicesChapter(), BlurIn(), TextTag, prefersReducedMotion(), registerMotionPlugins(), StaggerTag, TextTag, TextTag
...
Cohesion: 0.12
Nodes (11): Receipt, ReceiptInput, audited, makePayable(), NOW, PERIOD_ENDS, PERIOD_STARTS, receipts (+3 more)
...
Cohesion: 0.15
Nodes (13): CraftConstellation(), CRAFT_DISCS, CraftDisc, PrinciplesSection(), PRINCIPLES_HEADING, STATEMENT, Statement(), CRAFT_STATEMENT (+5 more)
...
Cohesion: 0.18
Nodes (12): PLACE_COORDINATES, PLACE_PHOTO, PlaceSection(), MarkSquiggle(), FormGround, FormKind, LightForm(), LightFormScene (+4 more)

### Community 76 - "Community 76"
Cohesion: 0.3
Nodes (9): NUMERIC_FIELDS, FILTERS, formatBsNumeric(), BsDate(), Money(), DataTable(), Td(), Th() (+1 more)
...
Cohesion: 0.21
Nodes (9): POST, POST, jobEndpoint(), JobHandler, equalInConstantTime(), isAuthorisedJobRequest(), NOT_FOUND, env (+1 more)
...
Cohesion: 0.27
Nodes (9): availableProviders(), ensureProvidersRegistered(), MOCKABLE, registerIfAbsent(), registerMocks(), POST, registeredProviders(), beginPayment() (+1 more)
...
- **Why does `cn()` connect `Community 58` to `Community 130`, `Community 131`, `Community 7`, `Community 137`, `Community 13`, `Community 145`, `Community 21`, `Community 159`, `Community 34`, `Community 38`, `Community 40`, `Community 42`, `Community 47`, `Community 55`, `Community 59`, `Community 66`, `Community 67`, `Community 71`, `Community 75`, `Community 76`, `Community 88`, `Community 106`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `isPaymentError()` connect `Community 41` to `Community 39`, `Community 10`, `Community 107`, `Community 11`, `Community 47`, `Community 23`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `headers` connect `Community 90` to `Community 8`?**
