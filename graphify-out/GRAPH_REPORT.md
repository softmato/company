...
## Corpus Check
- 648 files · ~632,720 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3892 nodes · 7819 edges · 203 communities (190 shown, 13 thin omitted)
...
Cohesion: 0.1
Nodes (43): NUMERIC_FIELDS, DashboardActivity(), DashboardInvoices(), DASHBOARD_TABS, DashboardInvoice, DashboardMethod, DashboardPaymentFilter, DashboardSnapshot (+35 more)
...
Cohesion: 0.06
Nodes (41): BuildTiers(), ClosingCta(), DisciplineCluster(), Discipline, DISCIPLINES, Satellite, PLACE_COORDINATES, PLACE_PHOTO (+33 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (42): CashRow, listCash(), Offline, adminMode(), listPayments(), PAYMENT_STATUSES, PaymentFilter, PaymentRow (+34 more)
...
Cohesion: 0.09
Nodes (36): confirmCashAction(), decide(), rejectCashAction(), confirmEnrolment(), metadata, enrolmentUrl(), qrSvg(), activateWithSecret() (+28 more)
...
Cohesion: 0.1
Nodes (26): AdminRoster(), EnrolmentHandoff(), InviteAdminForm(), PendingAdminActions(), PublishConfirm(), PublishPending(), listAdmins(), RosterEntry (+18 more)

### Community 18 - "Community 18"
Cohesion: 0.07
Nodes (31): accounts, FiscalPeriod, fiscalPeriods, periodStatus, entryDirection, journalEntries, JournalEntry, journalSource (+23 more)
...
Cohesion: 0.12
Nodes (31): documentFile(), safeFilename(), attach(), invoiceAttachment(), receiptAttachment(), safe(), documentPdf(), DocumentPdfResult (+23 more)
...
Cohesion: 0.1
Nodes (32): readProduct(), assertRegisteredHost(), isRegisteredHost(), AddDomainInput, removeDomain(), normalizeHostname(), normalizeHostnameInput(), assertLoopbackAllowed() (+24 more)
...
Cohesion: 0.13
Nodes (17): covering, DarkNavZone(), BLOOM_LAYERS, EXIT_DX, HeroArc(), CRESCENT_LAYERS, HeroEye(), EXIT_DX (+9 more)
...
Cohesion: 0.08
Nodes (28): ApplicationHeader(), ApplicationPanel(), Breadcrumbs(), ContentTable(), KeyLegend(), KEYS, RegisterApplicationForm(), ApplicationsPage() (+20 more)
...
Cohesion: 0.2
Nodes (20): extractHeadings(), getLegalDocument, getPost, getProductPage, getService, listPublishedLegalDocuments(), published(), publishedSlugs() (+12 more)
...
Cohesion: 0.14
Nodes (21): publishContent(), unpublishContent(), revalidateContent(), saveContent(), ActionResult, databaseMessage(), parseId(), requireKind() (+13 more)
...
Cohesion: 0.13
Nodes (18): Eclipse(), Orb(), FORM_COLORS, KATHMANDU, PointGlobe(), Showcase(), useIdleSpin(), SURFACES (+10 more)
...
Cohesion: 0.11
Nodes (22): CUSTOMER, DUE, ISSUED, SAMPLE_INVOICE, SAMPLE_INVOICE_PART_PAID, SAMPLE_INVOICE_VOID, SAMPLE_RECEIPT, SAMPLE_RECEIPT_PARTIAL (+14 more)
...
Cohesion: 0.13
Nodes (17): DashboardMonth, DashboardPayment, ActivityEntry, dashboardAttentionPayments(), dashboardMetrics(), dashboardOverdueInvoices(), dashboardPaymentMethods(), dashboardPayments() (+9 more)
...
Cohesion: 0.19
Nodes (17): ConfirmOutcome, sendEmail(), availableProviders(), availableFor(), registerFromEnv(), ensureProvidersRegistered(), esewaConfig(), khaltiConfig() (+9 more)
...
Cohesion: 0.14
Nodes (11): AdminNav(), NavItem, SECTIONS, AdminLayout(), AdminSandboxNotice(), CraftConstellation(), CRAFT_DISCS, CraftDisc (+3 more)
...
Cohesion: 0.15
Nodes (12): DeviceScreen(), ProductsSection(), TRUSTED_IMAGE_HOSTNAMES, CmsImage(), CmsImageFill(), CmsImageFillProps, CmsImageProps, optimizable() (+4 more)
...
Cohesion: 0.29
Nodes (9): OrderSummary(), CheckoutView, explainEmpty(), offerable(), summarise(), Summary, readPresentation(), CheckoutPage() (+1 more)
...
Cohesion: 0.33
Nodes (6): NotFound(), ServicesSection(), homeTagline(), collapse(), splitLede(), HomePage()

### Community 127 - "Community 127"
Cohesion: 0.33
Nodes (7): sitemap(), isIndexableLegalDocument(), LegalReadiness, publishedPageSlugs(), JsonLd(), serialiseJsonLd(), isProductionSite()
...
- **Why does `isPaymentError()` connect `Community 50` to `Community 33`, `Community 2`, `Community 132`, `Community 38`, `Community 8`, `Community 40`, `Community 11`, `Community 49`, `Community 26`, `Community 123`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Why does `decide()` connect `Community 8` to `Community 33`, `Community 50`, `Community 117`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 1` to `Community 34`, `Community 98`, `Community 4`, `Community 164`, `Community 41`, `Community 171`, `Community 76`, `Community 44`, `Community 43`, `Community 45`, `Community 14`, `Community 17`, `Community 147`, `Community 24`, `Community 29`?**
