...
## Corpus Check
- 589 files · ~542,249 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3332 nodes · 6681 edges · 184 communities (172 shown, 12 thin omitted)
...
Cohesion: 0.08
Nodes (32): callbackUrl(), decodeResponse(), EsewaConfig, EsewaProviderAdapter, HOSTS, missing(), STATUS, transactionUuidFor() (+24 more)

### Community 5 - "Community 5"
Cohesion: 0.09
Nodes (31): AdminRoster(), EnrolmentHandoff(), InviteAdminForm(), PendingAdminActions(), PublishConfirm(), PublishPending(), listAdmins(), RosterEntry (+23 more)
...
Cohesion: 0.09
Nodes (30): DomainRow, ReauthFields(), DESCRIPTION, ScopeCheckboxes(), confirmIdentity(), readDomains(), readScopes(), registerApplicationAction() (+22 more)
...
Cohesion: 0.15
Nodes (26): NotFound(), BlogIndexPage(), generateMetadata(), getLegalDocument, getPost, getProductPage, getService, listPublishedPosts() (+18 more)
...
Cohesion: 0.1
Nodes (29): ConfirmOutcome, confirmSessionPayment(), isPaymentError(), availableProviders(), ensureProvidersRegistered(), MOCKABLE, registerIfAbsent(), registerMocks() (+21 more)
...
Cohesion: 0.13
Nodes (21): confirmEnrolment(), metadata, enrolmentUrl(), qrSvg(), activateWithSecret(), createPendingAdmin(), deletePendingAdmin(), findEnrolmentSubject() (+13 more)

### Community 28 - "Community 28"
Cohesion: 0.16
Nodes (20): publishContent(), unpublishContent(), saveContent(), ActionResult, databaseMessage(), parseId(), requireAdmin(), requireKind() (+12 more)

### Community 29 - "Community 29"
Cohesion: 0.1
Nodes (24): ApplicationPanel(), Breadcrumbs(), ContentForm(), ContentTable(), DomainList(), PublicationPanel(), RegisterApplicationForm(), ApplicationsPage() (+16 more)
...
Cohesion: 0.18
Nodes (27): isIndexableLegalDocument(), LegalReadiness, absoluteImage(), blogPostingNode(), collectionPageNode(), contactPageNode(), iso(), legalPageNode() (+19 more)
...
Cohesion: 0.1
Nodes (18): authenticateApplication(), AuthenticatedApplication, bearerToken(), matchSecret(), unauthenticated(), PAYMENT_ERROR_STATUS, PaymentError, PaymentErrorCode (+10 more)

### Community 39 - "Community 39"
Cohesion: 0.17
Nodes (13): Chip(), PostList(), PostSummary, cn(), PageContainer(), Card(), CardBody(), CardHeader() (+5 more)

### Community 40 - "Community 40"
Cohesion: 0.13
Nodes (18): PrinciplesSection(), ProductsSection(), CLOSING_HEADING, PRINCIPLES_HEADING, PRODUCTS_HEADING, STATEMENT, TIERS_HEADING, Statement() (+10 more)

### Community 41 - "Community 41"
Cohesion: 0.11
Nodes (18): dmSans, inter, metadata, outfit, plexMono, logoDataUri(), OpengraphImage(), size (+10 more)
...
Cohesion: 0.12
Nodes (20): DashboardActivity(), DashboardInvoices(), DASHBOARD_TABS, DashboardInvoice, DashboardMethod, DashboardMonth, DashboardPayment, DashboardPaymentFilter (+12 more)
...
Cohesion: 0.12
Nodes (16): covering, DarkNavZone(), DisciplineCluster(), SERVICES_HEADING, ServiceStep(), ServicesChapter(), ServiceStepData, ServicesSection() (+8 more)
...
Cohesion: 0.22
Nodes (14): auditActions(), AuditRow, listAuditEntries(), NUMERIC_FIELDS, AuditLogPage(), FilterLink(), formatBsNumeric(), BsDate() (+6 more)
...
Cohesion: 0.19
Nodes (14): OrderSummary(), OrderSummaryProps, PlanDetails(), CheckoutView, offerable(), summarise(), Summary, plainText() (+6 more)
...
Cohesion: 0.13
Nodes (9): AccountSeed, accountSeeds, audited, makePayable(), NOW, PERIOD_ENDS, PERIOD_STARTS, receipts (+1 more)
...
Cohesion: 0.2
Nodes (9): CraftConstellation(), CRAFT_DISCS, CraftDisc, Discipline, DISCIPLINES, Satellite, Parallax(), StaggerIn() (+1 more)
...
Cohesion: 0.32
Nodes (9): emailConfigured, resendClient(), configuredDomain(), fallbackIdentity(), resolveEmailIdentity(), EmailAttachment, Message, sendEmail() (+1 more)
...
Cohesion: 0.29
Nodes (7): ClosingCta(), Hero(), RecentPosts(), homeTagline(), collapse(), splitLede(), HomePage()
...
- **Why does `cn()` connect `Community 39` to `Community 5`, `Community 13`, `Community 141`, `Community 149`, `Community 26`, `Community 34`, `Community 37`, `Community 40`, `Community 42`, `Community 43`, `Community 47`, `Community 49`, `Community 51`, `Community 54`, `Community 65`, `Community 86`, `Community 125`, `Community 126`, `Community 127`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `isPaymentError()` connect `Community 18` to `Community 69`, `Community 38`, `Community 10`, `Community 12`, `Community 45`, `Community 17`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `headers` connect `Community 30` to `Community 118`?**
