...
Cohesion: 0.07
Nodes (63): AboutPage(), generateMetadata(), NotFound(), robots(), sitemap(), BlogIndexPage(), generateMetadata(), PostList() (+55 more)
...
Cohesion: 0.05
Nodes (34): AdminNav(), NavItem, SECTIONS, ApplicationPanel(), AdminLayout(), PublishConfirm(), PublishPending(), RegisterApplicationForm() (+26 more)
...
Cohesion: 0.1
Nodes (24): Breadcrumbs(), ContentForm(), ContentTable(), KindCard(), PublicationPanel(), StatusBadge(), listContent(), isContentKind() (+16 more)

### Community 9 - "Community 9"
Cohesion: 0.1
Nodes (27): ClosingCta(), covering, DarkNavZone(), PrinciplesSection(), CLOSING_HEADING, PRINCIPLES_HEADING, PRODUCTS_HEADING, SERVICES_HEADING (+19 more)
...
Cohesion: 0.1
Nodes (26): uploadCmsImage(), UploadResult, cmsObjectKey(), DetectedImage, detectImage(), ImageMime, Signature, SIGNATURES (+18 more)
...
Cohesion: 0.15
Nodes (15): CraftConstellation(), CRAFT_DISCS, CraftDisc, DisciplineCluster(), Discipline, DISCIPLINES, Satellite, TextTag (+7 more)
...
Cohesion: 0.09
Nodes (23): Added, Added, Added, Added, Changed, Changed, Changed, Changed (+15 more)

### Community 26 - "Community 26"
Cohesion: 0.13
Nodes (15): formatBsNumeric(), Hero(), PLACE_COORDINATES, PLACE_PHOTO, PlaceSection(), ProductsSection(), RecentPosts(), ServicesChapter() (+7 more)
...
Cohesion: 0.12
Nodes (16): Account, accountClass, normalBalance, Product, productKind, Application, APPLICATION_SCOPES, applications (+8 more)
...
Cohesion: 0.2
Nodes (14): hasProvider(), providerAdapter(), registeredProviders(), registerProvider(), REGISTRY, resetProviderRegistry(), isProviderId(), PROVIDER_IDS (+6 more)
...
Cohesion: 0.27
Nodes (10): isPastExpiry(), expireIfDue(), loadPayableSession(), loadSession(), assertOffered(), selectProvider(), isPayable(), transitionSession() (+2 more)
...
Cohesion: 0.23
Nodes (10): mutatingEndpoint(), paisa(), serializeInvoice(), serializeSession(), serializeTransaction(), POST, schema, minorAmount (+2 more)
...
Cohesion: 0.26
Nodes (7): encodeRandom(), encodeTime(), newRequestId(), apiError(), apiJson(), toPaymentError(), ApiContext
...
Cohesion: 0.31
Nodes (8): InitiateResult, displayable(), liveAttempt(), StartedPayment, startPayment(), StartPaymentInput, storedInitiate(), TXN_STATUSES
...
- **Why does `submitContact()` connect `Community 1` to `Community 2`, `Community 13`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `headers` connect `Community 13` to `Community 1`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 4` to `Community 0`, `Community 1`, `Community 2`, `Community 26`, `Community 68`, `Community 8`, `Community 9`, `Community 18`, `Community 21`, `Community 23`, `Community 58`?**
