...
## Corpus Check
- 606 files · ~577,224 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3576 nodes · 7083 edges · 201 communities (191 shown, 10 thin omitted)
...
1. `[Unreleased]` - 152 edges
2. `cn()` - 85 edges
3. `[Phase 1] — 2026-08-14` - 51 edges
...
Cohesion: 0.01
Nodes (148): Added, Added, Added, Added, Added, Added, Added, Added (+140 more)
...
Cohesion: 0.07
Nodes (47): confirmEnrolment(), EnrolPage(), metadata, openPendingSecret(), seal(), sealPendingSecret(), activateWithSecret(), findEnrolmentSubject() (+39 more)

### Community 5 - "Community 5"
Cohesion: 0.08
Nodes (45): nextPollAt(), pollDelayMs(), pollExhausted(), giveUp(), LIVE, PollPendingResult, pollPendingTransactions(), reschedule() (+37 more)

### Community 6 - "Community 6"
Cohesion: 0.08
Nodes (29): PAYMENT_ERROR_STATUS, PaymentError, PaymentErrorCode, PUBLIC_MESSAGE, EsewaConfig, FonepayConfig, callbackUrl(), HOSTS (+21 more)
...
Cohesion: 0.08
Nodes (30): CallbackPage(), metadata, CheckoutFlow(), CheckoutFlowProps, fmt(), PROVIDER_META, CheckoutNotice(), CheckoutNoticeProps (+22 more)

### Community 13 - "Community 13"
Cohesion: 0.18
Nodes (24): AboutPage(), generateMetadata(), generateMetadata(), CareersPage(), generateMetadata(), metadataFor(), getPage, listPublishedProducts() (+16 more)

### Community 14 - "Community 14"
Cohesion: 0.07
Nodes (29): Account, accountClass, normalBalance, Product, productKind, products, FiscalPeriod, fiscalPeriods (+21 more)
...
Cohesion: 0.12
Nodes (22): AdminRoster(), EnrolmentHandoff(), InviteAdminForm(), PendingAdminActions(), listAdmins(), RosterEntry, RotateTotpForm(), RotateTotpFormProps (+14 more)
...
Cohesion: 0.1
Nodes (30): expireOne(), ExpireSessionsResult, expireStaleSessions(), OPEN, buildReceipt(), isPastExpiry(), isSessionIdShape(), expireIfDue() (+22 more)
...
Cohesion: 0.12
Nodes (24): publishContent(), unpublishContent(), saveContent(), ActionResult, databaseMessage(), parseId(), requireKind(), ContentForm() (+16 more)
...
Cohesion: 0.13
Nodes (19): extractHeadings(), Heading, headingId(), getLegalDocument, listPublishedLegalDocuments(), DevelopersPage(), metadata, { title, body } (+11 more)
...
Cohesion: 0.13
Nodes (21): documentFile(), DocumentFormat, joinReference(), safeFilename(), encodeRandom(), encodeTime(), newRequestId(), apiError() (+13 more)

### Community 31 - "Community 31"
Cohesion: 0.1
Nodes (24): mutatingEndpoint(), paisa(), serializeInvoice(), serializeRefund(), serializeSession(), serializeTransaction(), serializeTransactionView(), OrderSummary() (+16 more)
...
Cohesion: 0.25
Nodes (15): NUMERIC_FIELDS, DashboardSnapshot, FILTERS, formatBsNumeric(), BsDate(), Card(), CardBody(), CardHeader() (+7 more)
...
Cohesion: 0.25
Nodes (18): NotFound(), getPost, getProductPage, getService, published(), publishedSlugs(), CmsImage(), CmsImageFill() (+10 more)

### Community 39 - "Community 39"
Cohesion: 0.17
Nodes (18): enrolmentUrl(), qrSvg(), createPendingAdmin(), findPendingAdmin(), PendingAdmin, pendingOnly(), reclaimPendingAdmin(), replaceSecret() (+10 more)

### Community 40 - "Community 40"
Cohesion: 0.15
Nodes (13): covering, DarkNavZone(), BLOOM_LAYERS, EXIT_DX, HeroArc(), CRESCENT_LAYERS, HeroEye(), EXIT_DX (+5 more)

### Community 41 - "Community 41"
Cohesion: 0.12
Nodes (13): FilterLink(), Chip(), PostList(), PostSummary, cn(), PageContainer(), StillFrame(), Money() (+5 more)
...
Cohesion: 0.15
Nodes (12): CraftConstellation(), CRAFT_DISCS, CraftDisc, DeviceScreen(), Discipline, DISCIPLINES, Satellite, PRODUCTS_HEADING (+4 more)
...
Cohesion: 0.15
Nodes (12): BuildTiers(), CLOSING_HEADING, PRINCIPLES_HEADING, STATEMENT, TIERS_HEADING, TierRow(), Tier, TIERS (+4 more)
...
Cohesion: 0.15
Nodes (14): ClosingCta(), DisciplineCluster(), SERVICES_HEADING, ServiceStep(), ServicesChapter(), ServiceStepData, MarkArrow(), MarkCircle() (+6 more)

### Community 69 - "Community 69"
Cohesion: 0.19
Nodes (12): PLACE_COORDINATES, PLACE_PHOTO, PlaceSection(), PrinciplesSection(), Statement(), CRAFT_STATEMENT, Principle, PRINCIPLES (+4 more)

### Community 70 - "Community 70"
Cohesion: 0.19
Nodes (12): BlogIndexPage(), listPublishedPosts(), listPublishedServices(), ProductsSection(), RecentPosts(), ServicesSection(), homeTagline(), collapse() (+4 more)
...
Cohesion: 0.12
Nodes (15): 0. What this cost, and how to not pay it twice, 1. The pre-flight read, 2. Merge and build, 3. Apply the migrations, 4. Verify, in this order, 5. Afterwards, and not urgently, Before anything, code:sql (client_id LIKE 'app_' || mode || '\_%') (+7 more)
...
Cohesion: 0.16
Nodes (5): AuditRecord, refunds, audited, NOW, payment()
...
## Knowledge Gaps
- **1463 isolated node(s):** `eslintConfig`, `RemotePatterns`, `TRUSTED_IMAGE_HOSTS`, `nextConfig`, `config` (+1458 more)
...
- **Why does `isPaymentError()` connect `Community 5` to `Community 6`, `Community 12`, `Community 49`, `Community 19`, `Community 20`, `Community 30`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 41` to `Community 32`, `Community 33`, `Community 64`, `Community 56`, `Community 36`, `Community 37`, `Community 68`, `Community 135`, `Community 69`, `Community 134`, `Community 43`, `Community 12`, `Community 13`, `Community 17`, `Community 24`, `Community 57`, `Community 154`, `Community 60`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `submitContact()` connect `Community 1` to `Community 17`?**
