# Graph Report - company  (2026-08-28)

## Corpus Check
- 310 files · ~154,724 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1546 nodes · 2932 edges · 89 communities (81 shown, 8 thin omitted)
...
3. `getPage()` - 28 edges
4. `[Phase 1] — 2026-08-14` - 24 edges
5. `PaymentError` - 21 edges
6. `CmsPage()` - 17 edges
7. `recordAudit()` - 16 edges
8. `requireAdmin()` - 15 edges
9. `[Unreleased]` - 15 edges
10. `Design` - 15 edges
...
Cohesion: 0.07
Nodes (67): AboutPage(), generateMetadata(), NotFound(), sitemap(), BlogIndexPage(), generateMetadata(), PostList(), CareersPage() (+59 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (37): Eclipse(), Orb(), FORM_COLORS, KATHMANDU, PointGlobe(), useIdleSpin(), DarkNavZone(), BLOOM_LAYERS (+29 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (42): robots(), siteUrl(), ContactResult, schema, submitContact(), ContactNotification, notifyContact(), hashIp() (+34 more)
...
Cohesion: 0.08
Nodes (27): AccountingError, allocateDocumentNo(), allocateSequence(), COLUMN, formatDocumentNo(), SequenceKind, TABLE, WIDTH (+19 more)
...
Cohesion: 0.1
Nodes (19): Customer, customers, Invoice, InvoiceLine, invoiceLines, invoices, invoiceStatus, paymentSessions (+11 more)

### Community 17 - "Community 17"
Cohesion: 0.14
Nodes (14): CheckoutPage(), Button(), buttonClasses(), ButtonSize, ButtonVariant, SIZES, VARIANTS, ConfirmDialog() (+6 more)
...
Cohesion: 0.21
Nodes (17): NUMERIC_FIELDS, ActivityEntry, recentActivity(), unbalancedJournalCount(), AdminDashboard(), unbalancedJournalCount(), cn(), Card() (+9 more)
...
Cohesion: 0.16
Nodes (9): listPublishedLegalDocuments(), SmoothScroll(), ContactDetails(), NAV_LINKS, SiteFooter(), LINKS, SiteHeader(), Wordmark() (+1 more)
...
Cohesion: 0.19
Nodes (12): requireAdmin(), DESCRIPTION, ScopeCheckboxes(), SubmitButton(), CredentialResult, failure(), readScopes(), registerApplicationAction() (+4 more)

### Community 29 - "Community 29"
Cohesion: 0.16
Nodes (9): Chip(), PostSummary, ClosingCta(), BlurIn(), TextTag, StaggerIn(), StaggerTag, CardItem (+1 more)
...
Cohesion: 0.17
Nodes (10): ApplicationPanel(), Breadcrumbs(), ContentTable(), RegisterApplicationForm(), SettingsForm(), ApplicationSummary, listProductsWithApplications(), ProductWithApplications (+2 more)
...
Cohesion: 0.14
Nodes (12): AuditRecord, audited, entry, makePayable(), NOW, PERIOD_ENDS, PERIOD_STARTS, receipts (+4 more)
...
## Knowledge Gaps
- **585 isolated node(s):** `eslintConfig`, `Surface`, `SUBDOMAIN_SURFACE`, `SURFACE_PREFIX`, `config` (+580 more)
...
- **Why does `submitContact()` connect `Community 2` to `Community 17`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `headers` connect `Community 2` to `Community 11`?**
  _High betweenness centrality (0.113) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 21` to `Community 0`, `Community 1`, `Community 2`, `Community 67`, `Community 35`, `Community 70`, `Community 40`, `Community 41`, `Community 17`, `Community 20`, `Community 56`, `Community 26`, `Community 29`, `Community 63`?**
