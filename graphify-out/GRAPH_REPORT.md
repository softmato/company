...
## Corpus Check
- 620 files · ~604,207 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3657 nodes · 7225 edges · 197 communities (186 shown, 11 thin omitted)
...
Cohesion: 0.07
Nodes (34): EnrolmentHandoff(), InviteAdminForm(), PublishConfirm(), PublishPending(), RotateTotpForm(), RotateTotpFormProps, SubmitButton(), TotpSetup() (+26 more)

### Community 4 - "Community 4"
Cohesion: 0.09
Nodes (31): CraftConstellation(), CRAFT_DISCS, CraftDisc, covering, DarkNavZone(), PLACE_COORDINATES, PLACE_PHOTO, CLOSING_HEADING (+23 more)
...
Cohesion: 0.1
Nodes (32): AdminRoster(), PendingAdminActions(), listAdmins(), RosterEntry, confirmEnrolment(), metadata, enrolmentUrl(), openPendingSecret() (+24 more)
...
Cohesion: 0.12
Nodes (26): AuditDetail(), changedKeys(), auditActions(), AuditRow, listAuditEntries(), NUMERIC_FIELDS, DashboardSnapshot, FILTERS (+18 more)
...
Cohesion: 0.1
Nodes (28): paisa(), party(), serializeInvoiceDocument(), serializeReceiptDocument(), CUSTOMER, DUE, ISSUED, SAMPLE_INVOICE (+20 more)
...
Cohesion: 0.1
Nodes (22): authenticateApplication(), AuthenticatedApplication, bearerToken(), matchSecret(), unauthenticated(), AddDomainInput, removeDomain(), Actor (+14 more)
...
Cohesion: 0.09
Nodes (16): paymentSessions, audited, makeAttempt(), makeSession(), NOW, receipts, adapter, mockAdapter (+8 more)
...
Cohesion: 0.13
Nodes (16): FilterLink(), Chip(), PostSummary, formatBsNumeric(), cn(), MarkArrow(), MarkCircle(), MarkProps (+8 more)
...
Cohesion: 0.18
Nodes (12): ReauthFields(), DESCRIPTION, ScopeCheckboxes(), ApplicationSummary, CredentialResult, failure(), readScopes(), registerApplicationAction() (+4 more)
...
Cohesion: 0.16
Nodes (14): listPublishedServices(), BuildTiers(), ClosingCta(), Hero(), PlaceSection(), PrinciplesSection(), ProductsSection(), ServicesChapter() (+6 more)
...
Cohesion: 0.19
Nodes (13): ConfirmOutcome, availableProviders(), ensureProvidersRegistered(), esewaConfig(), khaltiConfig(), MOCKABLE, MODES, registerMocks() (+5 more)
...
Cohesion: 0.16
Nodes (12): dmSans, inter, metadata, outfit, plexMono, BlogIndexPage(), PostList(), listPublishedPosts() (+4 more)
...
Cohesion: 0.13
Nodes (14): 1. Prove the token can read the package, 2. The `.npmrc` in the consuming product, 3. Install and integrate, 4. Give the deployment the token, 5. Correct `docs/INTEGRATION.md`, code:bash (cd $env:TEMP; mkdir npmcheck -Force; cd npmcheck), code:block2 (@softmato:registry=https://npm.pkg.github.com), code:bash (pnpm add @softmato/sdk) (+6 more)
...
Cohesion: 0.26
Nodes (10): adminMode(), hasEverRun(), HeldPayment, heldPayments(), openRunItems(), RunItem, AdminReconciliationPage(), metadata (+2 more)
...
Cohesion: 0.24
Nodes (7): DisciplineCluster(), Discipline, DISCIPLINES, Satellite, SERVICES_HEADING, ServiceStep(), ServiceStepData
...
## Knowledge Gaps
- **1504 isolated node(s):** `eslintConfig`, `RemotePatterns`, `TRUSTED_IMAGE_HOSTS`, `nextConfig`, `config` (+1499 more)
...
- **Why does `isPaymentError()` connect `Community 37` to `Community 5`, `Community 8`, `Community 44`, `Community 45`, `Community 14`, `Community 115`, `Community 24`, `Community 57`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 46` to `Community 33`, `Community 161`, `Community 3`, `Community 4`, `Community 132`, `Community 134`, `Community 40`, `Community 42`, `Community 43`, `Community 12`, `Community 92`, `Community 115`, `Community 20`, `Community 22`, `Community 28`, `Community 31`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `submitContact()` connect `Community 99` to `Community 3`, `Community 23`?**
