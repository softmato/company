...
## Summary
- 4677 nodes · 10366 edges · 220 communities (211 shown, 9 thin omitted)
...
Cohesion: 0.06
Nodes (44): CraftConstellation(), CRAFT_DISCS, CraftDisc, covering, DarkNavZone(), PLACE_COORDINATES, PLACE_PHOTO, CLOSING_HEADING (+36 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (58): giveUp(), LIVE, PollPendingResult, pollPendingTransactions(), reschedule(), confirmOfflinePayment(), pendingCash(), RecordedOfflinePayment (+50 more)
...
Cohesion: 0.05
Nodes (38): SettingsForm(), BentoCard(), BentoGrid(), Chip(), PostList(), PostSummary, PaymentActivity(), LAYERS (+30 more)
...
Cohesion: 0.09
Nodes (38): DashboardActivity(), DashboardInvoices(), DASHBOARD_TABS, DashboardInvoice, DashboardMethod, DashboardMonth, DashboardPaymentFilter, DashboardSnapshot (+30 more)

### Community 11 - "Community 11"
Cohesion: 0.08
Nodes (44): AccountLedger, BALANCE_SHEET, chartOfAccounts(), ChartRow, LedgerLine, receivablesAging(), toCsv(), generalLedgerLines() (+36 more)
...
Cohesion: 0.06
Nodes (34): ApplicationHeader(), ApplicationPanel(), Breadcrumbs(), ContentTable(), DeleteApplicationForm(), DomainList(), DomainRow, KeyLegend() (+26 more)

### Community 15 - "Community 15"
Cohesion: 0.11
Nodes (34): AccountsPage(), CLASSES, metadata, NUMERIC_FIELDS, adminMode(), AccountLedgerPage(), metadata, isSource() (+26 more)
...
Cohesion: 0.1
Nodes (31): publishContent(), unpublishContent(), revalidateContent(), saveContent(), ActionResult, databaseMessage(), parseId(), requireKind() (+23 more)

### Community 18 - "Community 18"
Cohesion: 0.08
Nodes (30): WALLET_MARKS, DIRECT_LINE, OWN_PRODUCTS, PORTAL, SHIPPED, TRUSTED_ART, TrustedArt, TrustedName (+22 more)
...
Cohesion: 0.09
Nodes (35): expireOne(), ExpireSessionsResult, expireStaleSessions(), OPEN, PAYMENT_ERROR_STATUS, PaymentErrorCode, PUBLIC_MESSAGE, FormPost (+27 more)
...
Cohesion: 0.08
Nodes (31): encodeRandom(), encodeTime(), newRequestId(), ApiContext, mutatingEndpoint(), paisa(), serializeInvoice(), serializeOfflinePayment() (+23 more)
...
Cohesion: 0.08
Nodes (17): metadata, SmoothScroll(), FooterHorizon(), FooterStars(), LAYERS, seeded(), NAV_LINKS, SiteFooter() (+9 more)
...
Cohesion: 0.14
Nodes (32): robots(), isIndexableLegalDocument(), LegalReadiness, siteUrl(), ContactDetails(), absoluteImage(), blogPostingNode(), collectionPageNode() (+24 more)
...
Cohesion: 0.22
Nodes (22): NotFound(), sitemap(), getLegalDocument, getPost, getProductPage, getService, listPublishedLegalDocuments(), published() (+14 more)
...
Cohesion: 0.1
Nodes (18): DisciplineCluster(), Discipline, DISCIPLINES, Satellite, ART, ServiceArtPanel(), ServiceArt, serviceArtFor() (+10 more)

### Community 47 - "Community 47"
Cohesion: 0.09
Nodes (24): AiProvider, defaultAiProvider, SmartFallbackProvider, AiProviderChatParams, AiProviderResponse, BookMeetingParams, ChatMessage, ContactHumanParams (+16 more)

### Community 48 - "Community 48"
Cohesion: 0.16
Nodes (21): ContactNotification, DetailRow, escapeHtml(), layout(), LayoutOptions, paragraph(), rowsTable(), EmailTemplate (+13 more)
...
Cohesion: 0.09
Nodes (16): invoice(), audited, makeAttempt(), makeSession(), NOW, receipts, adapter, mockAdapter (+8 more)
...
Cohesion: 0.21
Nodes (18): AdminGuard, requireAdminApi(), POST(), detectImage(), extensionForMime(), isImageMime(), CMS_IMAGE_KEY, cmsImageKey() (+10 more)

### Community 63 - "Community 63"
Cohesion: 0.12
Nodes (19): AdminClientPage(), AdminProject, ClientDetail, ClientPerson, ClientRow, byRelevance, ClientDocumentRow, RecentMessage (+11 more)
...
Cohesion: 0.17
Nodes (16): confirmCashAction(), decide(), rejectCashAction(), enrolmentUrl(), qrSvg(), createPendingAdmin(), recordRefundAction(), rupeesToPaisa() (+8 more)
...
Cohesion: 0.13
Nodes (14): callbackBase(), MockProviderAdapter, hasProvider(), providerAdapter(), registerProvider(), REGISTRY, registryKey(), resetProviderRegistry() (+6 more)
...
Cohesion: 0.17
Nodes (17): saveSettings(), SettingsResult, SETTING_DEFINITIONS, SETTING_GROUPS, SETTING_KEYS, SettingDefinition, SettingKind, SettingsPage() (+9 more)
...
Cohesion: 0.16
Nodes (15): DocumentFormat, joinReference(), apiError(), apiJson(), secretExpiryHeaders(), toPaymentError(), readEndpoint(), paisa() (+7 more)
...
Cohesion: 0.15
Nodes (14): BuildTiers(), ClosingCta(), Hero(), PlaceSection(), PrinciplesSection(), ProductsSection(), RecentPosts(), ServicesSection() (+6 more)
...
Cohesion: 0.19
Nodes (11): DeliverableReview(), clientProject(), metadata, PortalProjectPage(), ComposerState, MessageComposer(), MessageThread(), previewHost() (+3 more)
...
Cohesion: 0.2
Nodes (8): ElasticEngine, ElasticOptions, ElasticPhoto(), LightForm(), LightFormScene, noopSubscribe(), serverSnapshot(), webglSupported()
...
Cohesion: 0.19
Nodes (7): PREVIEW_HEADING, PREVIEW_POINTS, POINT_LOOK, PreviewSection(), SITE_ICONS, ToneSegment, ToneSentence
...
Cohesion: 0.31
Nodes (5): BANK_SLUGS, bankMark(), BankSlug, BrandMark(), MarkAsset
...
Cohesion: 0.5
Nodes (4): IconChip(), SIZES, ROTATION, Tone
...
Cohesion: 0.43
Nodes (4): createDataPixelArcRenderer(), DATA_PIXEL_ARC_DEFAULTS, DataPixelArcMode, DataPixelArcOptions
...
Cohesion: 0.33
Nodes (4): InvoiceList(), ClientInvoice, base, html
...
Cohesion: 0.5
Nodes (3): confirmSessionPayment(), checkPayment(), latestAttempt()
...
- **Why does `isPaymentError()` connect `Community 4` to `Community 69`, `Community 40`, `Community 106`, `Community 80`, `Community 22`, `Community 55`, `Community 86`, `Community 186`?**
  _High betweenness centrality (0.109) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 8` to `Community 3`, `Community 132`, `Community 6`, `Community 10`, `Community 14`, `Community 15`, `Community 18`, `Community 20`, `Community 149`, `Community 21`, `Community 27`, `Community 160`, `Community 167`, `Community 42`, `Community 44`, `Community 46`, `Community 52`, `Community 53`, `Community 54`, `Community 57`, `Community 58`, `Community 63`, `Community 87`, `Community 94`, `Community 99`, `Community 110`, `Community 115`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `recordAudit()` connect `Community 1` to `Community 69`, `Community 70`, `Community 39`, `Community 40`, `Community 41`, `Community 106`, `Community 75`, `Community 11`, `Community 45`, `Community 109`, `Community 17`, `Community 150`, `Community 55`, `Community 24`, `Community 25`, `Community 122`, `Community 62`?**
