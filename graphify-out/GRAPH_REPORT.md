...
## Corpus Check
- 607 files · ~579,238 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3585 nodes · 7098 edges · 194 communities (185 shown, 9 thin omitted)
...
Cohesion: 0.06
Nodes (51): uploadCmsImage(), UploadResult, AdminGuard, requireAdminApi(), POST(), describedBy(), FieldShell(), ImageField() (+43 more)
...
Cohesion: 0.1
Nodes (31): AdminRoster(), PendingAdminActions(), listAdmins(), RosterEntry, TotpSetup(), confirmEnrolment(), metadata, enrolmentUrl() (+23 more)
...
Cohesion: 0.1
Nodes (23): ContentForm(), DomainRow, EnrolmentHandoff(), InviteAdminForm(), PublicationPanel(), PublishConfirm(), PublishPending(), RotateTotpForm() (+15 more)

### Community 15 - "Community 15"
Cohesion: 0.1
Nodes (30): paisa(), party(), serializeInvoiceDocument(), serializeReceiptDocument(), attach(), invoiceAttachment(), receiptAttachment(), safe() (+22 more)
...
Cohesion: 0.09
Nodes (21): Chip(), PostList(), PostSummary, cn(), PageContainer(), Badge(), BadgeTone, STATUS_TONES (+13 more)

### Community 23 - "Community 23"
Cohesion: 0.1
Nodes (26): INVOICE_STATUSES, InvoiceFilter, InvoiceRow, InvoiceTotals, listInvoices(), numberingGaps(), whereFor(), listPayments() (+18 more)
...
Cohesion: 0.14
Nodes (22): documentPdf(), DocumentPdfResult, DocumentKeyInput, documentPdfKey(), hex(), segment(), documentKeyFor(), isFinal() (+14 more)
...
Cohesion: 0.14
Nodes (21): expireOne(), ExpireSessionsResult, expireStaleSessions(), OPEN, isPastExpiry(), expireIfDue(), loadPayableSession(), loadSession() (+13 more)
...
Cohesion: 0.11
Nodes (18): BuildTiers(), CLOSING_HEADING, PRINCIPLES_HEADING, PRODUCTS_HEADING, SERVICES_HEADING, STATEMENT, TIERS_HEADING, ServiceStep() (+10 more)
...
Cohesion: 0.17
Nodes (20): publishContent(), unpublishContent(), saveContent(), ActionResult, databaseMessage(), parseId(), requireKind(), getContent() (+12 more)
...
Cohesion: 0.13
Nodes (20): SignResponse, uploadImage(), UploadResult, ACCEPT_ATTRIBUTE, ACCEPTED, describeRejection(), describeSourceRejection(), formatBytes() (+12 more)
...
Cohesion: 0.15
Nodes (16): PLACE_COORDINATES, PLACE_PHOTO, PlaceSection(), PrinciplesSection(), Statement(), CRAFT_STATEMENT, Principle, PRINCIPLES (+8 more)
...
Cohesion: 0.15
Nodes (18): assertRegisteredHost(), isRegisteredHost(), normalizeHostname(), normalizeHostnameInput(), addCredential(), DomainInput, IssuedCredential, normalizeDomains() (+10 more)
...
Cohesion: 0.18
Nodes (18): isPaymentError(), refusal(), close(), flag(), notify(), settle(), settleTransaction(), isSettled() (+10 more)
...
Cohesion: 0.16
Nodes (12): ClosingCta(), covering, DarkNavZone(), ServicesChapter(), BlurIn(), TextTag, LightForm(), LightFormScene (+4 more)

### Community 66 - "Community 66"
Cohesion: 0.13
Nodes (17): DashboardActivity(), DashboardInvoices(), DASHBOARD_TABS, DashboardInvoice, DashboardMethod, DashboardMonth, DashboardPayment, DashboardPaymentFilter (+9 more)
...
Cohesion: 0.15
Nodes (13): authenticateApplication(), AuthenticatedApplication, bearerToken(), matchSecret(), unauthenticated(), AddDomainInput, removeDomain(), Actor (+5 more)
...
Cohesion: 0.16
Nodes (14): CreatedSession, createSession(), CreateSessionInput, ownedInvoice(), providersForAmount(), generateSessionId(), isSessionIdShape(), NOW (+6 more)
...
Cohesion: 0.24
Nodes (12): DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailCategory, NAME_SUFFIX, EmailIdentity, configuredDomain(), fallbackIdentity(), resolveEmailIdentity() (+4 more)
...
Cohesion: 0.18
Nodes (7): AdminNav(), NavItem, SECTIONS, AdminLayout(), metadata, initials(), Wordmark()

### Community 87 - "Community 87"
Cohesion: 0.21
Nodes (12): OrderSummary(), OrderSummaryProps, PlanDetails(), CheckoutView, offerable(), summarise(), Summary, Presentation (+4 more)
...
Cohesion: 0.22
Nodes (10): ProductsSection(), RecentPosts(), ServicesSection(), homeTagline(), collapse(), splitLede(), generateMetadata(), HomePage() (+2 more)
...
Cohesion: 0.24
Nodes (12): availableProviders(), ensureProvidersRegistered(), esewaConfig(), khaltiConfig(), MOCKABLE, MODES, registerIfAbsent(), registerMocks() (+4 more)
...
Cohesion: 0.27
Nodes (9): emailConfigured, resendClient(), fromHeaderFor(), normaliseDomain(), replyToFor(), Message, sendEmail(), sendPaymentReceipt() (+1 more)
...
## Knowledge Gaps
- **1467 isolated node(s):** `eslintConfig`, `RemotePatterns`, `TRUSTED_IMAGE_HOSTS`, `nextConfig`, `config` (+1462 more)
...
- **Why does `isPaymentError()` connect `Community 62` to `Community 96`, `Community 33`, `Community 6`, `Community 39`, `Community 38`, `Community 47`, `Community 80`, `Community 55`, `Community 87`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 22` to `Community 64`, `Community 65`, `Community 35`, `Community 37`, `Community 134`, `Community 41`, `Community 42`, `Community 43`, `Community 12`, `Community 14`, `Community 111`, `Community 49`, `Community 19`, `Community 86`, `Community 87`, `Community 30`, `Community 95`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `CheckoutView` connect `Community 87` to `Community 80`, `Community 33`, `Community 62`?**
