# Graph Report - company  (2026-09-08)

## Corpus Check
- 619 files · ~603,325 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3642 nodes · 7211 edges · 205 communities (192 shown, 13 thin omitted)
...
1. `[Unreleased]` - 171 edges
2. `cn()` - 85 edges
3. `[Phase 1] — 2026-08-14` - 54 edges
4. `PaymentError` - 40 edges
5. `requireAdmin()` - 36 edges
6. `recordAudit()` - 36 edges
7. `metadataFor()` - 35 edges
8. `getPage` - 35 edges
9. `siteUrl()` - 27 edges
...
## Communities (205 total, 13 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (166): Added, Added, Added, Added, Added, Added, Added, Added (+158 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (43): call(), endpoint(), loaded, msg, [name, urlPath = '/', scrollArg = '0', width = '1440', height = '900'], pending, PORT, send() (+35 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (45): CallbackPage(), metadata, CheckoutFlow(), CheckoutFlowProps, fmt(), PROVIDER_META, CheckoutNotice(), CheckoutNoticeProps (+37 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (35): ApplicationHeader(), ApplicationPanel(), Breadcrumbs(), ContentTable(), KeyLegend(), KEYS, ReauthFields(), RegisterApplicationForm() (+27 more)
...
Cohesion: 0.06
Nodes (38): Account, accountClass, accounts, normalBalance, Product, productKind, products, entryDirection (+30 more)
...
Cohesion: 0.06
Nodes (50): 1. Conventions, 2. Authentication, 3. Endpoints, 4. Outbound webhooks, 5.1 `manual_qr`, 5.1 `manual_qr` — **removed 2026-08-16**, 5.2 Khalti (KPG v2), 5.3 eSewa (+42 more)
...
Cohesion: 0.1
Nodes (30): AdminRoster(), PendingAdminActions(), listAdmins(), RosterEntry, confirmEnrolment(), metadata, enrolmentUrl(), openPendingSecret() (+22 more)

### Community 10 - "Community 10"
Cohesion: 0.1
Nodes (27): EnrolmentHandoff(), InviteAdminForm(), PublishConfirm(), PublishPending(), RotateTotpForm(), RotateTotpFormProps, SubmitButton(), TotpSetup() (+19 more)
...
Cohesion: 0.07
Nodes (36): Application, APPLICATION_SCOPES, ApplicationCredential, applicationCredentials, ApplicationDomain, applicationDomains, applications, ApplicationScope (+28 more)

### Community 13 - "Community 13"
Cohesion: 0.18
Nodes (26): AboutPage(), generateMetadata(), generateMetadata(), CareersPage(), generateMetadata(), metadataFor(), getPage, listPublishedProducts() (+18 more)
...
Cohesion: 0.1
Nodes (34): giveUp(), LIVE, PollPendingResult, pollPendingTransactions(), reschedule(), AuditRecorder, buildReceipt(), ReceiptSender (+26 more)
...
Cohesion: 0.11
Nodes (22): extractHeadings(), Heading, headingId(), getLegalDocument, listPublishedLegalDocuments(), INTEGRATION_PATH, integrationDoc(), stripRepoLinks() (+14 more)

### Community 19 - "Community 19"
Cohesion: 0.08
Nodes (17): AuditRecord, Receipt, ReceiptInput, refunds, audited, makeAttempt(), makeSession(), NOW (+9 more)
...
Cohesion: 0.15
Nodes (24): DashboardActivity(), DashboardInvoices(), DASHBOARD_TABS, DashboardInvoice, DashboardMethod, DashboardMonth, DashboardPaymentFilter, DashboardSnapshot (+16 more)

### Community 22 - "Community 22"
Cohesion: 0.16
Nodes (22): Eclipse(), Orb(), FORM_COLORS, KATHMANDU, PointGlobe(), Showcase(), useIdleSpin(), drawApp() (+14 more)

### Community 23 - "Community 23"
Cohesion: 0.09
Nodes (30): assertRegisteredHost(), isRegisteredHost(), addDomain(), AddDomainInput, removeDomain(), normalizeHostname(), normalizeHostnameInput(), addCredential() (+22 more)
...
Cohesion: 0.14
Nodes (27): buildInvoiceDocument(), customerParty(), documentStatus(), documentIssues(), SheetWarning(), findInvoice(), findPayment(), InvoiceLineRecord (+19 more)
...
Cohesion: 0.14
Nodes (22): publishContent(), unpublishContent(), saveContent(), ActionResult, databaseMessage(), parseId(), requireKind(), ContentForm() (+14 more)

### Community 29 - "Community 29"
Cohesion: 0.09
Nodes (15): metadata, SmoothScroll(), MeetingSlot, MeetingSlotsCard(), ChatMessageUI, ChatWidget(), DEFAULT_WELCOME_MESSAGE, QUICK_ACTIONS (+7 more)
...
Cohesion: 0.14
Nodes (20): documentFile(), DocumentFormat, joinReference(), safeFilename(), encodeRandom(), encodeTime(), newRequestId(), apiError() (+12 more)

### Community 34 - "Community 34"
Cohesion: 0.12
Nodes (24): allowBooking(), allowTurn(), bookings, callerAddress(), hashAddress(), record(), turns, formatToolResults() (+16 more)
...
Cohesion: 0.11
Nodes (23): uploadCmsImage(), UploadResult, cmsObjectKey(), DetectedImage, detectImage(), Signature, SIGNATURES, validateImage() (+15 more)
...
Cohesion: 0.14
Nodes (21): FormPost, isPastExpiry(), isSessionIdShape(), expireIfDue(), loadPayableSession(), loadSession(), assertOffered(), selectProvider() (+13 more)
...
Cohesion: 0.12
Nodes (16): expireOne(), ExpireSessionsResult, expireStaleSessions(), OPEN, PAYMENT_ERROR_STATUS, PaymentError, PaymentErrorCode, PUBLIC_MESSAGE (+8 more)
...
Cohesion: 0.11
Nodes (18): listRefunds(), RefundRow, StatusBadge(), Tone, TONE_BY_STATUS, TONES, AdminRefundsPage(), metadata (+10 more)
...
Cohesion: 0.14
Nodes (15): Chip(), PostList(), PostSummary, ServiceStep(), ServicesChapter(), ServiceStepData, cn(), MarkArrow() (+7 more)

### Community 54 - "Community 54"
Cohesion: 0.13
Nodes (12): ClosingCta(), covering, DarkNavZone(), DeviceScreen(), DisciplineCluster(), Discipline, DISCIPLINES, Satellite (+4 more)
...
Cohesion: 0.13
Nodes (15): chromeBinary(), renderWithChrome(), run(), fontsArrived(), renderWithBundledChromium(), renderPdf(), PdfResult, COUNTED (+7 more)

### Community 57 - "Community 57"
Cohesion: 0.12
Nodes (15): CraftConstellation(), CRAFT_DISCS, CraftDisc, PrinciplesSection(), QUALITIES, Quality, QualityPile(), TONE_CLASS (+7 more)

### Community 58 - "Community 58"
Cohesion: 0.34
Nodes (14): NotFound(), getPost, getProductPage, getService, published(), publishedSlugs(), CmsImageFill(), Markdown() (+6 more)

### Community 59 - "Community 59"
Cohesion: 0.14
Nodes (17): mutatingEndpoint(), paisa(), serializeInvoice(), serializeRefund(), serializeSession(), serializeTransaction(), serializeTransactionView(), POST (+9 more)

### Community 60 - "Community 60"
Cohesion: 0.11
Nodes (13): FiscalPeriod, fiscalPeriods, periodStatus, bsCalendar, BsMonthBoundary, FiscalPeriodSeed, audited, makePayable() (+5 more)
...
Cohesion: 0.19
Nodes (15): INVOICE_STATUSES, InvoiceFilter, InvoiceRow, InvoiceTotals, listInvoices(), numberingGaps(), whereFor(), formatNpr() (+7 more)

### Community 64 - "Community 64"
Cohesion: 0.16
Nodes (13): AuditDetail(), changedKeys(), auditActions(), AuditRow, listAuditEntries(), NUMERIC_FIELDS, AuditLogPage(), FilterLink() (+5 more)

### Community 65 - "Community 65"
Cohesion: 0.22
Nodes (17): attach(), invoiceAttachment(), receiptAttachment(), safe(), documentPdf(), DocumentPdfResult, documentKeyFor(), StorableDocument (+9 more)
...
Cohesion: 0.14
Nodes (13): BuildTiers(), CLOSING_HEADING, PRINCIPLES_HEADING, PRODUCTS_HEADING, SERVICES_HEADING, STATEMENT, TIERS_HEADING, TierRow() (+5 more)
...
Cohesion: 0.21
Nodes (16): DEFAULT_MAILBOXES, EMAIL_CATEGORIES, EmailCategory, NAME_SUFFIX, EmailIdentity, fromHeaderFor(), normaliseDomain(), replyToFor() (+8 more)
...
Cohesion: 0.14
Nodes (13): PLACE_COORDINATES, PLACE_PHOTO, PlaceSection(), TRUSTED_IMAGE_HOSTNAMES, DrawIn(), CmsImage(), CmsImageFillProps, CmsImageProps (+5 more)

### Community 74 - "Community 74"
Cohesion: 0.2
Nodes (10): BLOOM_LAYERS, EXIT_DX, HeroArc(), CRESCENT_LAYERS, HeroEye(), EXIT_DX, Hero(), heroStart() (+2 more)

### Community 75 - "Community 75"
Cohesion: 0.2
Nodes (13): ActivityEntry, dashboardAttentionPayments(), dashboardMetrics(), dashboardOverdueInvoices(), dashboardPaymentMethods(), dashboardPayments(), dashboardRevenue(), dashboardSnapshot() (+5 more)

### Community 76 - "Community 76"
Cohesion: 0.23
Nodes (14): DetailRow, escapeHtml(), layout(), LayoutOptions, paragraph(), rowsTable(), EmailTemplate, contactEnquiryEmail() (+6 more)

### Community 77 - "Community 77"
Cohesion: 0.11
Nodes (14): ESEWA_KEYS, ESEWA_PAIRS, esewaSet, hex32, issues, missing, parsed, PRIVATE_R2_KEYS (+6 more)

### Community 78 - "Community 78"
Cohesion: 0.11
Nodes (14): adapter, mockAdapter, mockSession, mockTxn, txn, audited, entry, expiresAt (+6 more)

### Community 79 - "Community 79"
Cohesion: 0.33
Nodes (9): describedBy(), FieldShell(), ImageField(), Field(), MarkdownField(), TagsField(), TextField(), TextareaField() (+1 more)

### Community 80 - "Community 80"
Cohesion: 0.14
Nodes (16): CUSTOMER, DUE, ISSUED, SAMPLE_INVOICE, SAMPLE_INVOICE_PART_PAID, SAMPLE_INVOICE_VOID, SAMPLE_RECEIPT, SAMPLE_RECEIPT_PARTIAL (+8 more)
...
Cohesion: 0.33
Nodes (5): TextTag, prefersReducedMotion(), registerMotionPlugins(), TextTag, TextTag
...
Cohesion: 0.24
Nodes (12): DocumentKeyInput, documentPdfKey(), hex(), segment(), isFinal(), readDocumentPdf(), writeDocumentPdf(), privateBucket() (+4 more)

### Community 85 - "Community 85"
Cohesion: 0.21
Nodes (13): registerIfAbsent(), hasProvider(), providerAdapter(), registerProvider(), REGISTRY, registryKey(), resetProviderRegistry(), isProviderId() (+5 more)
...
Cohesion: 0.15
Nodes (11): SmartFallbackProvider, args, data, fallback, mockContext, pricingDoc, prompt, servicesDoc (+3 more)
...
Cohesion: 0.44
Nodes (9): POST(), parseCmsImageKey(), publicBucket(), publicUrl(), r2(), deleteCmsObject(), headCmsObject(), readCmsObjectPrefix() (+1 more)
...
Cohesion: 0.27
Nodes (8): ProductsSection(), ServicesSection(), homeTagline(), collapse(), splitLede(), HomePage(), JsonLd(), serialiseJsonLd()
...
Cohesion: 0.24
Nodes (9): CreatedSession, createSession(), CreateSessionInput, ownedInvoice(), providersForAmount(), generateSessionId(), seen, suffix (+1 more)
...
Cohesion: 0.27
Nodes (8): ContactNotification, emailConfigured, resendClient(), EmailAttachment, Message, SendResult, env, ContactEnquiry
...
Cohesion: 0.44
Nodes (7): ContactResult, schema, submitContact(), notifyContact(), hashIp(), isRateLimited(), headers
...
Cohesion: 0.43
Nodes (5): BlogIndexPage(), listPublishedPosts(), BS_MONTHS, formatBs(), RecentPosts()
...
Cohesion: 0.39
Nodes (6): nextPollAt(), pollDelayMs(), pollExhausted(), delay, due, now
...
Cohesion: 0.6
Nodes (5): atNptMidday(), formatToolResult(), speakSlot(), speakSlots(), speakTime()

### Community 157 - "Community 157"
Cohesion: 0.47
Nodes (3): ConfirmOutcome, sendPaymentReceipt(), POST
...
## Knowledge Gaps
- **1496 isolated node(s):** `eslintConfig`, `RemotePatterns`, `TRUSTED_IMAGE_HOSTS`, `nextConfig`, `config` (+1491 more)
...
- **Why does `isPaymentError()` connect `Community 95` to `Community 32`, `Community 33`, `Community 2`, `Community 45`, `Community 16`, `Community 23`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 53` to `Community 2`, `Community 3`, `Community 10`, `Community 13`, `Community 18`, `Community 21`, `Community 29`, `Community 36`, `Community 38`, `Community 167`, `Community 40`, `Community 166`, `Community 47`, `Community 48`, `Community 54`, `Community 57`, `Community 63`, `Community 64`, `Community 73`, `Community 82`, `Community 127`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `submitContact()` connect `Community 122` to `Community 10`?**
