...
## Corpus Check
- 605 files · ~575,969 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3528 nodes · 7020 edges · 196 communities (185 shown, 11 thin omitted)
...
Cohesion: 0.05
Nodes (45): AdminNav(), NavItem, SECTIONS, AdminLayout(), CallbackPage(), metadata, CheckoutFlow(), CheckoutFlowProps (+37 more)
...
Cohesion: 0.07
Nodes (33): ApplicationHeader(), ApplicationPanel(), Breadcrumbs(), ContentTable(), KeyLegend(), KEYS, ReauthFields(), RegisterApplicationForm() (+25 more)
...
Cohesion: 0.1
Nodes (35): dmSans, inter, metadata, outfit, plexMono, robots(), sitemap(), isIndexableLegalDocument() (+27 more)
...
Cohesion: 0.12
Nodes (22): EnrolmentHandoff(), InviteAdminForm(), RotateTotpForm(), RotateTotpFormProps, expiresIn(), formatAdDateTime(), LoginFailureCode, LoginPage() (+14 more)
...
Cohesion: 0.12
Nodes (26): isPaymentError(), ensureProvidersRegistered(), MOCKABLE, registerIfAbsent(), registerMocks(), registerReal(), asJson(), eventIdFor() (+18 more)
...
Cohesion: 0.14
Nodes (23): everything, close(), flag(), notify(), settle(), settleTransaction(), assertTransition(), canTransition() (+15 more)

### Community 39 - "Community 39"
Cohesion: 0.11
Nodes (16): FilterLink(), Chip(), PostList(), PostSummary, cn(), PillPile(), PageContainer(), StillFrame() (+8 more)
...
Cohesion: 0.12
Nodes (17): ClosingCta(), DeviceScreen(), DisciplineCluster(), CLOSING_HEADING, PRINCIPLES_HEADING, PRODUCTS_HEADING, SERVICES_HEADING, STATEMENT (+9 more)
...
Cohesion: 0.18
Nodes (14): Eclipse(), Orb(), FORM_COLORS, KATHMANDU, PointGlobe(), Showcase(), useIdleSpin(), prefersReducedMotion() (+6 more)
...
Cohesion: 0.1
Nodes (15): accounts, transactions, PaymentProvider, paymentProviders, ReconciliationItem, reconciliationItems, ReconciliationRun, reconciliationRuns (+7 more)
...
Cohesion: 0.23
Nodes (13): auditActions(), AuditRow, listAuditEntries(), NUMERIC_FIELDS, FILTERS, AuditLogPage(), formatBsNumeric(), BsDate() (+5 more)
...
Cohesion: 0.13
Nodes (16): hasEverRun(), HeldPayment, heldPayments(), openRunItems(), RunItem, StatusBadge(), Tone, TONE_BY_STATUS (+8 more)
...
Cohesion: 0.26
Nodes (8): DashboardSnapshot, KindCard(), Card(), CardBody(), CardHeader(), CardTitle(), Money(), StatTile()
...
Cohesion: 0.18
Nodes (12): listPublishedPosts(), listPublishedServices(), ProductsSection(), RecentPosts(), ServicesSection(), homeTagline(), collapse(), splitLede() (+4 more)
...
Cohesion: 0.24
Nodes (11): amountInWords(), InvoiceSheet(), DocumentDate(), PartyBlock(), STATUS_LABEL, StatusBadge(), vatNote(), ReceiptSheet() (+3 more)
...
Cohesion: 0.24
Nodes (11): enrolmentUrl(), createPendingAdmin(), findPendingAdmin(), reclaimPendingAdmin(), buildHandoff(), inviteAdmin(), InviteResult, Reauth (+3 more)
...
Cohesion: 0.3
Nodes (7): listPublishedTeam(), TeamGrid(), teamPageNode(), JsonLd(), serialiseJsonLd(), generateMetadata(), TeamPage()
...
## Knowledge Gaps
- **1418 isolated node(s):** `eslintConfig`, `RemotePatterns`, `TRUSTED_IMAGE_HOSTS`, `nextConfig`, `config` (+1413 more)
...
- **Why does `isPaymentError()` connect `Community 29` to `Community 1`, `Community 35`, `Community 36`, `Community 4`, `Community 38`, `Community 8`, `Community 20`, `Community 24`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 39` to `Community 1`, `Community 34`, `Community 33`, `Community 69`, `Community 41`, `Community 42`, `Community 44`, `Community 77`, `Community 45`, `Community 15`, `Community 18`, `Community 21`, `Community 54`, `Community 55`, `Community 56`, `Community 25`, `Community 91`, `Community 159`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `submitContact()` connect `Community 123` to `Community 10`, `Community 21`?**
