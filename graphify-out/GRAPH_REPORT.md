# Graph Report - company  (2026-09-10)

## Corpus Check
- 634 files · ~616,551 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3730 nodes · 7406 edges · 194 communities (186 shown, 8 thin omitted)
...
Cohesion: 0.07
Nodes (44): CraftConstellation(), CRAFT_DISCS, CraftDisc, covering, DarkNavZone(), DisciplineCluster(), Discipline, DISCIPLINES (+36 more)
...
Cohesion: 0.05
Nodes (45): Application, APPLICATION_SCOPES, ApplicationCredential, applicationCredentials, ApplicationDomain, applicationDomains, applications, ApplicationScope (+37 more)
...
Cohesion: 0.1
Nodes (39): paisa(), party(), serializeInvoiceDocument(), serializeReceiptDocument(), buildInvoiceDocument(), customerParty(), documentStatus(), documentIssues() (+31 more)
...
Cohesion: 0.16
Nodes (30): AboutPage(), generateMetadata(), BlogIndexPage(), generateMetadata(), CareersPage(), generateMetadata(), metadataFor(), getPage (+22 more)
...
Cohesion: 0.1
Nodes (35): documentFile(), safeFilename(), ConfirmOutcome, attach(), invoiceAttachment(), receiptAttachment(), safe(), documentPdf() (+27 more)
...
Cohesion: 0.06
Nodes (32): Account, accountClass, normalBalance, Product, productKind, products, FiscalPeriod, fiscalPeriods (+24 more)
...
Cohesion: 0.1
Nodes (26): EnrolmentHandoff(), PublicationPanel(), PublishConfirm(), PublishPending(), RotateTotpFormProps, SubmitButton(), TotpSetupProps, expiresIn() (+18 more)
...
Cohesion: 0.07
Nodes (20): AuditRecord, Receipt, ReceiptInput, refunds, audited, makeAttempt(), makeSession(), NOW (+12 more)

### Community 20 - "Community 20"
Cohesion: 0.1
Nodes (34): buildReceipt(), sendReceipt(), INPUT, receipt, everything, clearInvoice(), closeSession(), CompletedPayment (+26 more)
...
Cohesion: 0.08
Nodes (29): ApplicationPanel(), Breadcrumbs(), ContentTable(), DomainList(), KeyLegend(), KEYS, RegisterApplicationForm(), ApplicationsPage() (+21 more)
...
Cohesion: 0.09
Nodes (30): adminMode(), listPayments(), PAYMENT_STATUSES, PaymentFilter, PaymentRow, PaymentTotals, whereFor(), hasEverRun() (+22 more)

### Community 26 - "Community 26"
Cohesion: 0.2
Nodes (21): NUMERIC_FIELDS, DashboardActivity(), DashboardInvoices(), DashboardSnapshot, DashboardOperations(), DashboardOverview(), FILTERS, DashboardTabs() (+13 more)

### Community 27 - "Community 27"
Cohesion: 0.2
Nodes (23): NotFound(), sitemap(), isIndexableLegalDocument(), LegalReadiness, getLegalDocument, getPost, getProductPage, getService (+15 more)
...
Cohesion: 0.13
Nodes (23): confirmEnrolment(), metadata, enrolmentUrl(), qrSvg(), activateWithSecret(), createPendingAdmin(), deletePendingAdmin(), findEnrolmentSubject() (+15 more)
...
Cohesion: 0.12
Nodes (20): AdminNav(), NavItem, SECTIONS, AdminLayout(), setAdminMode(), AdminModeSwitch(), MODES, AdminSandboxNotice() (+12 more)
...
Cohesion: 0.11
Nodes (24): DocumentFormat, joinReference(), encodeRandom(), encodeTime(), newRequestId(), apiError(), apiJson(), secretExpiryHeaders() (+16 more)
...
Cohesion: 0.11
Nodes (24): accounts, PaymentProvider, paymentProviders, BlogPostSeed, blogPostSeeds, LegalDocumentSeed, legalDocumentSeeds, PageSeed (+16 more)
...
Cohesion: 0.11
Nodes (14): FilterLink(), Chip(), PostList(), PostSummary, cn(), PageContainer(), Skeleton(), SkeletonRows() (+6 more)

### Community 49 - "Community 49"
Cohesion: 0.13
Nodes (22): nextPollAt(), pollDelayMs(), pollExhausted(), giveUp(), LIVE, PollPendingResult, pollPendingTransactions(), reschedule() (+14 more)

### Community 50 - "Community 50"
Cohesion: 0.12
Nodes (18): listPublishedServices(), BuildTiers(), ClosingCta(), PlaceSection(), PrinciplesSection(), ProductsSection(), RecentPosts(), ServicesChapter() (+10 more)
...
Cohesion: 0.14
Nodes (11): CallbackPage(), metadata, CheckoutNotice(), CheckoutNoticeProps, Tone, confirmSessionPayment(), ReturnLink, returnLinkFor() (+3 more)
...
Cohesion: 0.14
Nodes (10): AdminRoster(), InviteAdminForm(), PendingAdminActions(), listAdmins(), RosterEntry, RotateTotpForm(), TotpSetup(), credentialsSchema (+2 more)
...
Cohesion: 0.17
Nodes (15): esewaConfig(), khaltiConfig(), MOCKABLE, MODES, paymentMode(), ProviderEnv, registerIfAbsent(), registerMocks() (+7 more)

### Community 85 - "Community 85"
Cohesion: 0.23
Nodes (12): ContactResult, schema, submitContact(), ContactNotification, notifyContact(), hashIp(), isRateLimited(), SendResult (+4 more)

### Community 86 - "Community 86"
Cohesion: 0.12
Nodes (10): transactions, ReconciliationItem, reconciliationItems, ReconciliationRun, reconciliationRuns, reconStatus, NOW, PERIOD_ENDS (+2 more)
...
Cohesion: 0.48
Nodes (6): CheckoutView, explainEmpty(), offerable(), summarise(), Summary, readPresentation()
...
Cohesion: 0.53
Nodes (4): CODES, LOGIN_FAILURE_MESSAGE, LoginFailureCode, LoginPage()
...
## Knowledge Gaps
- **1525 isolated node(s):** `eslintConfig`, `RemotePatterns`, `TRUSTED_IMAGE_HOSTS`, `nextConfig`, `config` (+1520 more)
...
- **Why does `isPaymentError()` connect `Community 49` to `Community 34`, `Community 35`, `Community 4`, `Community 68`, `Community 41`, `Community 137`, `Community 83`, `Community 20`, `Community 24`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 48` to `Community 1`, `Community 129`, `Community 38`, `Community 10`, `Community 44`, `Community 46`, `Community 47`, `Community 16`, `Community 55`, `Community 26`, `Community 63`, `Community 31`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `env` connect `Community 51` to `Community 32`, `Community 65`, `Community 98`, `Community 35`, `Community 6`, `Community 39`, `Community 74`, `Community 10`, `Community 12`, `Community 17`, `Community 83`, `Community 85`, `Community 121`?**
