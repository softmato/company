...
## Corpus Check
- 600 files · ~565,324 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3458 nodes · 6941 edges · 194 communities (182 shown, 12 thin omitted)
...
## Communities (194 total, 12 thin omitted)
...
Cohesion: 0.07
Nodes (46): confirmEnrolment(), EnrolPage(), metadata, openPendingSecret(), seal(), sealPendingSecret(), activateWithSecret(), findEnrolmentSubject() (+38 more)
...
Cohesion: 0.07
Nodes (31): ApplicationHeader(), ApplicationPanel(), Breadcrumbs(), ContentTable(), DomainList(), DomainRow, ReauthFields(), RegisterApplicationForm() (+23 more)
...
Cohesion: 0.08
Nodes (34): ClosingCta(), covering, DarkNavZone(), PLACE_COORDINATES, PLACE_PHOTO, PlaceSection(), PrinciplesSection(), CLOSING_HEADING (+26 more)
...
Cohesion: 0.12
Nodes (20): CraftConstellation(), CRAFT_DISCS, CraftDisc, BLOOM_LAYERS, EXIT_DX, HeroArc(), CRESCENT_LAYERS, HeroEye() (+12 more)
...
Cohesion: 0.19
Nodes (23): NUMERIC_FIELDS, DashboardSnapshot, FILTERS, formatBsNumeric(), cn(), Badge(), BadgeTone, STATUS_TONES (+15 more)

### Community 20 - "Community 20"
Cohesion: 0.1
Nodes (32): expireOne(), ExpireSessionsResult, expireStaleSessions(), OPEN, AuditRecorder, FormPost, isPastExpiry(), isSessionIdShape() (+24 more)
...
Cohesion: 0.08
Nodes (26): Account, accountClass, accounts, normalBalance, Product, productKind, entryDirection, journalEntries (+18 more)
...
Cohesion: 0.09
Nodes (25): FiscalPeriod, fiscalPeriods, periodStatus, BlogPostSeed, blogPostSeeds, LegalDocumentSeed, legalDocumentSeeds, PageSeed (+17 more)
...
Cohesion: 0.09
Nodes (18): AuditRecord, paymentSessions, audited, makePayable(), NOW, PERIOD_ENDS, PERIOD_STARTS, receipts (+10 more)
...
Cohesion: 0.14
Nodes (20): isPaymentError(), registerReal(), asJson(), eventIdFor(), ProviderEventInput, ProviderEventType, recordProviderEvent(), hasProvider() (+12 more)
...
Cohesion: 0.12
Nodes (18): authenticateApplication(), AuthenticatedApplication, bearerToken(), matchSecret(), unauthenticated(), FiledRefund, REFUNDABLE, requestRefund() (+10 more)
...
Cohesion: 0.24
Nodes (9): ConfirmOutcome, ensureProvidersRegistered(), MOCKABLE, registerIfAbsent(), registerMocks(), sendPaymentReceipt(), POST, beginPayment() (+1 more)
...
Cohesion: 0.18
Nodes (6): Receipt, ReceiptInput, NOW, PERIOD_ENDS, PERIOD_STARTS, settledPayment()
...
Cohesion: 0.25
Nodes (4): ContentForm(), KindCard(), PublicationPanel(), Field()
...
Cohesion: 0.25
Nodes (5): Chip(), PostList(), PostSummary, Skeleton(), SkeletonRows()
...
## Knowledge Gaps
- **1370 isolated node(s):** `eslintConfig`, `RemotePatterns`, `TRUSTED_IMAGE_HOSTS`, `nextConfig`, `config` (+1365 more)
...
- **Why does `isPaymentError()` connect `Community 46` to `Community 37`, `Community 106`, `Community 44`, `Community 77`, `Community 20`, `Community 23`, `Community 54`, `Community 87`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 19` to `Community 133`, `Community 134`, `Community 7`, `Community 6`, `Community 11`, `Community 141`, `Community 14`, `Community 142`, `Community 16`, `Community 150`, `Community 24`, `Community 158`, `Community 163`, `Community 36`, `Community 40`, `Community 42`, `Community 43`, `Community 105`, `Community 106`, `Community 112`, `Community 125`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `CheckoutView` connect `Community 106` to `Community 20`, `Community 77`, `Community 46`?**
