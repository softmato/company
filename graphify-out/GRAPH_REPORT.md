...
## Corpus Check
- 311 files · ~163,899 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1553 nodes · 2938 edges · 88 communities (82 shown, 6 thin omitted)
...
Cohesion: 0.06
Nodes (72): AboutPage(), generateMetadata(), NotFound(), sitemap(), BlogIndexPage(), generateMetadata(), CareersPage(), generateMetadata() (+64 more)
...
Cohesion: 0.16
Nodes (12): Button(), ButtonSize, ButtonVariant, SIZES, VARIANTS, ConfirmDialog(), Field(), borderFor() (+4 more)
...
Cohesion: 0.16
Nodes (9): ApplicationPanel(), RegisterApplicationForm(), DESCRIPTION, ScopeCheckboxes(), SubmitButton(), ApplicationSummary, listProductsWithApplications(), ProductWithApplications (+1 more)
...
Cohesion: 0.2
Nodes (8): listPublishedLegalDocuments(), SmoothScroll(), ContactDetails(), NAV_LINKS, SiteFooter(), LINKS, SiteHeader(), getSettings
...
Cohesion: 0.27
Nodes (10): ActivityEntry, recentActivity(), unbalancedJournalCount(), AdminDashboard(), unbalancedJournalCount(), Card(), CardBody(), CardHeader() (+2 more)
...
Cohesion: 0.2
Nodes (10): IssuedCredential, registerApplication(), RegisterInput, revokeApplication(), rotateSecret(), RotationResult, updateApplication(), Actor (+2 more)
...
Cohesion: 0.38
Nodes (4): Breadcrumbs(), ContentTable(), SettingsForm(), SettingsPage()
...
## Knowledge Gaps
- **590 isolated node(s):** `eslintConfig`, `Surface`, `SUBDOMAIN_SURFACE`, `SURFACE_PREFIX`, `config` (+585 more)
...
- **Why does `submitContact()` connect `Community 2` to `Community 11`, `Community 21`?**
  _High betweenness centrality (0.110) - this node is a cross-community bridge._
- **Why does `headers` connect `Community 11` to `Community 2`?**
  _High betweenness centrality (0.110) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 16` to `Community 0`, `Community 1`, `Community 32`, `Community 2`, `Community 38`, `Community 39`, `Community 40`, `Community 41`, `Community 19`, `Community 21`, `Community 59`?**
