...
## Corpus Check
- 620 files · ~604,585 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3666 nodes · 7234 edges · 195 communities (183 shown, 12 thin omitted)
...
Cohesion: 0.05
Nodes (52): AccountingError, allocateDocumentNo(), allocateSequence(), COLUMN, formatDocumentNo(), SequenceKind, TABLE, WIDTH (+44 more)
...
Cohesion: 0.09
Nodes (26): CRAFT_DISCS, CraftDisc, covering, DarkNavZone(), Discipline, DISCIPLINES, Satellite, BLOOM_LAYERS (+18 more)
...
Cohesion: 0.15
Nodes (23): AuditDetail(), changedKeys(), NUMERIC_FIELDS, DashboardSnapshot, FILTERS, formatBsNumeric(), Badge(), BadgeTone (+15 more)

### Community 15 - "Community 15"
Cohesion: 0.09
Nodes (36): buildReceipt(), Receipt, ReceiptInput, ReceiptSender, sendReceipt(), INPUT, receipt, everything (+28 more)

### Community 16 - "Community 16"
Cohesion: 0.1
Nodes (26): EnrolmentHandoff(), InviteAdminForm(), PublishConfirm(), PublishPending(), RotateTotpForm(), RotateTotpFormProps, SubmitButton(), TotpSetupProps (+18 more)

### Community 17 - "Community 17"
Cohesion: 0.09
Nodes (34): confirmSessionPayment(), expireOne(), ExpireSessionsResult, expireStaleSessions(), OPEN, isPaymentError(), FormPost, isPastExpiry() (+26 more)

### Community 18 - "Community 18"
Cohesion: 0.13
Nodes (36): requireAdmin(), DomainList(), DomainRow, addCredentialAction(), confirmIdentity(), confirmIfProduction(), confirmName(), readDomains() (+28 more)
...
Cohesion: 0.2
Nodes (24): AboutPage(), generateMetadata(), CareersPage(), generateMetadata(), metadataFor(), getPage, listPublishedProducts(), listPublishedServices() (+16 more)

### Community 23 - "Community 23"
Cohesion: 0.15
Nodes (24): NotFound(), BlogIndexPage(), generateMetadata(), getPost, getProductPage, getService, listPublishedPosts(), publishedSlugs() (+16 more)
...
Cohesion: 0.1
Nodes (25): FilterLink(), Chip(), PostList(), PostSummary, ClosingCta(), DisciplineCluster(), PLACE_COORDINATES, PLACE_PHOTO (+17 more)
...
Cohesion: 0.1
Nodes (21): BuildTiers(), CraftConstellation(), PrinciplesSection(), CLOSING_HEADING, PRINCIPLES_HEADING, PRODUCTS_HEADING, SERVICES_HEADING, STATEMENT (+13 more)
...
Cohesion: 0.16
Nodes (14): DocumentFormat, joinReference(), encodeRandom(), encodeTime(), newRequestId(), apiError(), apiJson(), secretExpiryHeaders() (+6 more)
...
Cohesion: 0.13
Nodes (10): audited, makeAttempt(), makeSession(), NOW, receipts, NOW, PERIOD_ENDS, PERIOD_STARTS (+2 more)
...
Cohesion: 0.14
Nodes (12): dmSans, inter, metadata, outfit, plexMono, logoDataUri(), OpengraphImage(), size (+4 more)
...
Cohesion: 0.19
Nodes (14): INVOICE_STATUSES, InvoiceFilter, InvoiceRow, InvoiceTotals, listInvoices(), numberingGaps(), whereFor(), formatNpr() (+6 more)
...
Cohesion: 0.16
Nodes (11): Account, accountClass, normalBalance, Product, productKind, products, vProductPl, vTrialBalance (+3 more)
...
Cohesion: 0.26
Nodes (11): availableProviders(), ensureProvidersRegistered(), esewaConfig(), khaltiConfig(), MOCKABLE, MODES, registerMocks(), registerReal() (+3 more)
...
Cohesion: 0.43
Nodes (6): sitemap(), isIndexableLegalDocument(), LegalReadiness, listPublishedLegalDocuments(), published(), publishedPageSlugs()
...
## Knowledge Gaps
- **1511 isolated node(s):** `eslintConfig`, `RemotePatterns`, `TRUSTED_IMAGE_HOSTS`, `nextConfig`, `config` (+1506 more)
...
- **Why does `isPaymentError()` connect `Community 17` to `Community 3`, `Community 101`, `Community 8`, `Community 15`, `Community 18`, `Community 53`, `Community 54`, `Community 56`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 26` to `Community 32`, `Community 129`, `Community 160`, `Community 131`, `Community 36`, `Community 37`, `Community 5`, `Community 161`, `Community 41`, `Community 43`, `Community 14`, `Community 16`, `Community 85`, `Community 22`, `Community 53`, `Community 25`, `Community 27`, `Community 92`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `submitContact()` connect `Community 103` to `Community 16`, `Community 33`?**
