...
## Summary
- 4677 nodes · 10366 edges · 223 communities (213 shown, 10 thin omitted)
...
Cohesion: 0.05
Nodes (46): CraftConstellation(), CRAFT_DISCS, CraftDisc, covering, DarkNavZone(), PREVIEW_HEADING, PREVIEW_POINTS, PLACE_COORDINATES (+38 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (42): callbackUrl(), decodeResponse(), EsewaConfig, EsewaProviderAdapter, HOSTS, missing(), STATUS, transactionUuidFor() (+34 more)
...
Cohesion: 0.09
Nodes (30): EnrolmentHandoff(), RotateTotpFormProps, SettingsForm(), SubmitButton(), TotpSetupProps, ActionForm(), ActionFormState, InviteDetails (+22 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (51): CLASSES, metadata, AccountLedger, BALANCE_SHEET, chartOfAccounts(), ChartRow, LedgerLine, receivablesAging() (+43 more)
...
Cohesion: 0.06
Nodes (37): ApplicationHeader(), ApplicationPanel(), DeleteApplicationForm(), FieldError(), KeyLegend(), KEYS, KIND_LABEL, NewProductDraft (+29 more)
...
Cohesion: 0.06
Nodes (44): products, Application, APPLICATION_SCOPES, ApplicationCredential, applicationCredentials, ApplicationDomain, applicationDomains, applications (+36 more)
...
Cohesion: 0.11
Nodes (35): DashboardActivity(), DashboardInvoices(), DASHBOARD_TABS, DashboardPaymentFilter, DashboardSnapshot, DashboardTab, filterDashboardPayments(), DashboardOperations() (+27 more)
...
Cohesion: 0.07
Nodes (32): WALLET_MARKS, DIRECT_LINE, OWN_PRODUCTS, PORTAL, SHIPPED, LAYERS, PaymentCardsArt(), TRUSTED_ART (+24 more)
...
Cohesion: 0.08
Nodes (33): INVOICE_STATUSES, InvoiceFilter, InvoiceRow, InvoiceTotals, listInvoices(), numberingGaps(), whereFor(), listPayments() (+25 more)

### Community 18 - "Community 18"
Cohesion: 0.11
Nodes (33): amountInWords(), numberInWords(), ONES, SCALES, TENS, underHundred(), underThousand(), InvoiceSheet() (+25 more)

### Community 19 - "Community 19"
Cohesion: 0.12
Nodes (17): BLOOM_LAYERS, EXIT_DX, HeroArc(), CRESCENT_LAYERS, HeroEye(), EXIT_DX, createLetterMelt(), HeroPixelArc() (+9 more)

### Community 20 - "Community 20"
Cohesion: 0.19
Nodes (26): AboutPage(), generateMetadata(), BlogIndexPage(), generateMetadata(), CareersPage(), generateMetadata(), metadataFor(), getPage (+18 more)
...
Cohesion: 0.06
Nodes (24): Chip(), PostList(), PostSummary, ICONS, ServiceCard, ServiceCards(), cn(), BorderBeam() (+16 more)
...
Cohesion: 0.08
Nodes (36): authorize(), decryptSecret(), deriveFromKey(), encryptSecret(), key(), checkTotp(), createTotpEnrolment(), enrolmentUri() (+28 more)
...
Cohesion: 0.08
Nodes (27): Account, accountClass, accounts, normalBalance, Product, productKind, entryDirection, journalEntries (+19 more)
...
Cohesion: 0.08
Nodes (21): invoices, paymentSessions, invoice(), audited, makeAttempt(), makeSession(), NOW, receipts (+13 more)
...
Cohesion: 0.12
Nodes (23): AdminRoster(), InviteAdminForm(), PendingAdminActions(), listAdmins(), RosterEntry, RotateTotpForm(), TotpSetup(), confirmEnrolment() (+15 more)

### Community 35 - "Community 35"
Cohesion: 0.13
Nodes (23): NUMERIC_FIELDS, AGING_BUCKETS, AgingBucket, AgingRow, AgingReport(), BalanceSheetReport(), ProductColumn, ProductPlReport() (+15 more)
...
Cohesion: 0.16
Nodes (27): documentFile(), safeFilename(), attach(), invoiceAttachment(), receiptAttachment(), safe(), documentPdf(), DocumentPdfResult (+19 more)
...
Cohesion: 0.09
Nodes (28): GET(), clientDocument(), detectDocument(), DetectedFile, OFFICE, PNG_METADATA, safeFileName(), startsWith() (+20 more)

### Community 41 - "Community 41"
Cohesion: 0.12
Nodes (20): extractHeadings(), Heading, headingId(), INTEGRATION_PATH, integrationDoc(), stripRepoLinks(), DevelopersPage(), metadata (+12 more)
...
Cohesion: 0.09
Nodes (19): DisciplineCluster(), Discipline, DISCIPLINES, Satellite, ART, ServiceArtPanel(), ServiceArt, serviceArtFor() (+11 more)

### Community 45 - "Community 45"
Cohesion: 0.12
Nodes (21): Breadcrumbs(), ContentTable(), NewClientForm(), metadata, saveSettings(), SettingsResult, SETTING_DEFINITIONS, SETTING_GROUPS (+13 more)

### Community 46 - "Community 46"
Cohesion: 0.15
Nodes (23): AccountsPage(), adminMode(), AccountLedgerPage(), metadata, isSource(), JournalsPage(), metadata, JOURNAL_SOURCES (+15 more)

### Community 47 - "Community 47"
Cohesion: 0.12
Nodes (23): confirmSessionPayment(), isPaymentError(), asJson(), eventIdFor(), ProviderEventInput, ProviderEventType, recordProviderEvent(), hasProvider() (+15 more)
...
Cohesion: 0.13
Nodes (20): DocumentFormat, joinReference(), encodeRandom(), encodeTime(), newRequestId(), apiError(), apiJson(), secretExpiryHeaders() (+12 more)
...
Cohesion: 0.11
Nodes (19): CashRow, listCash(), Offline, AdminCashPage(), CashCard(), metadata, BS_MONTHS, formatAdDateTime() (+11 more)
...
Cohesion: 0.14
Nodes (20): MessageState, postMessage(), reviewDeliverable(), ReviewState, signOut(), uploadDocument(), UploadState, metadata (+12 more)

### Community 57 - "Community 57"
Cohesion: 0.15
Nodes (21): ContactNotification, DetailRow, escapeHtml(), layout(), LayoutOptions, paragraph(), rowsTable(), SendResult (+13 more)

### Community 58 - "Community 58"
Cohesion: 0.12
Nodes (19): hasEverRun(), HeldPayment, heldPayments(), openRunItems(), RunItem, RecordRefundDialog(), listRefunds(), RefundRow (+11 more)
...
Cohesion: 0.25
Nodes (16): NotFound(), getLegalDocument, getPost, getProductPage, getService, publishedSlugs(), formatBsWithAd(), Markdown() (+8 more)

### Community 61 - "Community 61"
Cohesion: 0.11
Nodes (20): authenticateApplication(), AuthenticatedApplication, bearerToken(), matchSecret(), unauthenticated(), PAYMENT_ERROR_STATUS, PaymentErrorCode, PUBLIC_MESSAGE (+12 more)
...
Cohesion: 0.12
Nodes (19): DashboardInvoice, DashboardMethod, DashboardMonth, DashboardPayment, ActivityEntry, dashboardAttentionPayments(), dashboardMetrics(), dashboardOverdueInvoices() (+11 more)

### Community 71 - "Community 71"
Cohesion: 0.12
Nodes (12): FooterHorizon(), ElasticEngine, ElasticOptions, ElasticPhoto(), EMERALD_HORIZON_DEFAULTS, EmeraldHorizon(), Globe(), LightFormScene (+4 more)
...
Cohesion: 0.13
Nodes (16): CheckoutFlow(), CheckoutFlowProps, fmt(), PROVIDER_META, BUSY, FonepayQr(), FonepayQrProps, NOTES (+8 more)
...
Cohesion: 0.1
Nodes (16): AuditRecord, FiscalPeriod, fiscalPeriods, periodStatus, bsCalendar, BsMonthBoundary, FiscalPeriodSeed, audited (+8 more)
...
Cohesion: 0.16
Nodes (16): metadata, PortalInvoicesPage(), ART, PROJECT_ART, PROJECT_SCENES, SCENES, EmptyArt(), clientInvoices() (+8 more)
...
Cohesion: 0.19
Nodes (14): enrolmentUrl(), createPendingAdmin(), deletePendingAdmin(), findPendingAdmin(), PendingAdmin, pendingOnly(), reclaimPendingAdmin(), buildHandoff() (+6 more)
...
Cohesion: 0.17
Nodes (16): AdminClientPage(), AdminProject, ClientDetail, ClientPerson, ClientRow, byRelevance, ClientDocumentRow, clientProjects() (+8 more)
...
Cohesion: 0.15
Nodes (14): DeliverableReview(), clientProject(), metadata, PortalProjectPage(), StageView, DocumentList(), ComposerState, MessageComposer() (+6 more)

### Community 92 - "Community 92"
Cohesion: 0.16
Nodes (12): AdminNav(), NavItem, SECTIONS, AdminLayout(), setAdminMode(), AdminModeSwitch(), MODES, AdminSandboxNotice() (+4 more)

### Community 93 - "Community 93"
Cohesion: 0.16
Nodes (15): isDocumentKind(), InvoiceList(), ClientInvoice, clientOwnsInvoice(), clientOwnsReceipt(), ClientReceipt, OPEN_SESSION, RECEIPTED (+7 more)

### Community 94 - "Community 94"
Cohesion: 0.14
Nodes (16): listPublishedServices, BuildTiers(), ClosingCta(), Hero(), PlaceSection(), PrinciplesSection(), ProductsSection(), RecentPosts() (+8 more)
...
Cohesion: 0.22
Nodes (14): DEFAULT_MAILBOXES, EMAIL_CATEGORIES, NAME_SUFFIX, EmailIdentity, fromHeaderFor(), normaliseDomain(), replyToFor(), configuredDomain() (+6 more)

### Community 97 - "Community 97"
Cohesion: 0.15
Nodes (11): DeviceScreen(), TRUSTED_IMAGE_HOSTNAMES, CmsImage(), CmsImageFill(), CmsImageFillProps, CmsImageProps, optimizable(), loadRootEnv() (+3 more)
...
Cohesion: 0.23
Nodes (14): availableProviders(), availableFor(), ensureProvidersRegistered(), esewaConfig(), khaltiConfig(), MOCKABLE, MODES, registerIfAbsent() (+6 more)

### Community 105 - "Community 105"
Cohesion: 0.24
Nodes (10): ConfirmOutcome, EmailCategory, emailConfigured, resendClient(), Message, sendEmail(), EmailTemplate, deliverReceipt() (+2 more)
...
Cohesion: 0.26
Nodes (11): revokeApplication(), rotateSecret(), updateApplication(), CredentialResult, failure(), readScopes(), registerApplicationAction(), registerSchema (+3 more)
...
Cohesion: 0.32
Nodes (11): esewaConfig(), fonepayConfig(), khaltiConfig(), MOCKABLE, MODES, paymentMode(), registerFromEnv(), registerIfAbsent() (+3 more)
...
Cohesion: 0.29
Nodes (9): sitemap(), isIndexableLegalDocument(), LegalReadiness, listPublishedLegalDocuments(), published(), publishedPageSlugs(), JsonLd(), serialiseJsonLd() (+1 more)
...
Cohesion: 0.43
Nodes (6): confirmCashAction(), decide(), rejectCashAction(), recordRefundAction(), rupeesToPaisa(), reauthenticate()
...
Cohesion: 0.32
Nodes (6): metadata, PortalLoginPage(), AuthFrame(), WHAT_IS_INSIDE, currentViewer, SignInForm()

### Community 162 - "Community 162"
Cohesion: 0.54
Nodes (6): deleteDocumentObject(), putDocument(), privateBucket(), privateR2(), readPrivateObject(), writePrivateObject()
...
- **Why does `isPaymentError()` connect `Community 47` to `Community 132`, `Community 104`, `Community 43`, `Community 11`, `Community 49`, `Community 83`, `Community 61`, `Community 30`, `Community 159`?**
  _High betweenness centrality (0.109) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 22` to `Community 2`, `Community 5`, `Community 134`, `Community 6`, `Community 8`, `Community 12`, `Community 15`, `Community 17`, `Community 19`, `Community 20`, `Community 31`, `Community 35`, `Community 41`, `Community 169`, `Community 44`, `Community 46`, `Community 52`, `Community 53`, `Community 54`, `Community 55`, `Community 59`, `Community 71`, `Community 80`, `Community 90`, `Community 91`, `Community 92`, `Community 100`, `Community 122`?**
  _High betweenness centrality (0.080) - this node is a cross-community bridge._
- **Why does `recordAudit()` connect `Community 1` to `Community 65`, `Community 34`, `Community 132`, `Community 6`, `Community 104`, `Community 40`, `Community 105`, `Community 43`, `Community 108`, `Community 45`, `Community 111`, `Community 48`, `Community 82`, `Community 21`, `Community 117`, `Community 56`, `Community 26`, `Community 159`?**
