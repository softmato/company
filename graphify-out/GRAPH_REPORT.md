...
## Corpus Check
- 612 files · ~581,151 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3594 nodes · 7135 edges · 200 communities (190 shown, 10 thin omitted)
...
## Communities (200 total, 10 thin omitted)
...
Cohesion: 0.06
Nodes (43): AccountingError, assertBalanced(), JournalLineInput, PostedJournal, postJournal(), PostJournalInput, assertRevenueAccounts(), defaultRevenueAccount() (+35 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (46): TotpSetup(), confirmEnrolment(), EnrolPage(), metadata, openPendingSecret(), seal(), sealPendingSecret(), activateWithSecret() (+38 more)
...
Cohesion: 0.09
Nodes (37): buildReceipt(), Receipt, ReceiptInput, ReceiptSender, sendReceipt(), INPUT, receipt, everything (+29 more)
...
Cohesion: 0.17
Nodes (25): AboutPage(), generateMetadata(), NotFound(), CareersPage(), generateMetadata(), metadataFor(), getPage, listPublishedProducts() (+17 more)

### Community 13 - "Community 13"
Cohesion: 0.09
Nodes (24): PaymentError, EsewaConfig, FonepayConfig, callbackUrl(), HOSTS, isLookupAnswer(), KhaltiConfig, KhaltiProviderAdapter (+16 more)
...
Cohesion: 0.08
Nodes (30): ApplicationPanel(), Breadcrumbs(), ContentTable(), DomainList(), KeyLegend(), KEYS, RegisterApplicationForm(), ApplicationsPage() (+22 more)
...
Cohesion: 0.07
Nodes (29): allocateDocumentNo(), allocateSequence(), COLUMN, formatDocumentNo(), SequenceKind, TABLE, WIDTH, FiscalPeriod (+21 more)

### Community 18 - "Community 18"
Cohesion: 0.13
Nodes (22): EnrolmentHandoff(), InviteAdminForm(), PublishConfirm(), PublishPending(), RotateTotpForm(), RotateTotpFormProps, SubmitButton(), TotpSetupProps (+14 more)

### Community 19 - "Community 19"
Cohesion: 0.11
Nodes (23): extractHeadings(), Heading, getLegalDocument, listPublishedLegalDocuments(), INTEGRATION_PATH, integrationDoc(), stripRepoLinks(), DevelopersPage() (+15 more)

### Community 20 - "Community 20"
Cohesion: 0.11
Nodes (27): confirmSessionPayment(), expireOne(), ExpireSessionsResult, expireStaleSessions(), OPEN, isPaymentError(), PAYMENT_ERROR_STATUS, PaymentErrorCode (+19 more)
...
Cohesion: 0.2
Nodes (19): BlogIndexPage(), generateMetadata(), headingId(), getPost, getProductPage, getService, listPublishedPosts(), published() (+11 more)

### Community 30 - "Community 30"
Cohesion: 0.1
Nodes (21): PLACE_COORDINATES, PLACE_PHOTO, PlaceSection(), PrinciplesSection(), QUALITIES, Quality, QualityPile(), TONE_CLASS (+13 more)
...
Cohesion: 0.2
Nodes (24): requireAdmin(), DomainRow, addCredentialAction(), confirmIdentity(), confirmIfProduction(), confirmName(), readDomains(), readId() (+16 more)

### Community 33 - "Community 33"
Cohesion: 0.1
Nodes (18): FilterLink(), Chip(), PostList(), PostSummary, cn(), PageContainer(), Badge(), BadgeTone (+10 more)

### Community 34 - "Community 34"
Cohesion: 0.1
Nodes (15): AccountSeed, accountSeeds, audited, makeAttempt(), makeSession(), NOW, receipts, audited (+7 more)
...
Cohesion: 0.11
Nodes (19): BuildTiers(), DisciplineCluster(), CLOSING_HEADING, PRINCIPLES_HEADING, PRODUCTS_HEADING, SERVICES_HEADING, TIERS_HEADING, ServiceStep() (+11 more)
...
Cohesion: 0.13
Nodes (24): BOUNDS, clamped, frame, image, images, min, offset, scale (+16 more)
...
Cohesion: 0.14
Nodes (21): registerIfAbsent(), asJson(), eventIdFor(), ProviderEventInput, ProviderEventType, recordProviderEvent(), hasProvider(), providerAdapter() (+13 more)

### Community 41 - "Community 41"
Cohesion: 0.14
Nodes (16): ApplicationHeader(), ReauthFields(), DESCRIPTION, ScopeCheckboxes(), revokeApplication(), rotateSecret(), updateApplication(), ApplicationSummary (+8 more)

### Community 42 - "Community 42"
Cohesion: 0.16
Nodes (18): enrolmentUrl(), qrSvg(), createPendingAdmin(), deletePendingAdmin(), findPendingAdmin(), PendingAdmin, pendingOnly(), reclaimPendingAdmin() (+10 more)
...
Cohesion: 0.14
Nodes (17): AdminGuard, requireAdminApi(), DetectedImage, extensionForMime(), ImageMime, isImageMime(), Signature, SIGNATURES (+9 more)
...
Cohesion: 0.1
Nodes (19): Account, accountClass, accounts, normalBalance, Product, productKind, transactions, PaymentProvider (+11 more)
...
Cohesion: 0.15
Nodes (14): listPublishedTeam(), DeviceScreen(), ProductsSection(), RecentPosts(), StaggerIn(), StaggerTag, CmsImage(), CmsImageFill() (+6 more)
...
Cohesion: 0.13
Nodes (11): AdminRoster(), PendingAdminActions(), listAdmins(), RosterEntry, findTotpSecret(), credentialsSchema, CODES, LOGIN_FAILURE_MESSAGE (+3 more)

### Community 60 - "Community 60"
Cohesion: 0.2
Nodes (9): DashboardSnapshot, KindCard(), Card(), CardBody(), CardHeader(), CardTitle(), Skeleton(), SkeletonRows() (+1 more)

### Community 61 - "Community 61"
Cohesion: 0.25
Nodes (12): auditActions(), AuditRow, listAuditEntries(), NUMERIC_FIELDS, AuditLogPage(), formatBsNumeric(), BsDate(), EmptyState() (+4 more)
...
Cohesion: 0.19
Nodes (13): listPayments(), PAYMENT_STATUSES, PaymentFilter, PaymentRow, PaymentTotals, whereFor(), formatNpr(), formatPaisa() (+5 more)
...
Cohesion: 0.2
Nodes (12): ConfirmOutcome, ensureProvidersRegistered(), esewaConfig(), khaltiConfig(), MOCKABLE, MODES, registerMocks(), registerReal() (+4 more)
...
Cohesion: 0.19
Nodes (10): AdminNav(), NavItem, SECTIONS, AdminLayout(), setAdminMode(), adminMode(), AdminModeSwitch(), MODES (+2 more)
...
Cohesion: 0.26
Nodes (7): ClosingCta(), covering, DarkNavZone(), BlurIn(), TextTag, DrawIn(), registerMotionPlugins()
...
Cohesion: 0.45
Nodes (9): POST(), detectImage(), parseCmsImageKey(), publicBucket(), publicUrl(), r2(), deleteCmsObject(), headCmsObject() (+1 more)
...
Cohesion: 0.39
Nodes (7): uploadCmsImage(), UploadResult, cmsObjectKey(), validateImage(), validationMessage(), putCmsObject(), r2()
...
## Knowledge Gaps
- **1468 isolated node(s):** `eslintConfig`, `RemotePatterns`, `TRUSTED_IMAGE_HOSTS`, `nextConfig`, `config` (+1463 more)
...
- **Why does `cn()` connect `Community 33` to `Community 96`, `Community 36`, `Community 37`, `Community 38`, `Community 102`, `Community 39`, `Community 12`, `Community 48`, `Community 18`, `Community 83`, `Community 19`, `Community 22`, `Community 54`, `Community 90`, `Community 60`, `Community 61`, `Community 30`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `isPaymentError()` connect `Community 20` to `Community 32`, `Community 40`, `Community 104`, `Community 10`, `Community 43`, `Community 41`, `Community 48`, `Community 86`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `submitContact()` connect `Community 132` to `Community 17`, `Community 18`?**
