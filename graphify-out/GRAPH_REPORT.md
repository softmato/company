...
## Corpus Check
- 591 files · ~548,782 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3360 nodes · 6710 edges · 191 communities (182 shown, 9 thin omitted)
...
- `beginPayment()` --calls--> `isProviderId()`  [INFERRED]
  apps/web/app/(checkout)/checkout/[sessionId]/actions.ts → packages/payment-core/providers/types.ts
...
Cohesion: 0.09
Nodes (46): publishContent(), unpublishContent(), saveContent(), ActionResult, databaseMessage(), parseId(), requireAdmin(), requireKind() (+38 more)
...
Cohesion: 0.09
Nodes (40): dmSans, inter, metadata, outfit, plexMono, logoDataUri(), OpengraphImage(), size (+32 more)
...
Cohesion: 0.07
Nodes (29): ApplicationPanel(), Breadcrumbs(), ContentForm(), ContentTable(), PublicationPanel(), ReauthFields(), RegisterApplicationForm(), DESCRIPTION (+21 more)

### Community 8 - "Community 8"
Cohesion: 0.08
Nodes (39): confirmSessionPayment(), nextPollAt(), pollDelayMs(), pollExhausted(), giveUp(), LIVE, PollPendingResult, pollPendingTransactions() (+31 more)
...
Cohesion: 0.18
Nodes (26): AboutPage(), generateMetadata(), CareersPage(), generateMetadata(), metadataFor(), getPage, listPublishedProducts(), listPublishedServices() (+18 more)
...
Cohesion: 0.07
Nodes (34): Application, APPLICATION_SCOPES, ApplicationDomain, applicationDomains, applications, ApplicationScope, Customer, customers (+26 more)
...
Cohesion: 0.11
Nodes (25): extractHeadings(), Heading, headingId(), getLegalDocument, listPublishedLegalDocuments(), INTEGRATION_PATH, integrationDoc(), stripRepoLinks() (+17 more)
...
Cohesion: 0.13
Nodes (22): EnrolmentHandoff(), InviteAdminForm(), PublishConfirm(), PublishPending(), RotateTotpForm(), RotateTotpFormProps, SubmitButton(), expiresIn() (+14 more)
...
Cohesion: 0.13
Nodes (22): AdminRoster(), PendingAdminActions(), listAdmins(), RosterEntry, TotpSetup(), TotpSetupProps, confirmEnrolment(), EnrolPage() (+14 more)

### Community 24 - "Community 24"
Cohesion: 0.11
Nodes (24): amountInWords(), numberInWords(), ONES, SCALES, TENS, underHundred(), underThousand(), InvoiceSheet() (+16 more)
...
Cohesion: 0.19
Nodes (19): NotFound(), getPost, getProductPage, getService, published(), publishedSlugs(), DeviceScreen(), CmsImage() (+11 more)

### Community 29 - "Community 29"
Cohesion: 0.09
Nodes (17): AuditRecord, Receipt, ReceiptInput, audited, makeAttempt(), makeSession(), NOW, receipts (+9 more)
...
Cohesion: 0.19
Nodes (18): DashboardActivity(), DashboardInvoices(), DASHBOARD_TABS, DashboardMonth, DashboardPaymentFilter, DashboardSnapshot, DashboardTab, filterDashboardPayments() (+10 more)
...
Cohesion: 0.19
Nodes (12): ClosingCta(), covering, DarkNavZone(), CLOSING_HEADING, TextTag, prefersReducedMotion(), registerMotionPlugins(), StaggerIn() (+4 more)

### Community 36 - "Community 36"
Cohesion: 0.19
Nodes (18): auditActions(), AuditRow, listAuditEntries(), NUMERIC_FIELDS, AuditLogPage(), FilterLink(), Chip(), PostList() (+10 more)
...
Cohesion: 0.12
Nodes (17): expireOne(), ExpireSessionsResult, expireStaleSessions(), OPEN, PAYMENT_ERROR_STATUS, PaymentError, PaymentErrorCode, PUBLIC_MESSAGE (+9 more)

### Community 40 - "Community 40"
Cohesion: 0.16
Nodes (17): SettingsForm(), SettingsResult, SETTING_DEFINITIONS, SETTING_GROUPS, SETTING_KEYS, SettingDefinition, SettingKind, SettingsPage() (+9 more)
...
Cohesion: 0.14
Nodes (20): FormPost, isPastExpiry(), expireIfDue(), loadPayableSession(), loadSession(), assertOffered(), selectProvider(), isPayable() (+12 more)
...
Cohesion: 0.14
Nodes (17): CallbackPage(), metadata, CheckoutNotice(), CheckoutNoticeProps, Tone, OrderSummary(), ReturnLink, returnLinkFor() (+9 more)
...
Cohesion: 0.1
Nodes (16): FiscalPeriod, fiscalPeriods, periodStatus, bsCalendar, BsMonthBoundary, FiscalPeriodSeed, audited, entry (+8 more)
...
Cohesion: 0.13
Nodes (12): registerReal(), callbackBase(), MockProviderAdapter, hasProvider(), providerAdapter(), registerProvider(), REGISTRY, resetProviderRegistry() (+4 more)
...
Cohesion: 0.14
Nodes (15): PLACE_COORDINATES, PLACE_PHOTO, PlaceSection(), SERVICES_HEADING, ServiceStep(), ServicesChapter(), ServiceStepData, MarkArrow() (+7 more)
...
Cohesion: 0.16
Nodes (16): assertRegisteredHost(), isRegisteredHost(), addDomain(), AddDomainInput, removeDomain(), normalizeHostname(), normalizeHostnameInput(), DomainInput (+8 more)
...
Cohesion: 0.18
Nodes (15): DashboardInvoice, DashboardMethod, ActivityEntry, dashboardAttentionPayments(), dashboardMetrics(), dashboardOverdueInvoices(), dashboardPaymentMethods(), dashboardPayments() (+7 more)
...
Cohesion: 0.16
Nodes (12): PrinciplesSection(), PRINCIPLES_HEADING, PRODUCTS_HEADING, STATEMENT, TIERS_HEADING, Statement(), CRAFT_STATEMENT, Principle (+4 more)

### Community 72 - "Community 72"
Cohesion: 0.22
Nodes (13): enrolmentUrl(), createPendingAdmin(), findPendingAdmin(), pendingOnly(), reclaimPendingAdmin(), buildHandoff(), Handoff, inviteAdmin() (+5 more)

### Community 73 - "Community 73"
Cohesion: 0.18
Nodes (15): buildReceipt(), sendReceipt(), clearInvoice(), closeSession(), CompletedPayment, completePayment(), flagForReconciliation(), journalNoOf() (+7 more)
...
Cohesion: 0.14
Nodes (6): PageContainer(), Skeleton(), SkeletonRows(), Tabs(), Toast, ToastContext
...
Cohesion: 0.17
Nodes (13): mutatingEndpoint(), paisa(), serializeInvoice(), serializeSession(), serializeTransaction(), POST, schema, prerenderInvoicePdf() (+5 more)
...
Cohesion: 0.22
Nodes (11): AdminGuard, requireAdminApi(), extensionForMime(), isImageMime(), CMS_IMAGE_KEY, cmsImageKey(), parseCmsImageKey(), slugify() (+3 more)

### Community 88 - "Community 88"
Cohesion: 0.13
Nodes (7): callbackUrl(), isLookupAnswer(), KhaltiProviderAdapter, parseJson(), websiteUrl(), cases, txn
...
Cohesion: 0.18
Nodes (9): CraftConstellation(), CRAFT_DISCS, CraftDisc, DisciplineCluster(), Discipline, DISCIPLINES, Satellite, Drift() (+1 more)
...
Cohesion: 0.44
Nodes (9): POST(), detectImage(), publicBucket(), publicUrl(), r2(), deleteCmsObject(), headCmsObject(), readCmsObjectPrefix() (+1 more)
...
Cohesion: 0.36
Nodes (6): OrderSummaryProps, PlanDetails(), plainText(), Presentation, PresentationInput, sellingPoint()
...
Cohesion: 0.48
Nodes (4): BlogIndexPage(), generateMetadata(), listPublishedPosts(), BS_MONTHS
...
## Knowledge Gaps
- **1330 isolated node(s):** `eslintConfig`, `RemotePatterns`, `TRUSTED_IMAGE_HOSTS`, `nextConfig`, `config` (+1325 more)
...
- **Why does `cn()` connect `Community 36` to `Community 33`, `Community 34`, `Community 35`, `Community 132`, `Community 133`, `Community 37`, `Community 99`, `Community 40`, `Community 71`, `Community 10`, `Community 76`, `Community 45`, `Community 80`, `Community 18`, `Community 148`, `Community 21`, `Community 55`, `Community 31`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `isPaymentError()` connect `Community 8` to `Community 3`, `Community 39`, `Community 42`, `Community 45`, `Community 86`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `headers` connect `Community 119` to `Community 15`?**
