...
## Corpus Check
- 601 files · ~567,540 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3469 nodes · 6952 edges · 202 communities (195 shown, 7 thin omitted)
...
Cohesion: 0.06
Nodes (44): BuildTiers(), ClosingCta(), DeviceScreen(), PLACE_COORDINATES, PLACE_PHOTO, PlaceSection(), PrinciplesSection(), ProductsSection() (+36 more)
...
Cohesion: 0.06
Nodes (35): ApplicationHeader(), ApplicationPanel(), Breadcrumbs(), ContentTable(), DomainList(), DomainRow, ReauthFields(), RegisterApplicationForm() (+27 more)
...
Cohesion: 0.07
Nodes (45): confirmEnrolment(), EnrolPage(), metadata, openPendingSecret(), seal(), sealPendingSecret(), activateWithSecret(), findEnrolmentSubject() (+37 more)

### Community 6 - "Community 6"
Cohesion: 0.09
Nodes (35): publishContent(), unpublishContent(), saveContent(), ActionResult, databaseMessage(), parseId(), requireKind(), getContent() (+27 more)
...
Cohesion: 0.11
Nodes (35): dmSans, inter, metadata, outfit, plexMono, robots(), siteUrl(), absoluteImage() (+27 more)

### Community 12 - "Community 12"
Cohesion: 0.09
Nodes (27): InviteAdminForm(), PublishConfirm(), PublishPending(), RotateTotpForm(), RotateTotpFormProps, TotpSetup(), TotpSetupProps, CODES (+19 more)
...
Cohesion: 0.12
Nodes (32): buildInvoiceDocument(), customerParty(), documentStatus(), documentIssues(), SheetWarning(), findInvoice(), findPayment(), InvoiceLineRecord (+24 more)
...
Cohesion: 0.1
Nodes (31): expireOne(), ExpireSessionsResult, expireStaleSessions(), OPEN, FormPost, isPastExpiry(), expireIfDue(), loadPayableSession() (+23 more)
...
Cohesion: 0.17
Nodes (24): documentFile(), safeFilename(), attach(), invoiceAttachment(), receiptAttachment(), safe(), documentPdf(), DocumentPdfResult (+16 more)

### Community 32 - "Community 32"
Cohesion: 0.09
Nodes (20): FiscalPeriod, fiscalPeriods, periodStatus, entryDirection, journalEntries, JournalEntry, journalSource, ledgerEntries (+12 more)
...
Cohesion: 0.25
Nodes (23): requireAdmin(), addCredentialAction(), confirmIdentity(), confirmIfProduction(), confirmName(), readDomains(), readId(), readScopes() (+15 more)
...
Cohesion: 0.16
Nodes (18): ensureProvidersRegistered(), MOCKABLE, registerIfAbsent(), registerMocks(), registerReal(), hasProvider(), providerAdapter(), registeredProviders() (+10 more)
...
Cohesion: 0.1
Nodes (14): Application, APPLICATION_SCOPES, ApplicationCredential, applicationCredentials, ApplicationDomain, applicationDomains, applications, ApplicationScope (+6 more)

### Community 48 - "Community 48"
Cohesion: 0.14
Nodes (11): Chip(), PostList(), PostSummary, cn(), Drift(), PillPile(), PageContainer(), Money() (+3 more)

### Community 49 - "Community 49"
Cohesion: 0.12
Nodes (13): ContentForm(), KindCard(), PublicationPanel(), StatusBadge(), Tone, TONE_BY_STATUS, TONES, Field() (+5 more)

### Community 50 - "Community 50"
Cohesion: 0.14
Nodes (15): CallbackPage(), metadata, CheckoutNotice(), CheckoutNoticeProps, Tone, confirmSessionPayment(), ReturnLink, returnLinkFor() (+7 more)
...
Cohesion: 0.14
Nodes (15): products, Customer, customers, Invoice, InvoiceLine, invoiceLines, invoices, invoiceStatus (+7 more)
...
Cohesion: 0.14
Nodes (17): CUSTOMER, DUE, ISSUED, SAMPLE_INVOICE, SAMPLE_INVOICE_PART_PAID, SAMPLE_INVOICE_VOID, SAMPLE_RECEIPT, SAMPLE_RECEIPT_PARTIAL (+9 more)

### Community 66 - "Community 66"
Cohesion: 0.16
Nodes (14): DashboardActivity(), DashboardInvoices(), DASHBOARD_TABS, DashboardPayment, DashboardPaymentFilter, DashboardTab, filterDashboardPayments(), DashboardOperations() (+6 more)

### Community 67 - "Community 67"
Cohesion: 0.31
Nodes (10): NUMERIC_FIELDS, DashboardSnapshot, FILTERS, formatBsNumeric(), BsDate(), EmptyState(), DataTable(), Td() (+2 more)
...
Cohesion: 0.17
Nodes (10): AccountingError, PostJournalInput, InvoiceIssuedInput, invoiceIssuedJournal(), InvoiceLineForPosting, PaymentReceivedInput, paymentReceivedJournal(), BASE (+2 more)
...
Cohesion: 0.14
Nodes (8): Receipt, ReceiptInput, INPUT, receipt, NOW, PERIOD_ENDS, PERIOD_STARTS, settledPayment()

### Community 83 - "Community 83"
Cohesion: 0.25
Nodes (9): AdminRoster(), PendingAdminActions(), listAdmins(), RosterEntry, enrolmentUrl(), qrSvg(), findTotpSecret(), buildHandoff() (+1 more)

### Community 84 - "Community 84"
Cohesion: 0.19
Nodes (11): ServicesChapter(), ServicesSection(), BlurIn(), FormGround, FormKind, LightForm(), LightFormScene, useNearViewport() (+3 more)
...
Cohesion: 0.2
Nodes (13): allocateDocumentNo(), allocateSequence(), COLUMN, formatDocumentNo(), SequenceKind, TABLE, WIDTH, assertBalanced() (+5 more)
...
Cohesion: 0.23
Nodes (9): EnrolmentHandoff(), ReceiptSheet(), BS_MONTHS, expiresIn(), formatAdDateTime(), Handoff, formatted, moment (+1 more)
...
Cohesion: 0.21
Nodes (8): CraftConstellation(), CRAFT_DISCS, CraftDisc, DisciplineCluster(), Discipline, DISCIPLINES, Satellite, Parallax()

### Community 101 - "Community 101"
Cohesion: 0.24
Nodes (9): InvoiceSheet(), DocumentDate(), PartyBlock(), STATUS_LABEL, StatusBadge(), vatNote(), DocumentStatus, formatAd() (+1 more)
...
Cohesion: 0.31
Nodes (7): ContactNotification, emailConfigured, resendClient(), Message, SendResult, env, ContactEnquiry
...
Cohesion: 0.31
Nodes (6): formatNpr(), formatPaisa(), groupLakhCrore(), metadata, MOCK_SUBSCRIPTIONS, SubscriptionRecord
...
Cohesion: 0.27
Nodes (5): audited, makeAttempt(), makeSession(), NOW, receipts

### Community 129 - "Community 129"
Cohesion: 0.33
Nodes (9): buildReceipt(), sendReceipt(), clearInvoice(), closeSession(), CompletedPayment, completePayment(), flagForReconciliation(), journalNoOf() (+1 more)
...
Cohesion: 0.36
Nodes (7): amountInWords(), numberInWords(), ONES, SCALES, TENS, underHundred(), underThousand()
...
Cohesion: 0.29
Nodes (5): adapter, mockAdapter, mockSession, mockTxn, txn
...
Cohesion: 0.73
Nodes (4): privateBucket(), privateR2(), readPrivateObject(), writePrivateObject()
...
## Knowledge Gaps
- **1377 isolated node(s):** `eslintConfig`, `RemotePatterns`, `TRUSTED_IMAGE_HOSTS`, `nextConfig`, `config` (+1372 more)
...
- **Why does `isPaymentError()` connect `Community 13` to `Community 4`, `Community 37`, `Community 38`, `Community 43`, `Community 18`, `Community 50`, `Community 22`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 48` to `Community 1`, `Community 9`, `Community 12`, `Community 141`, `Community 16`, `Community 25`, `Community 26`, `Community 28`, `Community 34`, `Community 35`, `Community 36`, `Community 49`, `Community 66`, `Community 67`, `Community 74`, `Community 78`, `Community 84`, `Community 100`, `Community 111`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `submitContact()` connect `Community 124` to `Community 12`?**
