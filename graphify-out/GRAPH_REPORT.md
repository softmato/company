...
## Corpus Check
- 589 files · ~542,797 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3332 nodes · 6681 edges · 191 communities (181 shown, 10 thin omitted)
...
3. `PaymentError` - 39 edges
4. `[Phase 1] — 2026-08-14` - 39 edges
5. `recordAudit()` - 35 edges
...
Cohesion: 0.05
Nodes (50): AccountingError, allocateDocumentNo(), allocateSequence(), COLUMN, formatDocumentNo(), SequenceKind, TABLE, WIDTH (+42 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (39): call(), endpoint(), loaded, msg, [name, urlPath = '/', scrollArg = '0', width = '1440', height = '900'], pending, PORT, send() (+31 more)
...
Cohesion: 0.07
Nodes (37): callbackUrl(), decodeResponse(), EsewaConfig, EsewaProviderAdapter, HOSTS, missing(), STATUS, transactionUuidFor() (+29 more)
...
Cohesion: 0.1
Nodes (27): EnrolmentHandoff(), InviteAdminForm(), PublicationPanel(), PublishConfirm(), PublishPending(), RotateTotpFormProps, SubmitButton(), TotpSetup() (+19 more)
...
Cohesion: 0.09
Nodes (36): buildReceipt(), Receipt, ReceiptInput, ReceiptSender, INPUT, receipt, everything, clearInvoice() (+28 more)
...
Cohesion: 0.06
Nodes (43): 1. Conventions, 2. Authentication, 3. Endpoints, 4. Outbound webhooks, 5.1 `manual_qr`, 5.1 `manual_qr` — **removed 2026-08-16**, 5.2 Khalti (KPG v2), 5.3 eSewa (+35 more)

### Community 11 - "Community 11"
Cohesion: 0.08
Nodes (29): ApplicationPanel(), ReauthFields(), RegisterApplicationForm(), DESCRIPTION, ScopeCheckboxes(), revokeApplication(), rotateSecret(), updateApplication() (+21 more)

### Community 12 - "Community 12"
Cohesion: 0.16
Nodes (27): NotFound(), sitemap(), getLegalDocument, getPost, getProductPage, getService, listPublishedLegalDocuments(), published() (+19 more)
...
Cohesion: 0.07
Nodes (28): Account, accountClass, accounts, normalBalance, Product, productKind, entryDirection, journalEntries (+20 more)
...
Cohesion: 0.07
Nodes (33): products, Application, APPLICATION_SCOPES, ApplicationDomain, applicationDomains, applications, ApplicationScope, Customer (+25 more)

### Community 18 - "Community 18"
Cohesion: 0.1
Nodes (30): ConfirmOutcome, confirmSessionPayment(), isPaymentError(), availableProviders(), ensureProvidersRegistered(), MOCKABLE, registerIfAbsent(), registerMocks() (+22 more)

### Community 19 - "Community 19"
Cohesion: 0.1
Nodes (30): expireOne(), ExpireSessionsResult, expireStaleSessions(), OPEN, FormPost, isPastExpiry(), expireIfDue(), loadPayableSession() (+22 more)
...
Cohesion: 0.09
Nodes (30): paisa(), party(), serializeInvoiceDocument(), serializeReceiptDocument(), CUSTOMER, DUE, ISSUED, SAMPLE_INVOICE (+22 more)
...
Cohesion: 0.11
Nodes (22): SettingsForm(), TRUSTED_IMAGE_HOSTNAMES, saveSettings(), SettingsResult, SETTING_DEFINITIONS, SETTING_GROUPS, SETTING_KEYS, SettingDefinition (+14 more)

### Community 28 - "Community 28"
Cohesion: 0.08
Nodes (16): AiProvider, GeminiAiProvider, GroqAiProvider, OpenAiProvider, OpenRouterAiProvider, ResilientAiProvider, AiProviderChatParams, AiProviderResponse (+8 more)

### Community 29 - "Community 29"
Cohesion: 0.11
Nodes (19): EsewaConfig, FonepayConfig, callbackUrl(), HOSTS, isLookupAnswer(), KhaltiConfig, KhaltiProviderAdapter, parseJson() (+11 more)
...
Cohesion: 0.15
Nodes (25): buildInvoiceDocument(), customerParty(), documentStatus(), documentIssues(), SheetWarning(), findInvoice(), findPayment(), InvoiceLineRecord (+17 more)

### Community 32 - "Community 32"
Cohesion: 0.15
Nodes (19): AdminRoster(), PendingAdminActions(), listAdmins(), RosterEntry, RotateTotpForm(), confirmEnrolment(), metadata, openPendingSecret() (+11 more)
...
Cohesion: 0.18
Nodes (26): isIndexableLegalDocument(), LegalReadiness, absoluteImage(), blogPostingNode(), collectionPageNode(), contactPageNode(), iso(), legalPageNode() (+18 more)
...
Cohesion: 0.18
Nodes (20): documentFile(), safeFilename(), attach(), invoiceAttachment(), receiptAttachment(), safe(), documentPdf(), DocumentPdfResult (+12 more)

### Community 41 - "Community 41"
Cohesion: 0.16
Nodes (18): amountInWords(), numberInWords(), ONES, SCALES, TENS, underHundred(), underThousand(), InvoiceSheet() (+10 more)
...
Cohesion: 0.13
Nodes (19): DashboardActivity(), DashboardInvoices(), DASHBOARD_TABS, DashboardInvoice, DashboardMethod, DashboardMonth, DashboardPayment, DashboardPaymentFilter (+11 more)

### Community 46 - "Community 46"
Cohesion: 0.23
Nodes (14): NUMERIC_FIELDS, Chip(), PostList(), PostSummary, formatBsNumeric(), cn(), BsDate(), EmptyState() (+6 more)
...
Cohesion: 0.16
Nodes (18): allowBooking(), allowTurn(), bookings, callerAddress(), hashAddress(), record(), turns, atNptMidday() (+10 more)

### Community 50 - "Community 50"
Cohesion: 0.16
Nodes (17): assertRegisteredHost(), isRegisteredHost(), addDomain(), AddDomainInput, removeDomain(), normalizeHostname(), normalizeHostnameInput(), DomainInput (+9 more)

### Community 51 - "Community 51"
Cohesion: 0.09
Nodes (22): Blocked on external parties, Blocked on the founder, code:bash (pnpm install && pnpm dev      # localhost:3000, admin.localh), code:markdown (### Session N — YYYY-MM-DD), Current status, Decisions made, Deviations from the docs, Memory (+14 more)

### Community 52 - "Community 52"
Cohesion: 0.18
Nodes (16): DomainList(), DomainRow, confirmIdentity(), readDomains(), readScopes(), registerApplicationAction(), registerSchema, revealWebhookSecretAction() (+8 more)
...
Cohesion: 0.14
Nodes (14): ClosingCta(), covering, DarkNavZone(), CLOSING_HEADING, PRINCIPLES_HEADING, SERVICES_HEADING, ServiceStep(), ServiceStepData (+6 more)
...
Cohesion: 0.11
Nodes (16): AuditRecord, paymentSessions, generateSessionId(), isSessionIdShape(), seen, suffix, makeSession(), audited (+8 more)
...
Cohesion: 0.15
Nodes (10): Breadcrumbs(), ContentForm(), ContentTable(), KindCard(), ApplicationsPage(), listApplications(), isContentKind(), Field() (+2 more)
...
Cohesion: 0.17
Nodes (12): DocumentFormat, joinReference(), encodeRandom(), encodeTime(), newRequestId(), apiError(), apiJson(), toPaymentError() (+4 more)

### Community 62 - "Community 62"
Cohesion: 0.14
Nodes (10): SmoothScroll(), ChatMessageUI, ChatWidget(), DEFAULT_WELCOME_MESSAGE, QUICK_ACTIONS, NAV_LINKS, SiteFooter(), LINKS (+2 more)
...
Cohesion: 0.11
Nodes (12): audited, makePayable(), NOW, PERIOD_ENDS, PERIOD_STARTS, receipts, verified(), adapter (+4 more)
...
Cohesion: 0.13
Nodes (11): FiscalPeriod, fiscalPeriods, periodStatus, bsCalendar, BsMonthBoundary, FiscalPeriodSeed, audited, makeAttempt() (+3 more)
...
Cohesion: 0.23
Nodes (8): ToneSegment, ToneSentence, BlurIn(), TextTag, prefersReducedMotion(), registerMotionPlugins(), TextTag, TextTag

### Community 78 - "Community 78"
Cohesion: 0.18
Nodes (12): AdminGuard, requireAdminApi(), DetectedImage, extensionForMime(), isImageMime(), Signature, SIGNATURES, ValidationFailure (+4 more)
...
Cohesion: 0.28
Nodes (7): Card(), CardBody(), CardHeader(), CardTitle(), Skeleton(), SkeletonRows(), StatTile()
...
Cohesion: 0.18
Nodes (10): DisciplineCluster(), Discipline, DISCIPLINES, Satellite, ProductsSection(), RecentPosts(), PRODUCTS_HEADING, Parallax() (+2 more)

### Community 83 - "Community 83"
Cohesion: 0.2
Nodes (7): OrderSummary(), OrderSummaryProps, metadata, PlanDetails(), Presentation, Wordmark(), metadata
...
Cohesion: 0.19
Nodes (9): CraftConstellation(), CRAFT_DISCS, CraftDisc, STATEMENT, Statement(), CRAFT_STATEMENT, Principle, PRINCIPLES (+1 more)

### Community 92 - "Community 92"
Cohesion: 0.21
Nodes (10): ServicesChapter(), ServicesSection(), FormGround, FormKind, LightForm(), LightFormScene, useNearViewport(), noopSubscribe() (+2 more)
...
Cohesion: 0.23
Nodes (10): authenticateApplication(), AuthenticatedApplication, bearerToken(), matchSecret(), unauthenticated(), CreatedSession, createSession(), CreateSessionInput (+2 more)
...
Cohesion: 0.26
Nodes (7): AuditDetail(), changedKeys(), auditActions(), AuditRow, listAuditEntries(), AuditLogPage(), FilterLink()
...
Cohesion: 0.23
Nodes (9): prerenderInvoicePdf(), plainText(), PresentationInput, presentationSchema, sellingPoint(), toStoredPresentation(), minorAmount, POST (+1 more)

### Community 109 - "Community 109"
Cohesion: 0.3
Nodes (7): listPublishedTeam(), TeamGrid(), JsonLd(), serialiseJsonLd(), isProductionSite(), generateMetadata(), TeamPage()
...
Cohesion: 0.27
Nodes (7): BuildTiers(), TIERS_HEADING, TierRow(), Tier, TIERS, TierSide, ToneReveal()

### Community 114 - "Community 114"
Cohesion: 0.18
Nodes (9): transactions, paymentProviders, ReconciliationItem, reconciliationItems, ReconciliationRun, reconciliationRuns, reconStatus, ProviderSeed (+1 more)
...
Cohesion: 0.27
Nodes (6): PrinciplesSection(), QUALITIES, Quality, QualityPile(), TONE_CLASS, PillPile()
...
Cohesion: 0.33
Nodes (7): mutatingEndpoint(), paisa(), serializeInvoice(), serializeSession(), serializeTransaction(), POST, schema
...
Cohesion: 0.43
Nodes (5): Hero(), homeTagline(), collapse(), splitLede(), HomePage()
...
Cohesion: 0.38
Nodes (5): PLACE_COORDINATES, PLACE_PHOTO, PlaceSection(), DrawIn(), WordReveal()

### Community 139 - "Community 139"
Cohesion: 0.43
Nodes (6): CheckoutView, offerable(), summarise(), Summary, readPresentation(), CheckoutPage()
...
## Knowledge Gaps
- **1309 isolated node(s):** `eslintConfig`, `RemotePatterns`, `TRUSTED_IMAGE_HOSTS`, `nextConfig`, `config` (+1304 more)
...
- **Why does `cn()` connect `Community 46` to `Community 132`, `Community 6`, `Community 138`, `Community 16`, `Community 147`, `Community 27`, `Community 155`, `Community 160`, `Community 33`, `Community 37`, `Community 38`, `Community 39`, `Community 45`, `Community 55`, `Community 62`, `Community 77`, `Community 80`, `Community 82`, `Community 83`, `Community 91`, `Community 106`, `Community 113`, `Community 120`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `isPaymentError()` connect `Community 18` to `Community 4`, `Community 8`, `Community 139`, `Community 11`, `Community 19`, `Community 52`, `Community 61`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `headers` connect `Community 14` to `Community 124`?**
