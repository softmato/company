...
## Corpus Check
- 649 files · ~633,353 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3896 nodes · 7841 edges · 204 communities (195 shown, 9 thin omitted)
...
Cohesion: 0.06
Nodes (63): AuditDetail(), changedKeys(), auditActions(), AuditRow, listAuditEntries(), NUMERIC_FIELDS, DashboardActivity(), DashboardInvoices() (+55 more)
...
Cohesion: 0.07
Nodes (51): nextPollAt(), pollDelayMs(), pollExhausted(), giveUp(), LIVE, PollPendingResult, pollPendingTransactions(), reschedule() (+43 more)
...
Cohesion: 0.14
Nodes (34): AboutPage(), generateMetadata(), BlogIndexPage(), generateMetadata(), PostList(), CareersPage(), generateMetadata(), metadataFor() (+26 more)
...
Cohesion: 0.1
Nodes (34): dmSans, inter, metadata, outfit, plexMono, robots(), sitemap(), isIndexableLegalDocument() (+26 more)
...
Cohesion: 0.12
Nodes (30): amountInWords(), numberInWords(), ONES, SCALES, TENS, underHundred(), underThousand(), InvoiceSheet() (+22 more)
...
Cohesion: 0.08
Nodes (30): ApplicationPanel(), Breadcrumbs(), ContentTable(), KeyLegend(), KEYS, RegisterApplicationForm(), ApplicationsPage(), applicationColumns (+22 more)
...
Cohesion: 0.12
Nodes (27): confirmCashAction(), decide(), rejectCashAction(), enrolmentUrl(), createPendingAdmin(), deletePendingAdmin(), findPendingAdmin(), PendingAdmin (+19 more)
...
Cohesion: 0.12
Nodes (29): readProduct(), assertRegisteredHost(), isRegisteredHost(), addDomain(), AddDomainInput, normalizeHostname(), normalizeHostnameInput(), assertLoopbackAllowed() (+21 more)
...
Cohesion: 0.13
Nodes (21): EnrolmentHandoff(), InviteAdminForm(), PublishConfirm(), PublishPending(), RotateTotpForm(), RotateTotpFormProps, SubmitButton(), expiresIn() (+13 more)
...
Cohesion: 0.18
Nodes (27): requireAdmin(), DomainList(), DomainRow, addCredentialAction(), confirmIdentity(), confirmIfProduction(), confirmName(), deleteApplicationAction() (+19 more)

### Community 30 - "Community 30"
Cohesion: 0.11
Nodes (30): availableProviders(), availableFor(), esewaConfig(), fonepayConfig(), khaltiConfig(), MOCKABLE, MODES, paymentMode() (+22 more)
...
Cohesion: 0.11
Nodes (18): covering, DarkNavZone(), DeviceScreen(), CLOSING_HEADING, PRINCIPLES_HEADING, PRODUCTS_HEADING, STATEMENT, TIERS_HEADING (+10 more)
...
Cohesion: 0.17
Nodes (13): BLOOM_LAYERS, EXIT_DX, HeroArc(), CRESCENT_LAYERS, HeroEye(), EXIT_DX, heroStart(), HERO (+5 more)

### Community 36 - "Community 36"
Cohesion: 0.14
Nodes (19): AdminRoster(), PendingAdminActions(), listAdmins(), RosterEntry, TotpSetup(), TotpSetupProps, confirmEnrolment(), metadata (+11 more)
...
Cohesion: 0.11
Nodes (23): mutatingEndpoint(), paisa(), serializeInvoice(), serializeOfflinePayment(), serializeRefund(), serializeSession(), serializeTransaction(), serializeTransactionView() (+15 more)
...
Cohesion: 0.1
Nodes (15): Receipt, ReceiptInput, invoice(), audited, makeAttempt(), makeSession(), NOW, receipts (+7 more)

### Community 43 - "Community 43"
Cohesion: 0.12
Nodes (18): Chip(), PostSummary, SERVICES_HEADING, ServiceStep(), ServicesChapter(), ServiceStepData, cn(), MarkArrow() (+10 more)

### Community 44 - "Community 44"
Cohesion: 0.12
Nodes (11): PLAIN, Run, Sheet, COUNTED, counts(), FAKE_INVOICE_YEARS, FAKE_YEARS, GUARDS (+3 more)
...
Cohesion: 0.11
Nodes (17): CallbackPage(), metadata, CheckoutNotice(), CheckoutNoticeProps, Tone, ConfirmOutcome, confirmSessionPayment(), ReturnLink (+9 more)
...
Cohesion: 0.12
Nodes (19): CheckoutFlow(), CheckoutFlowProps, fmt(), PROVIDER_META, BUSY, FonepayQr(), FonepayQrProps, NOTES (+11 more)

### Community 50 - "Community 50"
Cohesion: 0.09
Nodes (11): AiProvider, defaultAiProvider, GeminiAiProvider, GroqAiProvider, OpenAiProvider, OpenRouterAiProvider, ResilientAiProvider, AiProviderChatParams (+3 more)
...
Cohesion: 0.14
Nodes (15): listRefunds(), RefundRow, BANK_SLUGS, bankMark(), BankSlug, BrandMark(), MarkAsset, ProviderBadge() (+7 more)
...
Cohesion: 0.13
Nodes (20): BookingFailure, BookingOutcome, BookingRecord, getAllLeads(), getAvailableSlots(), LeadEntry, LeadRecord, leadsStore (+12 more)

### Community 61 - "Community 61"
Cohesion: 0.16
Nodes (18): asJson(), eventIdFor(), ProviderEventInput, ProviderEventType, recordProviderEvent(), hasProvider(), providerAdapter(), registerProvider() (+10 more)

### Community 62 - "Community 62"
Cohesion: 0.13
Nodes (17): authenticateApplication(), AuthenticatedApplication, bearerToken(), matchSecret(), unauthenticated(), AuditRecorder, FiledRefund, REFUNDABLE (+9 more)
...
Cohesion: 0.18
Nodes (9): OrderSummary(), OrderSummaryProps, metadata, PlanDetails(), Presentation, Wordmark(), CheckoutPage(), metadata (+1 more)

### Community 79 - "Community 79"
Cohesion: 0.15
Nodes (15): bookMeetingSchema, contactHumanSchema, createLeadSchema, BookMeetingParams, ContactHumanParams, CreateLeadParams, MeetingSlot, Role (+7 more)

### Community 80 - "Community 80"
Cohesion: 0.16
Nodes (14): listPublishedPosts(), BuildTiers(), ClosingCta(), Hero(), PlaceSection(), PrinciplesSection(), ProductsSection(), RecentPosts() (+6 more)
...
Cohesion: 0.19
Nodes (11): PLACE_COORDINATES, PLACE_PHOTO, WordReveal(), FormGround, FormKind, LightForm(), LightFormScene, useNearViewport() (+3 more)
...
Cohesion: 0.19
Nodes (10): CashRow, listCash(), Offline, AdminCashPage(), CashCard(), metadata, formatAdDateTime(), formatted (+2 more)

### Community 98 - "Community 98"
Cohesion: 0.29
Nodes (10): allowBooking(), allowTurn(), bookings, callerAddress(), hashAddress(), record(), turns, formatToolResults() (+2 more)
...
Cohesion: 0.2
Nodes (8): TRUSTED_IMAGE_HOSTNAMES, CmsImageFillProps, CmsImageProps, optimizable(), loadRootEnv(), nextConfig, RemotePatterns, TRUSTED_IMAGE_HOSTS
...
- **Why does `isPaymentError()` connect `Community 46` to `Community 2`, `Community 36`, `Community 5`, `Community 39`, `Community 19`, `Community 61`, `Community 20`, `Community 24`, `Community 29`?**
  _High betweenness centrality (0.089) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 43` to `Community 1`, `Community 9`, `Community 140`, `Community 16`, `Community 149`, `Community 25`, `Community 33`, `Community 34`, `Community 35`, `Community 40`, `Community 41`, `Community 169`, `Community 47`, `Community 48`, `Community 53`, `Community 78`, `Community 86`, `Community 89`, `Community 104`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `decide()` connect `Community 20` to `Community 44`, `Community 29`, `Community 46`?**
