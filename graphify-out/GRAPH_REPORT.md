...
## Corpus Check
- 648 files · ~632,391 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3892 nodes · 7817 edges · 204 communities (194 shown, 10 thin omitted)
...
Cohesion: 0.07
Nodes (56): giveUp(), LIVE, PollPendingResult, pollPendingTransactions(), reschedule(), confirmOfflinePayment(), pendingCash(), RecordedOfflinePayment (+48 more)
...
Cohesion: 0.09
Nodes (31): confirmCashAction(), decide(), rejectCashAction(), enrolmentUrl(), createPendingAdmin(), deletePendingAdmin(), findPendingAdmin(), PendingAdmin (+23 more)

### Community 9 - "Community 9"
Cohesion: 0.1
Nodes (37): StatusBadge(), Tone, TONE_BY_STATUS, TONES, buildInvoiceDocument(), customerParty(), documentStatus(), documentIssues() (+29 more)

### Community 10 - "Community 10"
Cohesion: 0.11
Nodes (34): amountInWords(), numberInWords(), ONES, SCALES, TENS, underHundred(), underThousand(), InvoiceSheet() (+26 more)
...
Cohesion: 0.07
Nodes (31): ApplicationPanel(), Breadcrumbs(), ContentTable(), DomainList(), DomainRow, KeyLegend(), KEYS, RegisterApplicationForm() (+23 more)
...
Cohesion: 0.08
Nodes (38): findTotpSecret(), authorize(), decryptSecret(), deriveFromKey(), encryptSecret(), key(), checkTotp(), createTotpEnrolment() (+30 more)
...
Cohesion: 0.08
Nodes (29): INVOICE_STATUSES, InvoiceFilter, InvoiceRow, InvoiceTotals, listInvoices(), numberingGaps(), whereFor(), listPayments() (+21 more)
...
Cohesion: 0.16
Nodes (23): NUMERIC_FIELDS, DashboardActivity(), DashboardInvoices(), DASHBOARD_TABS, DashboardPaymentFilter, DashboardTab, filterDashboardPayments(), DashboardOperations() (+15 more)
...
Cohesion: 0.11
Nodes (18): bankApps(), BankReply, FonepayConfig, FonepayProviderAdapter, HOSTS, STATUS, StatusReply, PAYMENT_ERROR_STATUS (+10 more)
...
Cohesion: 0.14
Nodes (19): AdminRoster(), InviteAdminForm(), PendingAdminActions(), listAdmins(), RosterEntry, RotateTotpForm(), TotpSetup(), confirmEnrolment() (+11 more)

### Community 42 - "Community 42"
Cohesion: 0.1
Nodes (19): BuildTiers(), ClosingCta(), CLOSING_HEADING, PRINCIPLES_HEADING, PRODUCTS_HEADING, SERVICES_HEADING, STATEMENT, TIERS_HEADING (+11 more)

### Community 43 - "Community 43"
Cohesion: 0.13
Nodes (19): PLACE_COORDINATES, PLACE_PHOTO, PlaceSection(), PrinciplesSection(), QualityPile(), ServiceStep(), ServicesChapter(), ServiceStepData (+11 more)
...
Cohesion: 0.26
Nodes (17): NotFound(), getLegalDocument, getPost, getProductPage, getService, published(), publishedSlugs(), formatBsWithAd() (+9 more)
...
Cohesion: 0.13
Nodes (20): DashboardInvoice, DashboardMethod, DashboardMonth, DashboardPayment, DashboardSnapshot, ActivityEntry, dashboardAttentionPayments(), dashboardMetrics() (+12 more)
...
Cohesion: 0.12
Nodes (15): callbackBase(), MockProviderAdapter, hasProvider(), providerAdapter(), registerProvider(), REGISTRY, registryKey(), resetProviderRegistry() (+7 more)
...
Cohesion: 0.21
Nodes (16): publishContent(), unpublishContent(), revalidateContent(), saveContent(), ActionResult, databaseMessage(), parseId(), requireKind() (+8 more)
...
Cohesion: 0.14
Nodes (15): listPublishedProducts(), listPublishedServices(), DeviceScreen(), ProductsSection(), RecentPosts(), ServicesSection(), homeTagline(), collapse() (+7 more)
...
Cohesion: 0.12
Nodes (13): accounts, transactions, PaymentProvider, paymentProviders, ReconciliationItem, reconciliationItems, ReconciliationRun, reconciliationRuns (+5 more)
...
Cohesion: 0.13
Nodes (14): dmSans, inter, metadata, outfit, plexMono, sitemap(), isIndexableLegalDocument(), LegalReadiness (+6 more)
...
Cohesion: 0.38
Nodes (4): QUALITIES, Quality, TONE_CLASS, PillPile()
...
- **Why does `isPaymentError()` connect `Community 1` to `Community 128`, `Community 35`, `Community 68`, `Community 36`, `Community 8`, `Community 41`, `Community 109`, `Community 46`, `Community 50`, `Community 20`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Why does `decide()` connect `Community 8` to `Community 121`, `Community 50`, `Community 1`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 30` to `Community 160`, `Community 33`, `Community 98`, `Community 99`, `Community 38`, `Community 168`, `Community 42`, `Community 43`, `Community 44`, `Community 74`, `Community 13`, `Community 48`, `Community 16`, `Community 116`, `Community 21`, `Community 150`, `Community 26`, `Community 127`?**
