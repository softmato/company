...
## Corpus Check
- 598 files · ~559,390 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3434 nodes · 6877 edges · 182 communities (168 shown, 14 thin omitted)
...
Cohesion: 0.07
Nodes (44): ClosingCta(), CraftConstellation(), CRAFT_DISCS, CraftDisc, covering, DarkNavZone(), DisciplineCluster(), Discipline (+36 more)
...
Cohesion: 0.06
Nodes (37): Application, APPLICATION_SCOPES, ApplicationDomain, applicationDomains, applications, ApplicationScope, Customer, customers (+29 more)

### Community 8 - "Community 8"
Cohesion: 0.09
Nodes (31): EnrolmentHandoff(), InviteAdminForm(), PublishConfirm(), PublishPending(), RotateTotpForm(), RotateTotpFormProps, SubmitButton(), TotpSetup() (+23 more)
...
Cohesion: 0.08
Nodes (30): ApplicationPanel(), Breadcrumbs(), ContentTable(), ReauthFields(), RegisterApplicationForm(), DESCRIPTION, ScopeCheckboxes(), ApplicationsPage() (+22 more)
...
Cohesion: 0.09
Nodes (34): confirmSessionPayment(), expireOne(), ExpireSessionsResult, expireStaleSessions(), OPEN, isPaymentError(), FormPost, isProviderId() (+26 more)
...
Cohesion: 0.07
Nodes (31): Account, accountClass, normalBalance, Product, productKind, products, FiscalPeriod, fiscalPeriods (+23 more)
...
Cohesion: 0.14
Nodes (29): publishContent(), unpublishContent(), saveContent(), ActionResult, databaseMessage(), parseId(), requireAdmin(), requireKind() (+21 more)
...
Cohesion: 0.11
Nodes (31): sendReceipt(), everything, clearInvoice(), closeSession(), CompletedPayment, completePayment(), flagForReconciliation(), journalNoOf() (+23 more)
...
Cohesion: 0.13
Nodes (21): AdminRoster(), PendingAdminActions(), listAdmins(), RosterEntry, confirmEnrolment(), metadata, openPendingSecret(), seal() (+13 more)
...
Cohesion: 0.09
Nodes (16): buildReceipt(), Receipt, ReceiptInput, AccountSeed, accountSeeds, audited, makeAttempt(), makeSession() (+8 more)
...
Cohesion: 0.18
Nodes (19): DomainList(), DomainRow, confirmIdentity(), confirmIfProduction(), confirmName(), readDomains(), readScopes(), registerApplicationAction() (+11 more)
...
Cohesion: 0.13
Nodes (14): AdminNav(), NavItem, SECTIONS, AdminLayout(), DeviceScreen(), PLACE_COORDINATES, PLACE_PHOTO, PlaceSection() (+6 more)
...
Cohesion: 0.13
Nodes (11): callbackBase(), MockProviderAdapter, hasProvider(), providerAdapter(), registeredProviders(), registerProvider(), REGISTRY, resetProviderRegistry() (+3 more)
...
Cohesion: 0.22
Nodes (11): ConfirmOutcome, sendEmail(), ensureProvidersRegistered(), MOCKABLE, registerIfAbsent(), registerMocks(), registerReal(), sendPaymentReceipt() (+3 more)
...
Cohesion: 0.19
Nodes (7): ContentForm(), KindCard(), PublicationPanel(), listContent(), isContentKind(), ContentEditPage(), ContentListPage()
...
Cohesion: 0.26
Nodes (10): OrderSummary(), CheckoutProvider, CheckoutView, offerable(), summarise(), Summary, readPresentation(), availableProviders() (+2 more)
...
- **Why does `isPaymentError()` connect `Community 15` to `Community 98`, `Community 7`, `Community 41`, `Community 75`, `Community 44`, `Community 12`, `Community 49`, `Community 24`, `Community 29`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 14` to `Community 0`, `Community 2`, `Community 36`, `Community 39`, `Community 40`, `Community 8`, `Community 143`, `Community 145`, `Community 50`, `Community 82`, `Community 147`, `Community 23`, `Community 119`, `Community 120`, `Community 27`, `Community 152`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `submitContact()` connect `Community 113` to `Community 8`, `Community 17`?**
